...
- **Acorn ANFS 4.24**
  - [Formatted disassembly on acornaeology.uk](https://acornaeology.uk/acorn-nfs/4.24.html)
  - [Raw assembly source](versions/anfs-4.24/output/anfs-4.24.asm)
...
- **Acorn ANFS 4.26**
  - [Formatted disassembly on acornaeology.uk](https://acornaeology.uk/acorn-nfs/4.26.html)
  - [Raw assembly source](versions/anfs-4.26/output/anfs-4.26.asm)
  - [Acorn ANFS ROMs on J.G. Harston's site](https://mdfs.net/System/ROMs/Filing/Network/Acorn/)
  - [Acorn ANFS version notes (J.G. Harston)](https://mdfs.net/System/ROMs/Filing/Network/Acorn/Versions)
  - [Discuss this disassembly on the Stardot Forums thread: Acorn ANFS - A new annotated disassembly](https://www.stardot.org.uk/forums/viewtopic.php?t=32592)
  - [Changes from ANFS 4.25](versions/anfs-4.26/CHANGES-FROM-4.25.md)
...
Requires [uv](https://docs.astral.sh/uv/) and [beebasm](https://github.com/stardot/beebasm) (v1.10+). Disassembly and verification are driven by the [fantasm](https://acornaeology.github.io/fantasm/) CLI — full reference at <https://acornaeology.github.io/fantasm/>.

```sh
uv sync
uv run fantasm disassemble 3.34
uv run fantasm verify 3.34
uv run fantasm disassemble 3.34B
uv run fantasm verify 3.34B
uv run fantasm disassemble 3.35D
uv run fantasm verify 3.35D
uv run fantasm disassemble 3.35K
uv run fantasm verify 3.35K
uv run fantasm disassemble 3.40
uv run fantasm verify 3.40
uv run fantasm disassemble 3.60
uv run fantasm verify 3.60
uv run fantasm disassemble 3.62
uv run fantasm verify 3.62
uv run fantasm disassemble 3.65
uv run fantasm verify 3.65
uv run fantasm disassemble 4.08.53
uv run fantasm verify 4.08.53
uv run fantasm disassemble 4.18
uv run fantasm verify 4.18
uv run fantasm disassemble 4.21_variant_1
...
uv run fantasm disassemble 4.26
uv run fantasm verify 4.26
```
...
beebasm -i versions/anfs-4.26/output/anfs-4.26.asm -o anfs-4.26.rom
```
