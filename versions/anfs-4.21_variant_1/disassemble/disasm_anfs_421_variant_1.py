...
#
# Some hazel_shadow_XX names (and a few others) are still hex-derived
# placeholders -- the byte's role is not yet fully understood.
# These are better than auto-names but should be refined in a
# future pass. Flagged in the tracking doc.
...
label(0xC10B, "hazel_txcb_check_1")
label(0xC10C, "hazel_txcb_check_2")
...
label(0xC116, "hazel_txcb_spare_116")
label(0xC12F, "hazel_txcb_end")
label(0xC130, "hazel_examine_attr")
label(0xC1C8, "hazel_chan_status")
label(0xC1DC, "hazel_fcb_ctx_1")
label(0xC1DD, "hazel_fcb_ctx_2")
label(0xC1DE, "hazel_fcb_ctx_3")
label(0xC1DF, "hazel_fcb_ctx_4")
label(0xC1E0, "hazel_fcb_ctx_5")
label(0xC1F0, "hazel_ws_padding_start")
label(0xC1FF, "hazel_ws_padding_end")
label(0xC200, "hazel_page10_shadow")
label(0xC210, "hazel_shadow_10")
label(0xC220, "hazel_shadow_20")
label(0xC230, "hazel_shadow_30")
label(0xC240, "hazel_shadow_40")
label(0xC250, "hazel_shadow_50")
label(0xC260, "hazel_shadow_60")
label(0xC270, "hazel_shadow_70")
label(0xC271, "hazel_fs_lib_flags")
label(0xC272, "hazel_shadow_72")
label(0xC273, "hazel_shadow_73")
label(0xC274, "hazel_shadow_74")
label(0xC278, "hazel_shadow_78")
label(0xC288, "hazel_shadow_88")
label(0xC298, "hazel_shadow_98")
label(0xC2A8, "hazel_shadow_a8")
label(0xC2B8, "hazel_shadow_b8")
label(0xC2C8, "hazel_shadow_c8")
label(0xC2C9, "hazel_ws_clear_c9")
label(0xC2CA, "hazel_shadow_ca")
label(0xC2CB, "hazel_shadow_cb")
label(0xC2CC, "hazel_shadow_cc")
label(0xC2CD, "hazel_shadow_cd")
label(0xC2CE, "hazel_shadow_ce")
label(0xC2CF, "hazel_shadow_cf")
label(0xC2D0, "hazel_shadow_d0")
label(0xC2D1, "hazel_shadow_d1")
label(0xC2D4, "hazel_shadow_d4")
label(0xC2D5, "hazel_shadow_d5")
label(0xC2D6, "hazel_shadow_d6")
label(0xC2D7, "hazel_shadow_d7")
label(0xC2D8, "hazel_quote_mode")
label(0xC2D9, "hazel_shadow_d9")
label(0xC2F3, "hazel_shadow_f3")
