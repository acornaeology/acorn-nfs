...
comment(0x8430, "TAX -- restore X register", inline=True)
...
comment(0xA9A7, "RTS dispatches to handler", inline=True)
...
comment(0xAAE0, "Load l1010[handle]", inline=True)
...
comment(0xAAEC, "Load l1040[handle] flags", inline=True)
...
comment(0xAAF4, "Store handle to l1071+Y", inline=True)
comment(0xAAF7, "Load station from l1010", inline=True)
comment(0xAAFA, "Store station to l0e01+Y", inline=True)
...
comment(0xAB0A, "Reload l1040 flags", inline=True)
...
comment(0xAB26, "Reload l1040 flags", inline=True)
...
comment(0xAB39, "Reload l1040 flags", inline=True)
...
comment(0xAB8E, "Free = &6F - l0d6b", inline=True)
...
comment(0xABA1, "Store to l0d6d[Y]", inline=True)
...
comment(0xABCB, "Load default from l0e01", inline=True)
...
comment(0xABF6, "Rotate l0d61 right (save flag)", inline=True)
...
comment(0xAC0A, "Restore l0d61 flag", inline=True)
...
comment(0xAD18, "Push for RTS dispatch", inline=True)
comment(0xAD19, "Load handler low byte from table", inline=True)
comment(0xAD1C, "Push for RTS dispatch", inline=True)
comment(0xAD1D, "Reload OSWORD number for handler", inline=True)
comment(0xAD1F, "RTS will dispatch to handler", inline=True)
...
comment(0xAE02, "Test bit 6 via BIT (V flag check)", inline=True)
...
comment(0xAEDE, "Save l00d0 (exec flag)", inline=True)
...
comment(0xAF62, "Restore l00d0", inline=True)
...
comment(0xB01A, "Save l00ad counter", inline=True)
...
comment(0xB05C, "Restore original l00ad", inline=True)
...
comment(0xB70B, "Load current file index", inline=True)
comment(0xB70D, "Store file index in TX buffer byte 1", inline=True)
comment(0xB710, "X=3: copy from TX buffer offset 3", inline=True)
comment(0xB712, "Copy filename argument to TX buffer", inline=True)
comment(0xB715, "Function code 3 = examine", inline=True)
comment(0xB717, "Flag &80 = escapable", inline=True)
comment(0xB719, "Mark operation as escapable", inline=True)
comment(0xB71B, "Send examine request to file server", inline=True)
comment(0xB71E, "Get server response status", inline=True)
comment(0xB721, "Non-zero: file found, process it", inline=True)
comment(0xB723, "OSBYTE &0F: flush buffer class", inline=True)
comment(0xB725, "X=1: flush input buffers", inline=True)
comment(0xB727, "Flush keyboard buffer", inline=True)
comment(0xB72A, "OSBYTE &7A: keyboard scan from 16", inline=True)
comment(0xB72C, "Scan keyboard to clear state", inline=True)
comment(0xB72F, "Y=0: no key pressed", inline=True)
comment(0xB731, "OSBYTE &78: write keys pressed", inline=True)
comment(0xB733, "Clear keyboard state and return", inline=True)
comment(0xB736, "Load first attribute char of response", inline=True)
comment(0xB739, "Is file locked?", inline=True)
comment(0xB73B, "No: check if directory", inline=True)
comment(0xB73D, "Skip locked file, advance index", inline=True)
comment(0xB73F, "Request next file from server", inline=True)
comment(0xB742, "Is it a directory entry?", inline=True)
comment(0xB744, "No: regular file, show prompt", inline=True)
comment(0xB746, "Check directory contents flag", inline=True)
comment(0xB749, "Non-empty dir: treat as locked, skip", inline=True)
comment(0xB74B, "X=1: start from response byte 1", inline=True)
comment(0xB74D, "Y = destination index in delete buffer", inline=True)
comment(0xB74F, "Load filename char from response", inline=True)
comment(0xB752, "Print filename character to screen", inline=True)
comment(0xB755, "Store in delete command buffer too", inline=True)
comment(0xB758, "Advance destination index", inline=True)
comment(0xB759, "Advance source index", inline=True)
comment(0xB75A, "Copied all 11 filename characters?", inline=True)
comment(0xB75E, "Print '(Y/N/?) ' prompt", inline=True)
comment(0xB764, "Inline string terminator (NOP)", inline=True)
comment(0xB765, "Read user response character", inline=True)
comment(0xB768, "User pressed '?'?", inline=True)
comment(0xB76A, "No: check for Y/N response", inline=True)
comment(0xB76C, "Carriage return before full info", inline=True)
comment(0xB76E, "Print CR", inline=True)
comment(0xB771, "X=2: start from response byte 2", inline=True)
comment(0xB773, "Load file info character", inline=True)
comment(0xB776, "Print file info character", inline=True)
comment(0xB779, "Advance to next character", inline=True)
comment(0xB77A, "Printed all &3C info bytes?", inline=True)
comment(0xB77E, "Print ' (Y/N) ' prompt (no '?')", inline=True)
comment(0xB784, "Read user response (Y/N only)", inline=True)
comment(0xB787, "Force uppercase", inline=True)
comment(0xB789, "User said 'Y' (yes)?", inline=True)
comment(0xB78B, "No: print newline, skip to next file", inline=True)
comment(0xB78D, "Echo 'Y' to screen", inline=True)
comment(0xB790, "X=0: start of stored filename", inline=True)
comment(0xB792, "Check first byte of stored name", inline=True)
comment(0xB795, "Is first byte CR (empty first field)?", inline=True)
comment(0xB797, "Yes: use second filename field", inline=True)
comment(0xB799, "Load byte from stored filename", inline=True)
comment(0xB79C, "Is it CR (field separator)?", inline=True)
comment(0xB79E, "No: check for space", inline=True)
comment(0xB7A0, "Replace CR with '.' directory sep", inline=True)
comment(0xB7A2, "Is it a space (name terminator)?", inline=True)
comment(0xB7A4, "No: keep character as-is", inline=True)
comment(0xB7A6, "Replace space with CR (end of name)", inline=True)
comment(0xB7A8, "Store in delete command TX buffer", inline=True)
comment(0xB7AB, "Advance to next character", inline=True)
comment(0xB7AC, "Was it the CR terminator?", inline=True)
comment(0xB7AE, "No: continue building delete command", inline=True)
comment(0xB7B0, "Function code &14 = delete file", inline=True)
comment(0xB7B2, "Send delete request to file server", inline=True)
comment(0xB7B5, "Adjust file index after deletion", inline=True)
comment(0xB7B7, "Print newline after user response", inline=True)
comment(0xB7BA, "Advance index, process next file", inline=True)
comment(0xB7BD, "DEX to offset following INX", inline=True)
comment(0xB7BE, "Advance to next byte", inline=True)
comment(0xB7BF, "Load byte from second field", inline=True)
comment(0xB7C2, "Store in delete command TX buffer", inline=True)
...
comment(0xBE78, "PLP: C = bit shifted out of prev iter", inline=True)
...
comment(0xA620, "AND with l0f0c", inline=True)
...
comment(0xA9E6, "Store to l0dff", inline=True)
