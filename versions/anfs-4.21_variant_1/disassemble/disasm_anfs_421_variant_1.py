...
comment(0xAC0A, "Rotate econet_flags to update", inline=True)
comment(0xAC0D, "Clear tx_complete_flag bit 7", inline=True)
...
comment(0xAC21, "Poll TXCB control byte", inline=True)
...
comment(0xB764, "Inline string terminator", inline=True)
