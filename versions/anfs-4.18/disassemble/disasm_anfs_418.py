...
# UNMAPPED: label(0x8A65, "init_rom_scan")
label(0x8A71, "loop_scan_net_roms")
# UNMAPPED: label(0x8A90, "next_rom_slot")
...
# UNMAPPED: label(0x952F, "reload_reply_status")
...
# UNMAPPED: label(0xA281, "setup_oscli_arg")
...
# UNMAPPED: label(0xA3C7, "boot_oscli_lo_table")
...
# UNMAPPED: label(0xA508, "osword_dispatch_lo_table")
label(0xA52B, "osword_dispatch_hi_table")

# Mark OSWORD dispatch table entries as symbolic address pairs.
# UNMAPPED: for i in range(7):
# UNMAPPED:     rts_code_ptr(0xA508 + i, 0xA50F + i)

# UNMAPPED: comment(0xA508, "lo-&0E: Read clock", inline=True)
# UNMAPPED: comment(0xA509, "lo-&0F: (unimplemented)", inline=True)
# UNMAPPED: comment(0xA50A, "lo-&10: Transmit", inline=True)
# UNMAPPED: comment(0xA50B, "lo-&11: Receive", inline=True)
# UNMAPPED: comment(0xA50C, "lo-&12: Read station info", inline=True)
comment(0xA523, "lo-&13: Misc operations", inline=True)
# UNMAPPED: comment(0xA50E, "lo-&14: Bridge/net config", inline=True)
comment(0xA52B, "hi-&0E: Read clock", inline=True)
# UNMAPPED: comment(0xA510, "hi-&0F: (unimplemented)", inline=True)
comment(0xA52D, "hi-&10: Transmit", inline=True)
# UNMAPPED: comment(0xA512, "hi-&11: Receive", inline=True)
comment(0xA52F, "hi-&12: Read station info", inline=True)
# UNMAPPED: comment(0xA514, "hi-&13: Misc operations", inline=True)
# UNMAPPED: comment(0xA515, "hi-&14: Bridge/net config", inline=True)

# UNMAPPED: label(0xA516, "osword_0e_handler")
...
# UNMAPPED: label(0xA810, "store_a_to_pb_1")
label(0xA837, "bridge_found")
label(0xA840, "compare_bridge_status")
# UNMAPPED: label(0xA844, "bridge_ws_init_data")
...
# UNMAPPED: label(0xA98C, "osword_handler_lo_table")
...
# UNMAPPED:     rts_code_ptr(0xA98C + i, 0xA995 + i)
# UNMAPPED: comment(0xA98C, "OSWORD handler dispatch table\n"
# UNMAPPED:     "\n"
...
# UNMAPPED: comment(0xA98C, "lo OSWORD 0: no-op (RTS)", inline=True)
# UNMAPPED: comment(0xA98D, "lo OSWORD 1: printer spool data", inline=True)
# UNMAPPED: comment(0xA98E, "lo OSWORD 2: printer spool data", inline=True)
# UNMAPPED: comment(0xA98F, "lo OSWORD 3: printer spool data", inline=True)
# UNMAPPED: comment(0xA990, "lo OSWORD 4: clear carry + abort", inline=True)
# UNMAPPED: comment(0xA991, "lo OSWORD 5: spool buffer check", inline=True)
# UNMAPPED: comment(0xA992, "lo OSWORD 6: no-op (RTS)", inline=True)
# UNMAPPED: comment(0xA993, "lo OSWORD 7: claim/release handler", inline=True)
# UNMAPPED: comment(0xA994, "lo OSWORD 8: copy PB + abort", inline=True)
# UNMAPPED: comment(0xA995, "hi OSWORD 0: no-op (RTS)", inline=True)
# UNMAPPED: comment(0xA996, "hi OSWORD 1: printer spool data", inline=True)
# UNMAPPED: comment(0xA997, "hi OSWORD 2: printer spool data", inline=True)
comment(0xA9AA, "hi OSWORD 3: printer spool data", inline=True)
comment(0xA9AB, "hi OSWORD 4: clear carry + abort", inline=True)
# UNMAPPED: comment(0xA99A, "hi OSWORD 5: spool buffer check", inline=True)
comment(0xA9AD, "hi OSWORD 6: no-op (RTS)", inline=True)
# UNMAPPED: comment(0xA99C, "hi OSWORD 7: claim/release handler", inline=True)
# UNMAPPED: comment(0xA99D, "hi OSWORD 8: copy PB + abort", inline=True)
...
# UNMAPPED: label(0xABFE, "error_printer_jammed")
...
# UNMAPPED: label(0xACFB, "osbyte_mode_read_codes")
...
# UNMAPPED: label(0xAE0A, "loop_print_option_str")
...
# UNMAPPED: label(0xB092, "done_ps_status_msg")
...
# UNMAPPED: label(0xB11B, "write_ps_slot_link_addr")
...
# UNMAPPED: label(0xB243, "loop_pop_poll_slot")
...
# UNMAPPED: label(0x8534, "tx_done_dispatch_lo")
...
# UNMAPPED: label(0x8FDD, "print_station_id")
...
# UNMAPPED: label(0x96DA, "check_net_error_code")
...
# UNMAPPED: label(0xA4EF, "osword_setup_handler")
label(0xA595, "bin_to_bcd")
# UNMAPPED: label(0xA601, "store_osword_pb_ptr")
# UNMAPPED: label(0xA612, "store_ptr_at_ws_y")
...
# UNMAPPED: label(0xBAE4, "loop_print_col_num")
...
# UNMAPPED: label(0xBB53, "return_with_fn_offset")
...
# UNMAPPED: label(0x84A2, "svc5_dispatch_lo")
...
# UNMAPPED: label(0x847E, "imm_op_dispatch_lo")  # Immediate op dispatch lo-byte table
...
for addr in range(0x847E, 0x8486):
    byte(addr)
# UNMAPPED: expr(0x847E, "<(rx_imm_peek-1)")
# UNMAPPED: expr(0x847F, "<(rx_imm_poke-1)")
# UNMAPPED: expr(0x8480, "<(rx_imm_exec-1)")
# UNMAPPED: expr(0x8481, "<(rx_imm_exec-1)")
# UNMAPPED: expr(0x8482, "<(rx_imm_exec-1)")
# UNMAPPED: expr(0x8483, "<(rx_imm_halt_cont-1)")
# UNMAPPED: expr(0x8484, "<(rx_imm_halt_cont-1)")
# UNMAPPED: expr(0x8485, "<(rx_imm_machine_type-1)")
# UNMAPPED: comment(0x847E, "Ctrl &81: PEEK", inline=True)
# UNMAPPED: comment(0x847F, "Ctrl &82: POKE", inline=True)
# UNMAPPED: comment(0x8480, "Ctrl &83: JSR", inline=True)
# UNMAPPED: comment(0x8481, "Ctrl &84: UserProc", inline=True)
# UNMAPPED: comment(0x8482, "Ctrl &85: OSProc", inline=True)
# UNMAPPED: comment(0x8483, "Ctrl &86: HALT", inline=True)
# UNMAPPED: comment(0x8484, "Ctrl &87: CONTINUE", inline=True)
# UNMAPPED: comment(0x8485, "Ctrl &88: machine type query", inline=True)
...
# UNMAPPED: subroutine(0x8FDD, "print_station_id",
...
# UNMAPPED:     "then reads the station ID from offset 5 of the\n"
...
subroutine(0xA362, "flip_set_station_boot",
    ...
    "system state.")
# UNMAPPED: subroutine(0xA4EF, "osword_setup_handler",
# UNMAPPED:     title="Push OSWORD handler address for RTS dispatch",
# UNMAPPED:     description="Indexes the OSWORD dispatch table by X to\n"
# UNMAPPED:     "push a handler address (hi then lo) onto the\n"
# UNMAPPED:     "stack. Copies 3 bytes from the osword_flag\n"
# UNMAPPED:     "workspace into the RX buffer, loads PB byte 0\n"
# UNMAPPED:     "(the OSWORD sub-code), and clears svc_state.\n"
# UNMAPPED:     "The subsequent RTS dispatches to the pushed\n"
# UNMAPPED:     "handler address.",
# UNMAPPED:     on_entry={"x": "OSWORD handler index (0-6)"})
...
# UNMAPPED: subroutine(0xA601, "store_osword_pb_ptr",
# UNMAPPED:     title="Store OSWORD parameter block pointer+1 to workspace",
# UNMAPPED:     description="Computes PB pointer + 1 and stores the resulting\n"
# UNMAPPED:     "16-bit address at workspace offset &1C via\n"
# UNMAPPED:     "store_ptr_at_ws_y. Then reads PB byte 1 (the\n"
# UNMAPPED:     "transfer length) and adds the PB low byte to\n"
# UNMAPPED:     "compute the buffer end pointer, stored at\n"
# UNMAPPED:     "workspace offset &20.")
# UNMAPPED: subroutine(0xA612, "store_ptr_at_ws_y",
# UNMAPPED:     title="Store 16-bit pointer at workspace offset Y",
# UNMAPPED:     description="Writes a 16-bit address to (nfs_workspace)+Y.\n"
# UNMAPPED:     "The low byte comes from A; the high byte is\n"
# UNMAPPED:     "computed from osword_pb_ptr_hi plus carry,\n"
# UNMAPPED:     "supporting pointer arithmetic across page\n"
# UNMAPPED:     "boundaries.",
# UNMAPPED:     on_entry={"a": "pointer low byte",
# UNMAPPED:               "y": "workspace offset",
# UNMAPPED:               "c": "carry for high byte addition"})
...
# UNMAPPED: comment(0x048C, "X=0 for OSBYTE", inline=True)
# UNMAPPED: comment(0x048E, "Y=&FF for OSBYTE", inline=True)
# UNMAPPED: comment(0x0490, "OSBYTE &FD: what type of reset was this?", inline=True)
...
# UNMAPPED: comment(0x0518, """\
# UNMAPPED: Tube ULA control register values, indexed by transfer
# UNMAPPED: type (0-7). Written to &FEE0 after clearing V+M with
# UNMAPPED: &18. Bit layout: S=set/clear, T=reset regs, P=PRST,
# UNMAPPED: V=2-byte R3, M=PNMI(R3), J=PIRQ(R4), I=PIRQ(R1),
# UNMAPPED: Q=HIRQ(R4). Bits 1-7 select flags; bit 0 (S) is the
# UNMAPPED: value to set or clear.""")
_tube_ctrl_entries = [
...
# UNMAPPED: comment(0x8023, "A=4: SR bit mask for IFR test", inline=True)
...
# UNMAPPED: comment(0x804D, "Y=&FE: Econet event number", inline=True)
comment(0x8057, "Generate event and exit", inline=True)
...
# UNMAPPED: comment(0x83D7, "Set carry for subtraction", inline=True)
...
# UNMAPPED: comment(0x8486, "A=0: port buffer lo at page boundary", inline=True)
...
# UNMAPPED: comment(0x84A2, "Svc 5 dispatch table low bytes", inline=True)
...
# UNMAPPED: comment(0x8534, "Y=&83: lo &38 -> tx_done_jsr (&8539)", inline=True)
# UNMAPPED: comment(0x8535, "Y=&84: lo &41 -> tx_done_econet_event", inline=True)
# UNMAPPED: comment(0x8536, "Y=&85: lo &4F -> tx_done_os_proc", inline=True)
# UNMAPPED: comment(0x8537, "Y=&86: lo &5B -> tx_done_halt", inline=True)
# UNMAPPED: comment(0x8538, "Y=&87: lo &72 -> tx_done_continue", inline=True)
...
comment(0x862F, "CR1=&44: TIE | TX_LAST_DATA", inline=True)
...
# UNMAPPED: comment(0x8677, "TX ctrl dispatch table (lo bytes)\n"
# UNMAPPED:     "\n"
# UNMAPPED:     "Low bytes of PHA/PHA/RTS dispatch targets for TX\n"
# UNMAPPED:     "control byte types &81-&88. Read by the dispatch\n"
# UNMAPPED:     "at &8672 via LDA intoff_disable_nmi_op,Y (base\n"
# UNMAPPED:     "&85F6 + Y). High byte is always &86, so targets\n"
# UNMAPPED:     "are &86xx+1. The last entry dispatches to\n"
# UNMAPPED:     "tx_ctrl_machine_type at &867F, immediately after\n"
# UNMAPPED:     "the table.")
# UNMAPPED: comment(0x8677, "Ctrl &81 PEEK: tx_ctrl_peek", inline=True)
# UNMAPPED: comment(0x8678, "Ctrl &82 POKE: tx_ctrl_poke", inline=True)
# UNMAPPED: comment(0x8679, "Ctrl &83 JSR: proc_op_status2", inline=True)
# UNMAPPED: comment(0x867A, "Ctrl &84 UserProc: proc_op_status2", inline=True)
# UNMAPPED: comment(0x867B, "Ctrl &85 OSProc: proc_op_status2", inline=True)
# UNMAPPED: comment(0x867C, "Ctrl &86 HALT: tx_ctrl_exit", inline=True)
# UNMAPPED: comment(0x867D, "Ctrl &87 CONTINUE: tx_ctrl_exit", inline=True)
# UNMAPPED: comment(0x867E, "Ctrl &88 MachType: tx_ctrl_machine_type", inline=True)
# UNMAPPED: comment(0x867F, "scout_status=3 (machine type query)", inline=True)
...
# UNMAPPED: comment(0x88E6, "Dead data: &01", inline=True)
comment(0x88F1, "Dead data: &81", inline=True)
# UNMAPPED: comment(0x88E8, "Y=7: offset to RXCB buffer addr byte 3", inline=True)
...
# UNMAPPED: comment(0x89BE, "Dead data: &00", inline=True)
# UNMAPPED: comment(0x89BF, "Dead data: &08", inline=True)
...
# UNMAPPED: comment(0x8A65, "Store service number as ROM counter", inline=True)
...
# UNMAPPED: comment(0x8A85, "Get ROM slot being checked", inline=True)
...
# UNMAPPED: comment(0x8A90, "Decrement ROM counter", inline=True)
...
# UNMAPPED: comment(0x8B60, "Offset &0E in receive block", inline=True)
# UNMAPPED: comment(0x8B62, "Clear receive block flag", inline=True)
...
# UNMAPPED: comment(0x8BB0, "Y=9: max command name length", inline=True)
# UNMAPPED: comment(0x8BB2, "Load first char of command name", inline=True)
...
# UNMAPPED: comment(0x8CAA, "NOP (string terminator)", inline=True)
# UNMAPPED: comment(0x8CAB, "Print station number", inline=True)
# UNMAPPED: comment(0x8CAE, "Get current ROM slot number", inline=True)
...
# UNMAPPED: comment(0x8D0C, "Get command line offset", inline=True)
...
# UNMAPPED: comment(0x8D6E, "Save Y (command line offset)", inline=True)
...
# UNMAPPED: comment(0x8E49, "Dead data: &01", inline=True)
# UNMAPPED: comment(0x8E4A, "Dead data: &00", inline=True)

# UNMAPPED: comment(0x8E6D, "X=0", inline=True)
...
# UNMAPPED: comment(0x8E74, "NETV handler address\n"
# UNMAPPED:     "\n"
# UNMAPPED:     "2-byte handler address for the NETV extended\n"
# UNMAPPED:     "vector, read by write_vector_entry at Y=&36\n"
# UNMAPPED:     "from svc_dispatch_lo_offset (&8E3E). Points to\n"
# UNMAPPED:     "netv_handler (&A968) which dispatches OSWORDs\n"
# UNMAPPED:     "0-8 to Econet handlers. Interleaved with the\n"
# UNMAPPED:     "OSBYTE wrapper code in the data area.")
# UNMAPPED: comment(0x8E74, "NETV handler: netv_handler (&A968)", inline=True)

# UNMAPPED: comment(0x8E76, "X=0", inline=True)
...
comment(0x8F4A, "l0d6f: init=&28 (40, TX timeout)", inline=True)
comment(0x8F4B, "l0d70: init=&0A (10, pass-thru ctrl)", inline=True)
...
# UNMAPPED: comment(0x8F67, "X=&FF", inline=True)
# UNMAPPED: comment(0x8F68, "Store &FF in workspace flag", inline=True)
...
# UNMAPPED: comment(0x8FDD, "Print 'Econet Station ' via inline", inline=True)
# UNMAPPED: comment(0x8FEF, "Offset 5: station ID", inline=True)
# UNMAPPED: comment(0x8FF1, "Load station ID from receive block", inline=True)
...
# UNMAPPED: comment(0x9015, "Null terminator", inline=True)
comment(0x902A, "Syn 2: *I Am (login)", inline=True)
comment(0x9042, "Line break", inline=True)
# UNMAPPED: comment(0x902F, "Syn 2 continued: password clause", inline=True)
# UNMAPPED: comment(0x9042, "Null terminator", inline=True)
comment(0x9057, "Syn 3: *Delete, *FS, *Remove", inline=True)
# UNMAPPED: comment(0x904B, "Null terminator", inline=True)
# UNMAPPED: comment(0x904C, "Syn 4: *Dump", inline=True)
# UNMAPPED: comment(0x9061, "Line break", inline=True)
...
# UNMAPPED: comment(0x9074, "Null terminator", inline=True)
# UNMAPPED: comment(0x9075, "Syn 6: *CDir", inline=True)
# UNMAPPED: comment(0x9085, "Null terminator", inline=True)
comment(0x909A, "Syn 7: *Pass", inline=True)
# UNMAPPED: comment(0x9099, "Line break", inline=True)
comment(0x90AE, "Syn 7 continued: new password", inline=True)
# UNMAPPED: comment(0x90A8, "Null terminator", inline=True)
# UNMAPPED: comment(0x90A9, "Syn 8: *PS, *Pollps", inline=True)
# UNMAPPED: comment(0x90BF, "Null terminator", inline=True)
...
# UNMAPPED: comment(0x910F, "Idx 1: \"(<dir>)\" (Y wraps via &FF)", inline=True)
...
# UNMAPPED: comment(0x9113, "Idx 5: \"<dir>\"", inline=True)
# UNMAPPED: comment(0x9114, "Idx 6: \"<dir> (<number>)\"", inline=True)
...
# UNMAPPED: comment(0x9118, "Idx 10: \"<filename> <new filename>\"", inline=True)
...
# UNMAPPED: comment(0x9479, "Offset 2: txcb_dest lo (overwritten)", inline=True)
# UNMAPPED: comment(0x947A, "Offset 3: txcb_dest hi (overwritten)", inline=True)
...
# UNMAPPED: comment(0xA3DA, "*Close cont (dispatch hi base)", inline=True)
# UNMAPPED: comment(0xA3DD, "No syntax", inline=True)
# UNMAPPED: comment(0xA3DE, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA3E0, "*Dump", inline=True)
# UNMAPPED: comment(0xA3E4, "V no arg; syn 4: <filename> ...", inline=True)
# UNMAPPED: comment(0xA3E5, "Dispatch addr-1", inline=True)
comment(0xA3FF, "*Net (select NFS)", inline=True)
comment(0xA402, "No syntax", inline=True)
# UNMAPPED: comment(0xA3EB, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA3ED, "*Pollps", inline=True)
comment(0xA40B, "Syn 8: (<stn. id.>|<ps type>)", inline=True)
# UNMAPPED: comment(0xA3F4, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA3F6, "*Print", inline=True)
comment(0xA413, "V no arg; syn 12: <filename>", inline=True)
# UNMAPPED: comment(0xA3FC, "Dispatch addr-1", inline=True)
comment(0xA416, "*Prot", inline=True)
comment(0xA41A, "Syn 14: (attribute keywords)", inline=True)
# UNMAPPED: comment(0xA403, "Dispatch addr-1", inline=True)
comment(0xA41D, "*PS; syn 8: (<stn. id.>|<ps type>)", inline=True)
# UNMAPPED: comment(0xA408, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA40A, "*Roff", inline=True)
comment(0xA426, "No syntax", inline=True)
# UNMAPPED: comment(0xA40F, "Dispatch addr-1", inline=True)
comment(0xA429, "*Type", inline=True)
comment(0xA42D, "V no arg; syn 12: <filename>", inline=True)
# UNMAPPED: comment(0xA416, "Dispatch addr-1", inline=True)
comment(0xA430, "*Unprot", inline=True)
comment(0xA436, "Syn 14: (attribute keywords)", inline=True)
# UNMAPPED: comment(0xA41F, "Dispatch addr-1", inline=True)
...
# UNMAPPED: comment(0xA429, "Dispatch addr-1", inline=True)
comment(0xA443, "*Bye", inline=True)
# UNMAPPED: comment(0xA42E, "No syntax", inline=True)
# UNMAPPED: comment(0xA42F, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA431, "*Cdir", inline=True)
comment(0xA44D, "V no arg; syn 6: <dir> (<number>)", inline=True)
# UNMAPPED: comment(0xA436, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA438, "*Delete", inline=True)
# UNMAPPED: comment(0xA43E, "V no arg; syn 3: <object>", inline=True)
# UNMAPPED: comment(0xA43F, "Dispatch addr-1", inline=True)
comment(0xA459, "*Dir", inline=True)
comment(0xA45C, "Syn 1: (<dir>)", inline=True)
# UNMAPPED: comment(0xA445, "Dispatch addr-1", inline=True)
comment(0xA45F, "*Ex; syn 1: (<dir>)", inline=True)
# UNMAPPED: comment(0xA44A, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA44C, "*Flip", inline=True)
comment(0xA468, "No syntax", inline=True)
# UNMAPPED: comment(0xA451, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA453, "*FS; syn 11: (<stn. id.>)", inline=True)
# UNMAPPED: comment(0xA456, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA458, "*Info", inline=True)
comment(0xA474, "V no arg; syn 3: <object>", inline=True)
# UNMAPPED: comment(0xA45D, "Dispatch addr-1", inline=True)
comment(0xA477, "*I am", inline=True)
comment(0xA47B, "V no arg; syn 2: (<stn>) <user>...", inline=True)
# UNMAPPED: comment(0xA464, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA466, "*Lcat", inline=True)
comment(0xA482, "Syn 1: (<dir>)", inline=True)
# UNMAPPED: comment(0xA46B, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA46D, "*Lex", inline=True)
comment(0xA488, "Syn 1: (<dir>)", inline=True)
# UNMAPPED: comment(0xA471, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA473, "*Lib", inline=True)
comment(0xA48E, "V no arg; syn 5: <dir>", inline=True)
# UNMAPPED: comment(0xA477, "Dispatch addr-1", inline=True)
comment(0xA491, "*Pass", inline=True)
comment(0xA495, "V no arg; syn 7: <pass> ...", inline=True)
# UNMAPPED: comment(0xA47E, "Dispatch addr-1", inline=True)
# UNMAPPED: comment(0xA480, "*Remove", inline=True)
# UNMAPPED: comment(0xA486, "V no arg; syn 3: <object>", inline=True)
# UNMAPPED: comment(0xA487, "Dispatch addr-1", inline=True)
comment(0xA4A1, "*Rename", inline=True)
# UNMAPPED: comment(0xA48F, "V no arg; syn 10: <file> <new file>", inline=True)
# UNMAPPED: comment(0xA490, "Dispatch addr-1", inline=True)
comment(0xA4AA, "*Wipe", inline=True)
# UNMAPPED: comment(0xA496, "Syn 1: (<dir>)", inline=True)
# UNMAPPED: comment(0xA497, "Dispatch addr-1", inline=True)
comment(0xA4B1, "End of NFS sub-table", inline=True)

# Sub-table 3: help topic handlers (&A49A-&A4AA)
# UNMAPPED: comment(0xA49A, "&09/&8E: before help-only entries", inline=True)
# UNMAPPED: comment(0xA49C, "*Net (local)", inline=True)
comment(0xA4B7, "No syntax", inline=True)
# UNMAPPED: comment(0xA4A0, "Dispatch addr-1", inline=True)
comment(0xA4BA, "*Utils", inline=True)
comment(0xA4BF, "No syntax", inline=True)
# UNMAPPED: comment(0xA4A8, "Dispatch addr-1", inline=True)
...
# UNMAPPED:     byte(0x8534 + i)

# Use symbolic label expressions for PHA/PHA/RTS dispatch lo bytes.
# UNMAPPED: expr(0x8534, "<(tx_done_jsr-1)")
# UNMAPPED: expr(0x8535, "<(tx_done_econet_event-1)")
# UNMAPPED: expr(0x8536, "<(tx_done_os_proc-1)")
# UNMAPPED: expr(0x8537, "<(tx_done_halt-1)")
# UNMAPPED: expr(0x8538, "<(tx_done_continue-1)")

# TX ctrl dispatch table (8 bytes) and machine type handler (4 bytes)
# UNMAPPED: entry(0x867F)   # tx_ctrl_machine_type: ctrl &88 handler
# UNMAPPED: for i in range(8):
# UNMAPPED:     byte(0x8677 + i)

# Use symbolic label expressions for PHA/PHA/RTS dispatch lo bytes.
# UNMAPPED: expr(0x8677, "<(tx_ctrl_peek-1)")
# UNMAPPED: expr(0x8678, "<(tx_ctrl_poke-1)")
# UNMAPPED: expr(0x8679, "<(proc_op_status2-1)")
# UNMAPPED: expr(0x867A, "<(proc_op_status2-1)")
# UNMAPPED: expr(0x867B, "<(proc_op_status2-1)")
# UNMAPPED: expr(0x867C, "<(tx_ctrl_exit-1)")
# UNMAPPED: expr(0x867D, "<(tx_ctrl_exit-1)")
# UNMAPPED: expr(0x867E, "<(tx_ctrl_machine_type-1)")
...
# NETV handler address pair at &8E74 (read by write_vector_entry)
# UNMAPPED: label(0x8E74, "netv_handler_addr")
label(0xA97A, "netv_handler")
word(0x8E74)
# UNMAPPED: expr(0x8E74, "netv_handler")
...
# UNMAPPED: comment(0xAD36, "Index 5: threshold 39", inline=True)
# UNMAPPED: comment(0xAD37, "Index 6: threshold 49", inline=True)
comment(0xAD4A, "Index 7: threshold 59", inline=True)
comment(0xAD4B, "Index 8: threshold 69", inline=True)
# UNMAPPED: comment(0xAD3A, "Index 9: threshold 79", inline=True)
...
# UNMAPPED: comment(0xAD3E, "Index 13: threshold 118", inline=True)
# UNMAPPED: comment(0xAD3F, "Index 14: threshold 128", inline=True)
comment(0xAD52, "Index 15: threshold 138", inline=True)
comment(0xAD53, "Index 16: threshold 148", inline=True)
# UNMAPPED: comment(0xAD42, "Index 17: threshold 157", inline=True)
comment(0xAD55, "Index 18: threshold 167", inline=True)
comment(0xAD56, "Index 19: threshold 177", inline=True)
# UNMAPPED: comment(0xAD45, "Index 20: threshold 187", inline=True)
comment(0xAD58, "Index 21: threshold 197", inline=True)
# UNMAPPED: comment(0xAD47, "Index 22: threshold 207", inline=True)
...
# UNMAPPED: comment(0xAD4B, "Index 26: threshold 246", inline=True)
# UNMAPPED: comment(0xAD4C, "Unused (index 27, never accessed)", inline=True)
...
comment(0x9470, "Decrement control byte", inline=True)
...
comment(0xA356, "Load FS station byte", inline=True)
comment(0xA359, "Save it", inline=True)
comment(0xA35A, "Load boot type flag", inline=True)
comment(0xA35D, "Find station entry with bit 3 set", inline=True)
comment(0xA360, "Restore FS station", inline=True)
comment(0xA361, "Transfer to Y (boot type)", inline=True)
...
# UNMAPPED: comment(0xA3C7, "Boot option OSCLI address table\n"
# UNMAPPED:     "\n"
...
# UNMAPPED: comment(0xA3C7, "Opt 0: &A3C6 (don't-care, unused)", inline=True)
# UNMAPPED: comment(0xA3C8, "Opt 1: &A3B7 'L.!BOOT' (*LOAD)", inline=True)
# UNMAPPED: comment(0xA3C9, "Opt 2: &A3B9 '!BOOT' (*RUN)", inline=True)
# UNMAPPED: comment(0xA3CA, "Opt 3: &A3BF 'E.!BOOT' (*EXEC)", inline=True)
# UNMAPPED: comment(0xA3CB, "Load boot type", inline=True)
...
# UNMAPPED: comment(0xB22D, "Start of PS name in buffer", inline=True)
...
# UNMAPPED: comment(0xB242, "Padding byte", inline=True)

# Poll each printer slot
# UNMAPPED: comment(0xB243, "Get slot offset from stack", inline=True)
...
# UNMAPPED: comment(0xB267, "X=0 for indirect indexed access", inline=True)
...
# UNMAPPED: comment(0xB275, "Clear V", inline=True)
...
# UNMAPPED: comment(0xB293, "Advance past status byte", inline=True)
...
# UNMAPPED: comment(0xB2AC, "Advance past station low", inline=True)
# UNMAPPED: comment(0xB2AE, "Read client network number", inline=True)
...
# UNMAPPED: comment(0xADC1, "Get owner/public flag", inline=True)
comment(0xADD6, "Non-zero: public access", inline=True)
comment(0xADD8, "Print 'Owner' + CR", inline=True)
# UNMAPPED: comment(0xADCF, "Skip public; ALWAYS branch", inline=True)
comment(0xADE3, "Print 'Public' + CR", inline=True)

# Directory info: option, dir name, lib name
# UNMAPPED: comment(0xADDB, "Get flags", inline=True)
# UNMAPPED: comment(0xADDE, "Save flags", inline=True)
...
# UNMAPPED: comment(0xADFB, "Get option byte", inline=True)
...
# UNMAPPED: comment(0xAE1F, "Offset &11: directory name", inline=True)
# UNMAPPED: comment(0xAE21, "Print directory name (10 chars)", inline=True)
comment(0xAE3A, "Print '     Lib. '", inline=True)
# UNMAPPED: comment(0xAE31, "Offset &1B: library name", inline=True)
...
# UNMAPPED: comment(0xAF00, "No: continue copying", inline=True)
# UNMAPPED: comment(0xAF02, "'&' in filename: bad filename", inline=True)
...
# UNMAPPED: comment(0xAF38, "Skip newline; ALWAYS branch", inline=True)
# UNMAPPED: comment(0xAF3A, "CR character for newline", inline=True)
...
# UNMAPPED: comment(0xB087, "Clear V", inline=True)
comment(0xB0AE, "Print 'now '", inline=True)
# UNMAPPED: comment(0xB091, "Padding", inline=True)
# UNMAPPED: comment(0xB092, "Print FS info and newline", inline=True)
...
# UNMAPPED: comment(0xB0A8, "Clear V", inline=True)
...
# UNMAPPED: comment(0xB0C4, "Padding", inline=True)
# UNMAPPED: comment(0xB0C5, "Return", inline=True)
...
# UNMAPPED: comment(0xB18D, "Get station number", inline=True)
...
# UNMAPPED: comment(0xB197, "Data buffer start lo (&14)", inline=True)
# UNMAPPED: comment(0xB198, "Data buffer start hi (= rx page)", inline=True)
comment(0xB1BD, "Data buffer end lo (placeholder)", inline=True)
comment(0xB1BE, "Data buffer end hi (placeholder)", inline=True)
# UNMAPPED: comment(0xB19B, "Reply buffer start lo (&1C)", inline=True)
...
# UNMAPPED: comment(0x9518, "Next channel", inline=True)
# UNMAPPED: comment(0x9519, "Loop all 16 channels", inline=True)
...
# UNMAPPED: comment(0x952F, "Reload reply status code", inline=True)
# UNMAPPED: comment(0x9532, "Check pending operation", inline=True)
# UNMAPPED: comment(0x9535, "No pending: build error from reply", inline=True)
...
# UNMAPPED: comment(0xA165, "'\"' double quote", inline=True)
# UNMAPPED: comment(0xA166, "'#' hash", inline=True)
comment(0xA17F, "'$' dollar", inline=True)
# UNMAPPED: comment(0xA168, "'&' ampersand", inline=True)
...
# UNMAPPED: comment(0xA16D, "Restore saved Y", inline=True)
# UNMAPPED: comment(0xA16E, "Transfer to Y", inline=True)
...
# UNMAPPED: comment(0xA281, "Copy argument to buffer (X=0)", inline=True)
...
# UNMAPPED: comment(0x9273, "Bit 1: &20 = %00100000 (bit 5)", inline=True)
comment(0x9288, "Bit 2: &05 = %00000101 (bits 0,2)", inline=True)
# UNMAPPED: comment(0x9275, "Bit 3: &02 = %00000010 (bit 1)", inline=True)
...
# UNMAPPED: comment(0x927B, "Bit 4: &01 = %00000001 (bit 0)", inline=True)
...
# UNMAPPED: comment(0xA4E6, "Load from RX buffer", inline=True)
comment(0xA50F, "Store to osword_flag workspace", inline=True)
# UNMAPPED: comment(0xA4EB, "Next byte down", inline=True)
# UNMAPPED: comment(0xA4EC, "Loop for all 3 bytes", inline=True)
comment(0xA515, "Return from svc_8_osword", inline=True)

# osword_setup_handler: push handler address and save state
# UNMAPPED: comment(0xA4EF, "X = OSWORD index (0-6)", inline=True)
...
# UNMAPPED: comment(0xA4F8, "Copy 3 bytes (Y=2,1,0)", inline=True)

# Save osword_flag to RX buffer (reverse of return copy)
# UNMAPPED: comment(0xA4FA, "Load from osword_flag workspace", inline=True)
# UNMAPPED: comment(0xA4FD, "Store to RX buffer", inline=True)
# UNMAPPED: comment(0xA4FF, "Next byte down", inline=True)
# UNMAPPED: comment(0xA500, "Loop for all 3 bytes", inline=True)
# UNMAPPED: comment(0xA502, "Y=0 (INY from -1)", inline=True)
...
# UNMAPPED: comment(0xA516, "Save A for later test", inline=True)
comment(0xA531, "Test station active flag", inline=True)
comment(0xA534, "Not active: just return", inline=True)
# UNMAPPED: comment(0xA51C, "Restore A (OSWORD sub-code)", inline=True)
...
# UNMAPPED: comment(0xA5B1, "Load PB byte 0 (OSWORD flag)", inline=True)
...
# UNMAPPED: comment(0xA63F, "lo-sub 0: read FS station", inline=True)
# UNMAPPED: comment(0xA640, "lo-sub 1: set FS station", inline=True)
# UNMAPPED: comment(0xA641, "lo-sub 2: read workspace pair", inline=True)
# UNMAPPED: comment(0xA642, "lo-sub 3: write workspace pair", inline=True)
# UNMAPPED: comment(0xA643, "lo-sub 4: read protection mask", inline=True)
# UNMAPPED: comment(0xA644, "lo-sub 5: write protection mask", inline=True)
# UNMAPPED: comment(0xA645, "lo-sub 6: read FCB handles", inline=True)
# UNMAPPED: comment(0xA646, "lo-sub 7: set FCB handles", inline=True)
# UNMAPPED: comment(0xA647, "lo-sub 8: read RX flag", inline=True)
# UNMAPPED: comment(0xA648, "lo-sub 9: read RX port", inline=True)
# UNMAPPED: comment(0xA649, "lo-sub 10: read error flag", inline=True)
# UNMAPPED: comment(0xA64A, "lo-sub 11: read context byte", inline=True)
# UNMAPPED: comment(0xA64B, "lo-sub 12: read CSD path", inline=True)
# UNMAPPED: comment(0xA64C, "lo-sub 13: write CSD path", inline=True)
# UNMAPPED: comment(0xA64D, "lo-sub 14: read free buffers", inline=True)
# UNMAPPED: comment(0xA64E, "lo-sub 15: read 3 context bytes", inline=True)
# UNMAPPED: comment(0xA64F, "lo-sub 16: write 3 context bytes", inline=True)
# UNMAPPED: comment(0xA650, "lo-sub 17: query bridge status", inline=True)

# OSWORD &13 dispatch table: hi bytes
# UNMAPPED: comment(0xA651, "hi-sub 0: read FS station", inline=True)
comment(0xA64F, "hi-sub 1: set FS station", inline=True)
# UNMAPPED: comment(0xA653, "hi-sub 2: read workspace pair", inline=True)
...
# UNMAPPED: comment(0xA65E, "hi-sub 13: write CSD path", inline=True)
...
# UNMAPPED: comment(0xA801, "Store to PB[1] and return", inline=True)

# osword_13_read_context (&A804): sub 11 — read context byte
comment(0xA802, "Load context byte", inline=True)
# UNMAPPED: comment(0xA807, "Store to PB[1] and return", inline=True)
...
# UNMAPPED: comment(0xA810, "Y=1", inline=True)
# UNMAPPED: comment(0xA811, "Store A to PB[1]", inline=True)
# UNMAPPED: comment(0xA813, "Return", inline=True)
...
# UNMAPPED: comment(0xA839, "Return", inline=True)
...
# UNMAPPED: comment(0xA85A, "TX 10: &9C (port echo)", inline=True)
...
# UNMAPPED: comment(0xA860, "RX 4: buf start lo (&72)", inline=True)
# UNMAPPED: comment(0xA861, "RX 5: buf start hi (&0D) -> &0D72", inline=True)
# UNMAPPED: comment(0xA862, "RX 6: extended addr fill (&FF)", inline=True)
# UNMAPPED: comment(0xA863, "RX 7: extended addr fill (&FF)", inline=True)
# UNMAPPED: comment(0xA864, "RX 8: buf end lo (&74)", inline=True)
comment(0xA862, "RX 9: buf end hi (&0D) -> &0D74", inline=True)
# UNMAPPED: comment(0xA866, "RX 10: extended addr fill (&FF)", inline=True)
# UNMAPPED: comment(0xA867, "RX 11: extended addr fill (&FF)", inline=True)
...
# UNMAPPED: comment(0xA8A4, "X = result status", inline=True)
comment(0xA8A2, "Save TX status", inline=True)
# UNMAPPED: comment(0xA8A6, "Save PB pointer high", inline=True)
# UNMAPPED: comment(0xA8A8, "Push for later restore", inline=True)
# UNMAPPED: comment(0xA8A9, "X = PB pointer low", inline=True)
comment(0xA8A3, "OSBYTE &13: wait for VSYNC", inline=True)
comment(0xA8A5, "Wait for vertical sync", inline=True)
# UNMAPPED: comment(0xA8B0, "Restore PB pointer high", inline=True)
# UNMAPPED: comment(0xA8B1, "Restore to osword_pb_ptr_hi", inline=True)
...
# UNMAPPED: comment(0xA90B, "Enable interrupts", inline=True)
...
# UNMAPPED: comment(0xAA3C, "Range 2 only: OSWORD &7A", inline=True)
# UNMAPPED: comment(0xAA3D, "Range 2 only: OSWORD &86", inline=True)
...
# UNMAPPED: comment(0xAAA0, "Wide &70: port=&00", inline=True)
comment(0xAAB3, "Wide &71: skip (dest station)", inline=True)
# UNMAPPED: comment(0xAAA2, "Wide &72: skip (dest network)", inline=True)
# UNMAPPED: comment(0xAAA3, "Wide &73: buf start lo=&7D", inline=True)
...
# UNMAPPED: comment(0xAAA8, "Wide &78: buf end hi=page ptr", inline=True)
# UNMAPPED: comment(0xAAA9, "Wide &79: buf end ext lo", inline=True)
...
# UNMAPPED: comment(0xAAAE, "Narrow &0C: ctrl=&80 (standard)", inline=True)
# UNMAPPED: comment(0xAAAF, "Narrow &0D: port=&93", inline=True)
comment(0xAAC2, "Narrow &0E: skip (dest station)", inline=True)
# UNMAPPED: comment(0xAAB1, "Narrow &0F: skip (dest network)", inline=True)
# UNMAPPED: comment(0xAAB2, "Narrow &10: buf start lo=&D9", inline=True)
...
# UNMAPPED: comment(0xAAB7, "Narrow &15: buf end hi=page ptr", inline=True)
# UNMAPPED: comment(0xAAB8, "Narrow &16: buf end ext lo", inline=True)
comment(0xAACB, "Narrow &17: buf end ext hi", inline=True)
comment(0xAACC, "Spool stop (&FE terminator)", inline=True)
# UNMAPPED: comment(0xAABB, "Spool &01: port=&D1", inline=True)
# UNMAPPED: comment(0xAABC, "Spool &02: skip (dest station)", inline=True)
comment(0xAACF, "Spool &03: skip (dest network)", inline=True)
# UNMAPPED: comment(0xAABE, "Spool &04: buf start lo=&25", inline=True)
# UNMAPPED: comment(0xAABF, "Spool &05: skip (buf start hi)", inline=True)
...
# UNMAPPED: comment(0xAAC3, "Spool &09: skip (buf end hi)", inline=True)
# UNMAPPED: comment(0xAAC4, "Spool &0A: buf end ext lo", inline=True)
...
# UNMAPPED: comment(0xABFE, "A=&A7: printer jammed error number", inline=True)
...
# UNMAPPED: comment(0xAC72, "buf start lo=&43", inline=True)
# UNMAPPED: comment(0xAC73, "buf start hi=&8E", inline=True)
# UNMAPPED: comment(0xAC74, "buf start ext lo=&FF", inline=True)
# UNMAPPED: comment(0xAC75, "buf start ext hi=&FF", inline=True)
# UNMAPPED: comment(0xAC76, "buf end lo=&4B", inline=True)
# UNMAPPED: comment(0xAC77, "buf end hi=&8E", inline=True)
# UNMAPPED: comment(0xAC78, "buf end ext lo=&FF", inline=True)
# UNMAPPED: comment(0xAC79, "buf end ext hi=&FF", inline=True)
...
# UNMAPPED: comment(0xAC7D, "skip: preserve dest network", inline=True)
# UNMAPPED: comment(0xAC7E, "buf start lo=&31", inline=True)
...
# UNMAPPED: comment(0xAC82, "buf end lo=&34", inline=True)
# UNMAPPED: comment(0xAC83, "buf end hi=page ptr (&FC)", inline=True)
...
# UNMAPPED: comment(0xACFB, "OSBYTE mode read codes\n"
# UNMAPPED:     "\n"
# UNMAPPED:     "Three OSBYTE numbers used by read_osbyte_to_ws\n"
# UNMAPPED:     "to save display mode state to workspace before\n"
# UNMAPPED:     "a language 2 file transfer.")
# UNMAPPED: comment(0xACFB, "OSBYTE &85: read display start addr", inline=True)
# UNMAPPED: comment(0xACFC, "OSBYTE &C2: read video ULA ctrl", inline=True)
...
# UNMAPPED: comment(0xBA80, "Space separator", inline=True)
# UNMAPPED: comment(0xBA82, "Print space between hex bytes", inline=True)
...
# UNMAPPED: comment(0xBAA1, "Inline string terminator (NOP)", inline=True)
# UNMAPPED: comment(0xBAA2, "X += 16: restore byte count for ASCII", inline=True)
# UNMAPPED: comment(0xBAA5, "Start from first data byte", inline=True)
...
# UNMAPPED: comment(0xBAE0, "Inline string terminator (NOP)", inline=True)
# UNMAPPED: comment(0xBAE1, "Restore starting column number", inline=True)
# UNMAPPED: comment(0xBAE2, "16 column headers to print", inline=True)

# Column header print loop
# UNMAPPED: comment(0xBAE4, "Save current column number", inline=True)
comment(0xBAF2, "Print as two hex digits", inline=True)
# UNMAPPED: comment(0xBAE8, "Space separator", inline=True)
# UNMAPPED: comment(0xBAEA, "Print space after column number", inline=True)
# UNMAPPED: comment(0xBAED, "Restore column number", inline=True)
...
# UNMAPPED: comment(0xBC44, "More bytes to check", inline=True)
...
# UNMAPPED: comment(0xB3D7, "Inline string terminator (NOP)", inline=True)
...
# UNMAPPED: comment(0xB42E, "Return with character in A", inline=True)
...
# UNMAPPED: comment(0xB42F, "A=0: clear value", inline=True)
# UNMAPPED: comment(0xB431, "Y=&78: clear offsets &00-&77", inline=True)
# UNMAPPED: comment(0xB433, "Decrement index", inline=True)
# UNMAPPED: comment(0xB434, "Clear workspace byte via l00cc", inline=True)
# UNMAPPED: comment(0xB436, "Loop until Y=0", inline=True)
...
# UNMAPPED: comment(0xB4DF, "Offset &0E in receive buffer", inline=True)
# UNMAPPED: comment(0xB4E1, "Store attribute in receive buffer", inline=True)
...
# UNMAPPED: comment(0xB4F9, "Return", inline=True)
...
# UNMAPPED: comment(0xB54B, "Branch always to scan entry", inline=True)
# UNMAPPED: comment(0xB54D, "C=1: close with write-flush", inline=True)
...
# UNMAPPED: comment(0xB636, "Offset &0E in receive buffer", inline=True)
# UNMAPPED: comment(0xB638, "Save current receive attribute", inline=True)
...
# UNMAPPED: comment(0xB64B, "Offset &0E", inline=True)
# UNMAPPED: comment(0xB64D, "Restore receive attribute", inline=True)
...
# UNMAPPED: comment(0xB6A3, "Store in TX buffer", inline=True)
comment(0xB6B0, "Store station low in FCB", inline=True)
comment(0xB6B3, "Load working station high", inline=True)
# UNMAPPED: comment(0xB6AC, "Store in TX buffer", inline=True)
...
# UNMAPPED: comment(0xB6BC, "Command byte = 0", inline=True)
# UNMAPPED: comment(0xB6BE, "Store in TX buffer", inline=True)
# UNMAPPED: comment(0xB6C1, "X=1: flag byte", inline=True)
# UNMAPPED: comment(0xB6C2, "Store in TX buffer", inline=True)
# UNMAPPED: comment(0xB6C5, "Function code &0D", inline=True)
# UNMAPPED: comment(0xB6C7, "X=5: copy 5 bytes to TX", inline=True)
...
# UNMAPPED: comment(0xB6CF, "Offset &0E", inline=True)
# UNMAPPED: comment(0xB6D1, "Save current receive attribute", inline=True)
...
# UNMAPPED: comment(0xB6E1, "Offset &0E", inline=True)
# UNMAPPED: comment(0xB6E3, "Restore receive attribute", inline=True)
...
# UNMAPPED: comment(0xB7A3, "Save fs_options", inline=True)
comment(0xB7A2, "Push fs_options", inline=True)
# UNMAPPED: comment(0xB7A6, "Save fs_block_offset", inline=True)
# UNMAPPED: comment(0xB7A8, "Push fs_block_offset", inline=True)
...
# UNMAPPED: comment(0xB7C5, "Store fs_block_offset", inline=True)
# UNMAPPED: comment(0xB7C7, "Restore fs_options", inline=True)
# UNMAPPED: comment(0xB7C8, "Store fs_options", inline=True)
...
# UNMAPPED: comment(0xB80C, "Offset &0E", inline=True)
# UNMAPPED: comment(0xB80E, "Clear attribute in receive buffer", inline=True)
...
# UNMAPPED: comment(0xB832, "Offset &0E", inline=True)
# UNMAPPED: comment(0xB834, "Clear attribute in receive buffer", inline=True)
...
# UNMAPPED: comment(0xB898, "Save X", inline=True)
# UNMAPPED: comment(0xB899, "Push X", inline=True)
# UNMAPPED: comment(0xB89A, "Save Y (FCB slot)", inline=True)
# UNMAPPED: comment(0xB89B, "Push Y", inline=True)
# UNMAPPED: comment(0xB89C, "Load reply port for FCB", inline=True)
# UNMAPPED: comment(0xB89F, "Save reply port", inline=True)
# UNMAPPED: comment(0xB8A0, "Y=0: no nested context", inline=True)
...
# UNMAPPED: comment(0xB915, "Offset &0E", inline=True)
# UNMAPPED: comment(0xB917, "Clear attribute in receive buffer", inline=True)
...
# UNMAPPED: comment(0x96DA, "Y=&0E: offset to error code in RX buffer", inline=True)
# UNMAPPED: comment(0x96DC, "Load network error code from reply", inline=True)
...
# UNMAPPED: comment(0x96EE, "Y=&0E: error code offset", inline=True)
# UNMAPPED: comment(0x96F0, "Load error code from RX buffer", inline=True)
...
# UNMAPPED: comment(0x979A, "Class 2: &A2 \"Station\"", inline=True)
# UNMAPPED: comment(0x979B, "Class 3: &A3 \"No clock\"", inline=True)
...
# UNMAPPED: comment(0x97A2, "Index 10: \" on channel\" suffix", inline=True)
comment(0x97B8, "Index 11: \" not present\" suffix", inline=True)

# error_msg_table (&97A4) — error number + string entries
# UNMAPPED: comment(0x97A4, "Network error message table\n"
# UNMAPPED:     "\n"
...
# UNMAPPED: comment(0x97A4, "Error &A0: Line jammed", inline=True)
...
# UNMAPPED: comment(0x97C4, "Null terminator", inline=True)
# UNMAPPED: comment(0x97C5, "Error &A3: No clock", inline=True)
comment(0x97E3, "Null terminator", inline=True)
comment(0x97E4, "Error &11: Escape", inline=True)
# UNMAPPED: comment(0x97D6, "Null terminator", inline=True)
comment(0x97EC, "Error &CB: Bad option", inline=True)
# UNMAPPED: comment(0x97E2, "Null terminator", inline=True)
# UNMAPPED: comment(0x97E3, "Error &A5: No reply from station", inline=True)
# UNMAPPED: comment(0x97F9, "Null terminator", inline=True)
# UNMAPPED: comment(0x97FA, "Suffix: \" not listening\"", inline=True)
...
comment(0x984F, "Write control byte back to CB", inline=True)
...
# UNMAPPED: comment(0x9876, "Offset 3: &FD skip (preserve dest net)", inline=True)
# UNMAPPED: comment(0x9877, "Offset 4: buf start lo (&3A)", inline=True)
comment(0x988D, "Offset 5: buf start hi (&0D) -> &0D3A", inline=True)
# UNMAPPED: comment(0x9879, "Offset 6: extended addr fill (&FF)", inline=True)
# UNMAPPED: comment(0x987A, "Offset 7: extended addr fill (&FF)", inline=True)
comment(0x9890, "Offset 8: buf end lo (&3E)", inline=True)
# UNMAPPED: comment(0x987C, "Offset 9: buf end hi (&0D) -> &0D3E", inline=True)
# UNMAPPED: comment(0x987D, "Offset 10: extended addr fill (&FF)", inline=True)
...
# UNMAPPED: comment(0x98FD, "Y=0: reset command line offset", inline=True)
...
# UNMAPPED: comment(0x9A33, "Printed all 12 characters?", inline=True)
...
# UNMAPPED: comment(0x9B83, "Unreachable dead code (3 bytes)\n"
# UNMAPPED:     "\n"
# UNMAPPED:     "Duplicate of the JMP at &9B80 immediately above.\n"
# UNMAPPED:     "Unreachable after the unconditional JMP and\n"
# UNMAPPED:     "unreferenced. Likely a development remnant.")
# UNMAPPED: comment(0x9B83, "Dead: duplicate JMP finalise_and_return", inline=True)
...
# UNMAPPED: comment(0x9BFD, "Y=&0E: error code offset", inline=True)
# UNMAPPED: comment(0x9BFF, "Store channel char in RX buffer", inline=True)
...
# UNMAPPED: comment(0x9CBE, "Y=&0E: error code offset", inline=True)
# UNMAPPED: comment(0x9CC0, "Clear error code in RX buffer", inline=True)
...
# UNMAPPED: comment(0x9D0F, "Y=&0E: error code offset", inline=True)
# UNMAPPED: comment(0x9D11, "Store &FF as error flag in RX buffer", inline=True)
