...
# SUSPECT: comment(0xA524, "lo-&0F: (unimplemented)", inline=True)
# SUSPECT: comment(0xA525, "lo-&10: Transmit", inline=True)
# SUSPECT: comment(0xA526, "lo-&11: Receive", inline=True)
# SUSPECT: comment(0xA527, "lo-&12: Read station info", inline=True)
comment(0xA523, "lo-&13: Misc operations", inline=True)
# SUSPECT: comment(0xA524, "lo-&14: Bridge/net config", inline=True)
comment(0xA52B, "hi-&0E: Read clock", inline=True)
# SUSPECT: comment(0xA52C, "hi-&0F: (unimplemented)", inline=True)
comment(0xA52D, "hi-&10: Transmit", inline=True)
# SUSPECT: comment(0xA52E, "hi-&11: Receive", inline=True)
comment(0xA52F, "hi-&12: Read station info", inline=True)
# SUSPECT: comment(0xA530, "hi-&13: Misc operations", inline=True)
...
# SUSPECT: comment(0xA99E, "lo OSWORD 0: no-op (RTS)", inline=True)
# SUSPECT: comment(0xA99F, "lo OSWORD 1: printer spool data", inline=True)
# SUSPECT: comment(0xA9A0, "lo OSWORD 2: printer spool data", inline=True)
# SUSPECT: comment(0xA9A1, "lo OSWORD 3: printer spool data", inline=True)
# SUSPECT: comment(0xA9A2, "lo OSWORD 4: clear carry + abort", inline=True)
# SUSPECT: comment(0xA9A3, "lo OSWORD 5: spool buffer check", inline=True)
# SUSPECT: comment(0xA9A4, "lo OSWORD 6: no-op (RTS)", inline=True)
# SUSPECT: comment(0xA9A5, "lo OSWORD 7: claim/release handler", inline=True)
# SUSPECT: comment(0xA9A6, "lo OSWORD 8: copy PB + abort", inline=True)
# SUSPECT: comment(0xA9A7, "hi OSWORD 0: no-op (RTS)", inline=True)
# SUSPECT: comment(0xA9A8, "hi OSWORD 1: printer spool data", inline=True)
# SUSPECT: comment(0xA9A9, "hi OSWORD 2: printer spool data", inline=True)
comment(0xA9AA, "hi OSWORD 3: printer spool data", inline=True)
comment(0xA9AB, "hi OSWORD 4: clear carry + abort", inline=True)
# SUSPECT: comment(0xA9AC, "hi OSWORD 5: spool buffer check", inline=True)
comment(0xA9AD, "hi OSWORD 6: no-op (RTS)", inline=True)
# SUSPECT: comment(0xA9AE, "hi OSWORD 7: claim/release handler", inline=True)
# SUSPECT: comment(0xA9AF, "hi OSWORD 8: copy PB + abort", inline=True)
...
# SUSPECT: comment(0x8488, "Ctrl &81: PEEK", inline=True)
# SUSPECT: comment(0x8489, "Ctrl &82: POKE", inline=True)
# SUSPECT: comment(0x848A, "Ctrl &83: JSR", inline=True)
# SUSPECT: comment(0x848B, "Ctrl &84: UserProc", inline=True)
# SUSPECT: comment(0x848C, "Ctrl &85: OSProc", inline=True)
# SUSPECT: comment(0x848D, "Ctrl &86: HALT", inline=True)
# SUSPECT: comment(0x848E, "Ctrl &87: CONTINUE", inline=True)
# SUSPECT: comment(0x848F, "Ctrl &88: machine type query", inline=True)
...
# SUSPECT: comment(0x8028, "A=4: SR bit mask for IFR test", inline=True)
...
# SUSPECT: comment(0x8052, "Y=&FE: Econet event number", inline=True)
...
# SUSPECT: comment(0x8490, "A=0: port buffer lo at page boundary", inline=True)
...
# SUSPECT: comment(0x84AC, "Svc 5 dispatch table low bytes", inline=True)
...
# SUSPECT: comment(0x853E, "Y=&83: lo &38 -> tx_done_jsr (&8539)", inline=True)
# SUSPECT: comment(0x853F, "Y=&84: lo &41 -> tx_done_econet_event", inline=True)
# SUSPECT: comment(0x8540, "Y=&85: lo &4F -> tx_done_os_proc", inline=True)
# SUSPECT: comment(0x8541, "Y=&86: lo &5B -> tx_done_halt", inline=True)
# SUSPECT: comment(0x8542, "Y=&87: lo &72 -> tx_done_continue", inline=True)
...
comment(0x8681, "TX ctrl dispatch table (lo bytes)\n"
    ...
    "the table.")
# SUSPECT: comment(0x8681, "Ctrl &81 PEEK: tx_ctrl_peek", inline=True)
# SUSPECT: comment(0x8682, "Ctrl &82 POKE: tx_ctrl_poke", inline=True)
# SUSPECT: comment(0x8683, "Ctrl &83 JSR: proc_op_status2", inline=True)
# SUSPECT: comment(0x8684, "Ctrl &84 UserProc: proc_op_status2", inline=True)
# SUSPECT: comment(0x8685, "Ctrl &85 OSProc: proc_op_status2", inline=True)
# SUSPECT: comment(0x8686, "Ctrl &86 HALT: tx_ctrl_exit", inline=True)
# SUSPECT: comment(0x8687, "Ctrl &87 CONTINUE: tx_ctrl_exit", inline=True)
# SUSPECT: comment(0x8688, "Ctrl &88 MachType: tx_ctrl_machine_type", inline=True)
# SUSPECT: comment(0x8689, "scout_status=3 (machine type query)", inline=True)
...
# SUSPECT: comment(0x88F0, "Dead data: &01", inline=True)
comment(0x88F1, "Dead data: &81", inline=True)
# SUSPECT: comment(0x88F2, "Y=7: offset to RXCB buffer addr byte 3", inline=True)
...
# SUSPECT: comment(0x89C8, "Dead data: &00", inline=True)
# SUSPECT: comment(0x89C9, "Dead data: &08", inline=True)
...
# SUSPECT: comment(0x8A6F, "Store service number as ROM counter", inline=True)
...
# SUSPECT: comment(0x8A8E, "Get ROM slot being checked", inline=True)
...
# SUSPECT: comment(0x8A98, "Decrement ROM counter", inline=True)
...
# SUSPECT: comment(0x8B6C, "Offset &0E in receive block", inline=True)
# SUSPECT: comment(0x8B6E, "Clear receive block flag", inline=True)
...
# SUSPECT: comment(0x8BBB, "Y=9: max command name length", inline=True)
# SUSPECT: comment(0x8BBD, "Load first char of command name", inline=True)
...
# SUSPECT: comment(0x8CB5, "NOP (string terminator)", inline=True)
# SUSPECT: comment(0x8CB6, "Print station number", inline=True)
# SUSPECT: comment(0x8CB9, "Get current ROM slot number", inline=True)
...
# SUSPECT: comment(0x8D17, "Get command line offset", inline=True)
...
# SUSPECT: comment(0x8D79, "Save Y (command line offset)", inline=True)
...
# SUSPECT: comment(0x8E5F, "Dead data: &01", inline=True)
# SUSPECT: comment(0x8E60, "Dead data: &00", inline=True)

# SUSPECT: comment(0x8E83, "X=0", inline=True)
...
# SUSPECT: comment(0x8E8A, "NETV handler: netv_handler (&A968)", inline=True)

# SUSPECT: comment(0x8E8C, "X=0", inline=True)
...
# SUSPECT: comment(0x8F85, "Store &FF in workspace flag", inline=True)
...
# SUSPECT: comment(0x9003, "Offset 5: station ID", inline=True)
# SUSPECT: comment(0x9005, "Load station ID from receive block", inline=True)
...
# SUSPECT: comment(0x9029, "Null terminator", inline=True)
comment(0x902A, "Syn 2: *I Am (login)", inline=True)
comment(0x9042, "Line break", inline=True)
# SUSPECT: comment(0x9043, "Syn 2 continued: password clause", inline=True)
# SUSPECT: comment(0x9056, "Null terminator", inline=True)
comment(0x9057, "Syn 3: *Delete, *FS, *Remove", inline=True)
# SUSPECT: comment(0x905F, "Null terminator", inline=True)
# SUSPECT: comment(0x9060, "Syn 4: *Dump", inline=True)
# SUSPECT: comment(0x9075, "Line break", inline=True)
...
# SUSPECT: comment(0x9088, "Null terminator", inline=True)
# SUSPECT: comment(0x9089, "Syn 6: *CDir", inline=True)
# SUSPECT: comment(0x9099, "Null terminator", inline=True)
comment(0x909A, "Syn 7: *Pass", inline=True)
# SUSPECT: comment(0x90AD, "Line break", inline=True)
comment(0x90AE, "Syn 7 continued: new password", inline=True)
# SUSPECT: comment(0x90BC, "Null terminator", inline=True)
# SUSPECT: comment(0x90BD, "Syn 8: *PS, *Pollps", inline=True)
# SUSPECT: comment(0x90D3, "Null terminator", inline=True)
...
# SUSPECT: comment(0x9123, "Idx 1: \"(<dir>)\" (Y wraps via &FF)", inline=True)
...
# SUSPECT: comment(0x9127, "Idx 5: \"<dir>\"", inline=True)
# SUSPECT: comment(0x9128, "Idx 6: \"<dir> (<number>)\"", inline=True)
...
# SUSPECT: comment(0x912C, "Idx 10: \"<filename> <new filename>\"", inline=True)
...
# SUSPECT: comment(0x948D, "Offset 2: txcb_dest lo (overwritten)", inline=True)
# SUSPECT: comment(0x948E, "Offset 3: txcb_dest hi (overwritten)", inline=True)
...
# SUSPECT: comment(0xA3F2, "*Close cont (dispatch hi base)", inline=True)
# SUSPECT: comment(0xA3F5, "No syntax", inline=True)
# SUSPECT: comment(0xA3F6, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA3F8, "*Dump", inline=True)
# SUSPECT: comment(0xA3FC, "V no arg; syn 4: <filename> ...", inline=True)
# SUSPECT: comment(0xA3FD, "Dispatch addr-1", inline=True)
comment(0xA3FF, "*Net (select NFS)", inline=True)
comment(0xA402, "No syntax", inline=True)
# SUSPECT: comment(0xA403, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA405, "*Pollps", inline=True)
comment(0xA40B, "Syn 8: (<stn. id.>|<ps type>)", inline=True)
# SUSPECT: comment(0xA40C, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA40E, "*Print", inline=True)
comment(0xA413, "V no arg; syn 12: <filename>", inline=True)
# SUSPECT: comment(0xA414, "Dispatch addr-1", inline=True)
comment(0xA416, "*Prot", inline=True)
comment(0xA41A, "Syn 14: (attribute keywords)", inline=True)
# SUSPECT: comment(0xA41B, "Dispatch addr-1", inline=True)
comment(0xA41D, "*PS; syn 8: (<stn. id.>|<ps type>)", inline=True)
# SUSPECT: comment(0xA420, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA422, "*Roff", inline=True)
comment(0xA426, "No syntax", inline=True)
# SUSPECT: comment(0xA427, "Dispatch addr-1", inline=True)
comment(0xA429, "*Type", inline=True)
comment(0xA42D, "V no arg; syn 12: <filename>", inline=True)
# SUSPECT: comment(0xA42E, "Dispatch addr-1", inline=True)
comment(0xA430, "*Unprot", inline=True)
comment(0xA436, "Syn 14: (attribute keywords)", inline=True)
# SUSPECT: comment(0xA437, "Dispatch addr-1", inline=True)
...
# SUSPECT: comment(0xA441, "Dispatch addr-1", inline=True)
comment(0xA443, "*Bye", inline=True)
# SUSPECT: comment(0xA446, "No syntax", inline=True)
# SUSPECT: comment(0xA447, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA449, "*Cdir", inline=True)
comment(0xA44D, "V no arg; syn 6: <dir> (<number>)", inline=True)
# SUSPECT: comment(0xA44E, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA450, "*Delete", inline=True)
# SUSPECT: comment(0xA456, "V no arg; syn 3: <object>", inline=True)
# SUSPECT: comment(0xA457, "Dispatch addr-1", inline=True)
comment(0xA459, "*Dir", inline=True)
comment(0xA45C, "Syn 1: (<dir>)", inline=True)
# SUSPECT: comment(0xA45D, "Dispatch addr-1", inline=True)
comment(0xA45F, "*Ex; syn 1: (<dir>)", inline=True)
# SUSPECT: comment(0xA462, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA464, "*Flip", inline=True)
comment(0xA468, "No syntax", inline=True)
# SUSPECT: comment(0xA469, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA46B, "*FS; syn 11: (<stn. id.>)", inline=True)
# SUSPECT: comment(0xA46E, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA470, "*Info", inline=True)
comment(0xA474, "V no arg; syn 3: <object>", inline=True)
# SUSPECT: comment(0xA475, "Dispatch addr-1", inline=True)
comment(0xA477, "*I am", inline=True)
comment(0xA47B, "V no arg; syn 2: (<stn>) <user>...", inline=True)
# SUSPECT: comment(0xA47C, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA47E, "*Lcat", inline=True)
comment(0xA482, "Syn 1: (<dir>)", inline=True)
# SUSPECT: comment(0xA483, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA485, "*Lex", inline=True)
comment(0xA488, "Syn 1: (<dir>)", inline=True)
# SUSPECT: comment(0xA489, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA48B, "*Lib", inline=True)
comment(0xA48E, "V no arg; syn 5: <dir>", inline=True)
# SUSPECT: comment(0xA48F, "Dispatch addr-1", inline=True)
comment(0xA491, "*Pass", inline=True)
comment(0xA495, "V no arg; syn 7: <pass> ...", inline=True)
# SUSPECT: comment(0xA496, "Dispatch addr-1", inline=True)
# SUSPECT: comment(0xA498, "*Remove", inline=True)
comment(0xA4A2, "V no arg; syn 3: <object>", inline=True)
# SUSPECT: comment(0xA4A3, "Dispatch addr-1", inline=True)
comment(0xA4A1, "*Rename", inline=True)
# SUSPECT: comment(0xA4A7, "V no arg; syn 10: <file> <new file>", inline=True)
# SUSPECT: comment(0xA4A8, "Dispatch addr-1", inline=True)
comment(0xA4AA, "*Wipe", inline=True)
# SUSPECT: comment(0xA4AE, "Syn 1: (<dir>)", inline=True)
# SUSPECT: comment(0xA4AF, "Dispatch addr-1", inline=True)
comment(0xA4B1, "End of NFS sub-table", inline=True)

# Sub-table 3: help topic handlers (&A49A-&A4AA)
# SUSPECT: comment(0xA4B2, "&09/&8E: before help-only entries", inline=True)
# SUSPECT: comment(0xA4B4, "*Net (local)", inline=True)
comment(0xA4B7, "No syntax", inline=True)
# SUSPECT: comment(0xA4B8, "Dispatch addr-1", inline=True)
comment(0xA4BA, "*Utils", inline=True)
comment(0xA4BF, "No syntax", inline=True)
# SUSPECT: comment(0xA4C0, "Dispatch addr-1", inline=True)
...
# SUSPECT: comment(0xA4C9, "*Unprot AND mask: ~bit 5", inline=True)
# SUSPECT: comment(0xA4CA, "JSR", inline=True)
...
# SUSPECT: comment(0xA4D6, "*Unprot AND mask: ~bit 0", inline=True)
comment(0xA4D7, "Poke", inline=True)
# SUSPECT: comment(0xA4DB, "Flag &FC: V no arg, syn 28 (unused)", inline=True)
comment(0xA4DC, "*Prot OR mask: bit 1", inline=True)
comment(0xA4DD, "*Unprot AND mask: ~bit 1", inline=True)
# SUSPECT: comment(0xA4DE, "Proc", inline=True)
...
# SUSPECT: comment(0xA4EB, "*Prot OR mask: bit 4", inline=True)
...
# SUSPECT: comment(0xAD48, "Index 5: threshold 39", inline=True)
# SUSPECT: comment(0xAD49, "Index 6: threshold 49", inline=True)
comment(0xAD4A, "Index 7: threshold 59", inline=True)
comment(0xAD4B, "Index 8: threshold 69", inline=True)
# SUSPECT: comment(0xAD4C, "Index 9: threshold 79", inline=True)
...
# SUSPECT: comment(0xAD50, "Index 13: threshold 118", inline=True)
# SUSPECT: comment(0xAD51, "Index 14: threshold 128", inline=True)
comment(0xAD52, "Index 15: threshold 138", inline=True)
comment(0xAD53, "Index 16: threshold 148", inline=True)
# SUSPECT: comment(0xAD54, "Index 17: threshold 157", inline=True)
comment(0xAD55, "Index 18: threshold 167", inline=True)
comment(0xAD56, "Index 19: threshold 177", inline=True)
# SUSPECT: comment(0xAD57, "Index 20: threshold 187", inline=True)
comment(0xAD58, "Index 21: threshold 197", inline=True)
# SUSPECT: comment(0xAD59, "Index 22: threshold 207", inline=True)
...
# SUSPECT: comment(0xAD5D, "Index 26: threshold 246", inline=True)
# SUSPECT: comment(0xAD5E, "Unused (index 27, never accessed)", inline=True)
...
# SUSPECT: comment(0xA3DF, "Opt 0: &A3C6 (don't-care, unused)", inline=True)
# SUSPECT: comment(0xA3E0, "Opt 1: &A3B7 'L.!BOOT' (*LOAD)", inline=True)
# SUSPECT: comment(0xA3E1, "Opt 2: &A3B9 '!BOOT' (*RUN)", inline=True)
# SUSPECT: comment(0xA3E2, "Opt 3: &A3BF 'E.!BOOT' (*EXEC)", inline=True)
# SUSPECT: comment(0xA3E3, "Load boot type", inline=True)
...
# SUSPECT: comment(0xB251, "Start of PS name in buffer", inline=True)
...
# SUSPECT: comment(0xB266, "Padding byte", inline=True)

# Poll each printer slot
# SUSPECT: comment(0xB267, "Get slot offset from stack", inline=True)
...
# SUSPECT: comment(0xB28B, "X=0 for indirect indexed access", inline=True)
...
# SUSPECT: comment(0xB299, "Clear V", inline=True)
...
# SUSPECT: comment(0xB2B7, "Advance past status byte", inline=True)
...
# SUSPECT: comment(0xB2D0, "Advance past station low", inline=True)
# SUSPECT: comment(0xB2D2, "Read client network number", inline=True)
...
# SUSPECT: comment(0xADB5, "Print as 3-digit decimal", inline=True)
comment(0xADB8, "Print ')     '", inline=True)
# SUSPECT: comment(0xADD3, "Get owner/public flag", inline=True)
comment(0xADD6, "Non-zero: public access", inline=True)
comment(0xADD8, "Print 'Owner' + CR", inline=True)
# SUSPECT: comment(0xADE1, "Skip public; ALWAYS branch", inline=True)
comment(0xADE3, "Print 'Public' + CR", inline=True)

# Directory info: option, dir name, lib name
# SUSPECT: comment(0xADED, "Get flags", inline=True)
# SUSPECT: comment(0xADF0, "Save flags", inline=True)
...
# SUSPECT: comment(0xAE0D, "Get option byte", inline=True)
...
# SUSPECT: comment(0xAE07, "Index into option string table", inline=True)
# SUSPECT: comment(0xAE0A, "Get option name character", inline=True)
# SUSPECT: comment(0xAE0D, "High bit set: end of string", inline=True)
# SUSPECT: comment(0xAE12, "Next character", inline=True)
# SUSPECT: comment(0xAE13, "Loop; ALWAYS branch", inline=True)
# SUSPECT: comment(0xAE15, "Print ')' + CR + 'Dir. '", inline=True)
# SUSPECT: comment(0xAE31, "Offset &11: directory name", inline=True)
# SUSPECT: comment(0xAE33, "Print directory name (10 chars)", inline=True)
comment(0xAE3A, "Print '     Lib. '", inline=True)
# SUSPECT: comment(0xAE43, "Offset &1B: library name", inline=True)
...
# SUSPECT: comment(0xAF12, "No: continue copying", inline=True)
...
# SUSPECT: comment(0xAF58, "Skip newline; ALWAYS branch", inline=True)
# SUSPECT: comment(0xAF5A, "CR character for newline", inline=True)
...
# SUSPECT: comment(0xB0AB, "Clear V", inline=True)
comment(0xB0AE, "Print 'now '", inline=True)
# SUSPECT: comment(0xB0B5, "Padding", inline=True)
# SUSPECT: comment(0xB0B6, "Print FS info and newline", inline=True)
...
# SUSPECT: comment(0xB0CC, "Clear V", inline=True)
...
# SUSPECT: comment(0xB0E8, "Padding", inline=True)
# SUSPECT: comment(0xB0E9, "Return", inline=True)
...
# SUSPECT: comment(0xB1B1, "Get station number", inline=True)
...
# SUSPECT: comment(0xB1BB, "Data buffer start lo (&14)", inline=True)
# SUSPECT: comment(0xB1BC, "Data buffer start hi (= rx page)", inline=True)
comment(0xB1BD, "Data buffer end lo (placeholder)", inline=True)
comment(0xB1BE, "Data buffer end hi (placeholder)", inline=True)
# SUSPECT: comment(0xB1BF, "Reply buffer start lo (&1C)", inline=True)
...
# SUSPECT: comment(0x952D, "Next channel", inline=True)
# SUSPECT: comment(0x952E, "Loop all 16 channels", inline=True)
...
# SUSPECT: comment(0x9547, "Reload reply status code", inline=True)
# SUSPECT: comment(0x954A, "Check pending operation", inline=True)
...
# SUSPECT: comment(0xA17D, "'\"' double quote", inline=True)
# SUSPECT: comment(0xA17E, "'#' hash", inline=True)
comment(0xA17F, "'$' dollar", inline=True)
# SUSPECT: comment(0xA180, "'&' ampersand", inline=True)
...
# SUSPECT: comment(0xA185, "Restore saved Y", inline=True)
# SUSPECT: comment(0xA186, "Transfer to Y", inline=True)
...
# SUSPECT: comment(0xA299, "Copy argument to buffer (X=0)", inline=True)
...
# SUSPECT: comment(0x9287, "Bit 1: &20 = %00100000 (bit 5)", inline=True)
comment(0x9288, "Bit 2: &05 = %00000101 (bits 0,2)", inline=True)
# SUSPECT: comment(0x9289, "Bit 3: &02 = %00000010 (bit 1)", inline=True)
...
# SUSPECT: comment(0x928F, "Bit 4: &01 = %00000001 (bit 0)", inline=True)
...
# SUSPECT: comment(0xA50E, "Load from RX buffer", inline=True)
comment(0xA50F, "Store to osword_flag workspace", inline=True)
# SUSPECT: comment(0xA512, "Next byte down", inline=True)
# SUSPECT: comment(0xA513, "Loop for all 3 bytes", inline=True)
...
# SUSPECT: comment(0xA525, "Next byte down", inline=True)
# SUSPECT: comment(0xA526, "Loop for all 3 bytes", inline=True)
# SUSPECT: comment(0xA528, "Y=0 (INY from -1)", inline=True)
...
# SUSPECT: comment(0xA532, "Save A for later test", inline=True)
...
# SUSPECT: comment(0xA5CA, "Load PB byte 0 (OSWORD flag)", inline=True)
...
# SUSPECT: comment(0xA63C, "lo-sub 0: read FS station", inline=True)
# SUSPECT: comment(0xA63D, "lo-sub 1: set FS station", inline=True)
# SUSPECT: comment(0xA63E, "lo-sub 2: read workspace pair", inline=True)
# SUSPECT: comment(0xA63F, "lo-sub 3: write workspace pair", inline=True)
# SUSPECT: comment(0xA640, "lo-sub 4: read protection mask", inline=True)
# SUSPECT: comment(0xA641, "lo-sub 5: write protection mask", inline=True)
# SUSPECT: comment(0xA642, "lo-sub 6: read FCB handles", inline=True)
# SUSPECT: comment(0xA643, "lo-sub 7: set FCB handles", inline=True)
# SUSPECT: comment(0xA644, "lo-sub 8: read RX flag", inline=True)
# SUSPECT: comment(0xA645, "lo-sub 9: read RX port", inline=True)
# SUSPECT: comment(0xA646, "lo-sub 10: read error flag", inline=True)
# SUSPECT: comment(0xA647, "lo-sub 11: read context byte", inline=True)
# SUSPECT: comment(0xA648, "lo-sub 12: read CSD path", inline=True)
# SUSPECT: comment(0xA649, "lo-sub 13: write CSD path", inline=True)
# SUSPECT: comment(0xA64A, "lo-sub 14: read free buffers", inline=True)
# SUSPECT: comment(0xA64B, "lo-sub 15: read 3 context bytes", inline=True)
# SUSPECT: comment(0xA64C, "lo-sub 16: write 3 context bytes", inline=True)
# SUSPECT: comment(0xA64D, "lo-sub 17: query bridge status", inline=True)

# OSWORD &13 dispatch table: hi bytes
# SUSPECT: comment(0xA64E, "hi-sub 0: read FS station", inline=True)
comment(0xA64F, "hi-sub 1: set FS station", inline=True)
# SUSPECT: comment(0xA650, "hi-sub 2: read workspace pair", inline=True)
...
# SUSPECT: comment(0xA65B, "hi-sub 13: write CSD path", inline=True)
...
# SUSPECT: comment(0xA7FE, "Store to PB[1] and return", inline=True)

# osword_13_read_context (&A804): sub 11 — read context byte
comment(0xA802, "Load context byte", inline=True)
# SUSPECT: comment(0xA805, "Store to PB[1] and return", inline=True)
...
# SUSPECT: comment(0xA80D, "Y=1", inline=True)
# SUSPECT: comment(0xA80E, "Store A to PB[1]", inline=True)
...
# SUSPECT: comment(0xA834, "Return", inline=True)
...
# SUSPECT: comment(0xA857, "TX 10: &9C (port echo)", inline=True)
...
# SUSPECT: comment(0xA85D, "RX 4: buf start lo (&72)", inline=True)
# SUSPECT: comment(0xA85E, "RX 5: buf start hi (&0D) -> &0D72", inline=True)
# SUSPECT: comment(0xA85F, "RX 6: extended addr fill (&FF)", inline=True)
# SUSPECT: comment(0xA860, "RX 7: extended addr fill (&FF)", inline=True)
# SUSPECT: comment(0xA861, "RX 8: buf end lo (&74)", inline=True)
comment(0xA862, "RX 9: buf end hi (&0D) -> &0D74", inline=True)
# SUSPECT: comment(0xA863, "RX 10: extended addr fill (&FF)", inline=True)
# SUSPECT: comment(0xA864, "RX 11: extended addr fill (&FF)", inline=True)
...
# SUSPECT: comment(0xA8A1, "X = result status", inline=True)
...
# SUSPECT: comment(0xA8A6, "X = PB pointer low", inline=True)
...
# SUSPECT: comment(0xAA4E, "Range 2 only: OSWORD &7A", inline=True)
# SUSPECT: comment(0xAA4F, "Range 2 only: OSWORD &86", inline=True)
...
# SUSPECT: comment(0xAAB2, "Wide &70: port=&00", inline=True)
comment(0xAAB3, "Wide &71: skip (dest station)", inline=True)
# SUSPECT: comment(0xAAB4, "Wide &72: skip (dest network)", inline=True)
# SUSPECT: comment(0xAAB5, "Wide &73: buf start lo=&7D", inline=True)
...
# SUSPECT: comment(0xAABA, "Wide &78: buf end hi=page ptr", inline=True)
# SUSPECT: comment(0xAABB, "Wide &79: buf end ext lo", inline=True)
...
# SUSPECT: comment(0xAAC0, "Narrow &0C: ctrl=&80 (standard)", inline=True)
# SUSPECT: comment(0xAAC1, "Narrow &0D: port=&93", inline=True)
comment(0xAAC2, "Narrow &0E: skip (dest station)", inline=True)
# SUSPECT: comment(0xAAC3, "Narrow &0F: skip (dest network)", inline=True)
# SUSPECT: comment(0xAAC4, "Narrow &10: buf start lo=&D9", inline=True)
...
# SUSPECT: comment(0xAAC9, "Narrow &15: buf end hi=page ptr", inline=True)
# SUSPECT: comment(0xAACA, "Narrow &16: buf end ext lo", inline=True)
comment(0xAACB, "Narrow &17: buf end ext hi", inline=True)
comment(0xAACC, "Spool stop (&FE terminator)", inline=True)
# SUSPECT: comment(0xAACD, "Spool &01: port=&D1", inline=True)
# SUSPECT: comment(0xAACE, "Spool &02: skip (dest station)", inline=True)
comment(0xAACF, "Spool &03: skip (dest network)", inline=True)
# SUSPECT: comment(0xAAD0, "Spool &04: buf start lo=&25", inline=True)
# SUSPECT: comment(0xAAD1, "Spool &05: skip (buf start hi)", inline=True)
...
# SUSPECT: comment(0xAAD5, "Spool &09: skip (buf end hi)", inline=True)
# SUSPECT: comment(0xAAD6, "Spool &0A: buf end ext lo", inline=True)
...
# SUSPECT: comment(0xAC10, "A=&A7: printer jammed error number", inline=True)
...
# SUSPECT: comment(0xAC84, "buf start lo=&43", inline=True)
# SUSPECT: comment(0xAC85, "buf start hi=&8E", inline=True)
# SUSPECT: comment(0xAC86, "buf start ext lo=&FF", inline=True)
# SUSPECT: comment(0xAC87, "buf start ext hi=&FF", inline=True)
# SUSPECT: comment(0xAC88, "buf end lo=&4B", inline=True)
# SUSPECT: comment(0xAC89, "buf end hi=&8E", inline=True)
# SUSPECT: comment(0xAC8A, "buf end ext lo=&FF", inline=True)
# SUSPECT: comment(0xAC8B, "buf end ext hi=&FF", inline=True)
...
# SUSPECT: comment(0xAC8F, "skip: preserve dest network", inline=True)
# SUSPECT: comment(0xAC90, "buf start lo=&31", inline=True)
...
# SUSPECT: comment(0xAC94, "buf end lo=&34", inline=True)
# SUSPECT: comment(0xAC95, "buf end hi=page ptr (&FC)", inline=True)
...
# SUSPECT: comment(0xAD0D, "OSBYTE &85: read display start addr", inline=True)
# SUSPECT: comment(0xAD0E, "OSBYTE &C2: read video ULA ctrl", inline=True)
...
# SUSPECT: comment(0xBA97, "Print space between hex bytes", inline=True)
...
# SUSPECT: comment(0xBAB1, "Inline string terminator (NOP)", inline=True)
# SUSPECT: comment(0xBAB2, "X += 16: restore byte count for ASCII", inline=True)
# SUSPECT: comment(0xBAB5, "Start from first data byte", inline=True)
...
# SUSPECT: comment(0xBAEF, "Inline string terminator (NOP)", inline=True)
# SUSPECT: comment(0xBAF0, "Restore starting column number", inline=True)
# SUSPECT: comment(0xBAF1, "16 column headers to print", inline=True)

# Column header print loop
# SUSPECT: comment(0xBAF3, "Save current column number", inline=True)
comment(0xBAF2, "Print as two hex digits", inline=True)
comment(0xBAF5, "Space separator", inline=True)
# SUSPECT: comment(0xBAF7, "Print space after column number", inline=True)
...
# SUSPECT: comment(0xBBFD, "More bytes to check", inline=True)
...
# SUSPECT: comment(0xB3EE, "Inline string terminator (NOP)", inline=True)
...
# SUSPECT: comment(0xB44D, "Decrement index", inline=True)
# SUSPECT: comment(0xB44E, "Clear workspace byte via l00cc", inline=True)
...
# SUSPECT: comment(0xB4EF, "Offset &0E in receive buffer", inline=True)
# SUSPECT: comment(0xB4F1, "Store attribute in receive buffer", inline=True)
...
# SUSPECT: comment(0xB508, "Return", inline=True)
...
# SUSPECT: comment(0xB55C, "C=1: close with write-flush", inline=True)
...
# SUSPECT: comment(0xB642, "Offset &0E in receive buffer", inline=True)
# SUSPECT: comment(0xB644, "Save current receive attribute", inline=True)
...
# SUSPECT: comment(0xB656, "Offset &0E", inline=True)
# SUSPECT: comment(0xB658, "Restore receive attribute", inline=True)
...
# SUSPECT: comment(0xB6C5, "Store in TX buffer", inline=True)
# SUSPECT: comment(0xB6C8, "X=1: flag byte", inline=True)
# SUSPECT: comment(0xB6C9, "Store in TX buffer", inline=True)
comment(0xB6CC, "Function code &0D", inline=True)
# SUSPECT: comment(0xB6CE, "X=5: copy 5 bytes to TX", inline=True)
...
# SUSPECT: comment(0xB6C9, "Offset &0E", inline=True)
# SUSPECT: comment(0xB6CB, "Save current receive attribute", inline=True)
...
# SUSPECT: comment(0xB6DA, "Offset &0E", inline=True)
# SUSPECT: comment(0xB6DC, "Restore receive attribute", inline=True)
...
# SUSPECT: comment(0xB79D, "Save fs_options", inline=True)
comment(0xB7A2, "Push fs_options", inline=True)
# SUSPECT: comment(0xB7A3, "Save fs_block_offset", inline=True)
# SUSPECT: comment(0xB7A5, "Push fs_block_offset", inline=True)
...
# SUSPECT: comment(0xB7C4, "Store fs_block_offset", inline=True)
# SUSPECT: comment(0xB7C6, "Restore fs_options", inline=True)
# SUSPECT: comment(0xB7C7, "Store fs_options", inline=True)
...
# SUSPECT: comment(0xB80B, "Offset &0E", inline=True)
# SUSPECT: comment(0xB80D, "Clear attribute in receive buffer", inline=True)
...
# SUSPECT: comment(0xB830, "Offset &0E", inline=True)
# SUSPECT: comment(0xB832, "Clear attribute in receive buffer", inline=True)
...
# SUSPECT: comment(0xB896, "Push X", inline=True)
# SUSPECT: comment(0xB897, "Save Y (FCB slot)", inline=True)
comment(0xB898, "Push Y", inline=True)
# SUSPECT: comment(0xB899, "Load reply port for FCB", inline=True)
# SUSPECT: comment(0xB89C, "Save reply port", inline=True)
...
# SUSPECT: comment(0xB8D0, "Offset &0E", inline=True)
# SUSPECT: comment(0xB8D2, "Clear attribute in receive buffer", inline=True)
...
# SUSPECT: comment(0x96F0, "Y=&0E: offset to error code in RX buffer", inline=True)
# SUSPECT: comment(0x96F2, "Load network error code from reply", inline=True)
...
# SUSPECT: comment(0x9703, "Y=&0E: error code offset", inline=True)
# SUSPECT: comment(0x9705, "Load error code from RX buffer", inline=True)
...
# SUSPECT: comment(0x97AF, "Class 2: &A2 \"Station\"", inline=True)
# SUSPECT: comment(0x97B0, "Class 3: &A3 \"No clock\"", inline=True)
...
# SUSPECT: comment(0x97B7, "Index 10: \" on channel\" suffix", inline=True)
...
# SUSPECT: comment(0x97B9, "Error &A0: Line jammed", inline=True)
...
# SUSPECT: comment(0x97D9, "Null terminator", inline=True)
# SUSPECT: comment(0x97DA, "Error &A3: No clock", inline=True)
comment(0x97E3, "Null terminator", inline=True)
comment(0x97E4, "Error &11: Escape", inline=True)
# SUSPECT: comment(0x97EB, "Null terminator", inline=True)
comment(0x97EC, "Error &CB: Bad option", inline=True)
# SUSPECT: comment(0x97F7, "Null terminator", inline=True)
# SUSPECT: comment(0x97F8, "Error &A5: No reply from station", inline=True)
# SUSPECT: comment(0x980E, "Null terminator", inline=True)
# SUSPECT: comment(0x980F, "Suffix: \" not listening\"", inline=True)
...
# SUSPECT: comment(0x988B, "Offset 3: &FD skip (preserve dest net)", inline=True)
# SUSPECT: comment(0x988C, "Offset 4: buf start lo (&3A)", inline=True)
comment(0x988D, "Offset 5: buf start hi (&0D) -> &0D3A", inline=True)
# SUSPECT: comment(0x988E, "Offset 6: extended addr fill (&FF)", inline=True)
# SUSPECT: comment(0x988F, "Offset 7: extended addr fill (&FF)", inline=True)
comment(0x9890, "Offset 8: buf end lo (&3E)", inline=True)
# SUSPECT: comment(0x9891, "Offset 9: buf end hi (&0D) -> &0D3E", inline=True)
# SUSPECT: comment(0x9892, "Offset 10: extended addr fill (&FF)", inline=True)
...
# SUSPECT: comment(0x9912, "Y=0: reset command line offset", inline=True)
...
# SUSPECT: comment(0x9C0C, "Y=&0E: error code offset", inline=True)
# SUSPECT: comment(0x9C0E, "Store channel char in RX buffer", inline=True)
...
# SUSPECT: comment(0x9CCC, "Y=&0E: error code offset", inline=True)
# SUSPECT: comment(0x9CCE, "Clear error code in RX buffer", inline=True)
...
# SUSPECT: comment(0x9D1C, "Y=&0E: error code offset", inline=True)
# SUSPECT: comment(0x9D1E, "Store &FF as error flag in RX buffer", inline=True)
