...
comment(0xA524, "lo-&0F: (unimplemented)", inline=True)
comment(0xA525, "lo-&10: Transmit", inline=True)
comment(0xA526, "lo-&11: Receive", inline=True)
comment(0xA527, "lo-&12: Read station info", inline=True)
comment(0xA523, "lo-&13: Misc operations", inline=True)
comment(0xA524, "lo-&14: Bridge/net config", inline=True)
...
comment(0xA52E, "hi-&11: Receive", inline=True)
comment(0xA52F, "hi-&12: Read station info", inline=True)
comment(0xA530, "hi-&13: Misc operations", inline=True)
...
comment(0xA99E, "lo OSWORD 0: no-op (RTS)", inline=True)
comment(0xA99F, "lo OSWORD 1: printer spool data", inline=True)
comment(0xA9A0, "lo OSWORD 2: printer spool data", inline=True)
comment(0xA9A1, "lo OSWORD 3: printer spool data", inline=True)
comment(0xA9A2, "lo OSWORD 4: clear carry + abort", inline=True)
comment(0xA9A3, "lo OSWORD 5: spool buffer check", inline=True)
comment(0xA9A4, "lo OSWORD 6: no-op (RTS)", inline=True)
comment(0xA9A5, "lo OSWORD 7: claim/release handler", inline=True)
comment(0xA9A6, "lo OSWORD 8: copy PB + abort", inline=True)
...
comment(0x8488, "Ctrl &81: PEEK", inline=True)
comment(0x8489, "Ctrl &82: POKE", inline=True)
comment(0x848A, "Ctrl &83: JSR", inline=True)
comment(0x848B, "Ctrl &84: UserProc", inline=True)
comment(0x848C, "Ctrl &85: OSProc", inline=True)
comment(0x848D, "Ctrl &86: HALT", inline=True)
comment(0x848E, "Ctrl &87: CONTINUE", inline=True)
comment(0x848F, "Ctrl &88: machine type query", inline=True)
...
comment(0x8052, "Y=&FE: Econet event number", inline=True)
...
comment(0x84AC, "Svc 5 dispatch table low bytes", inline=True)
...
comment(0x853E, "Y=&83: lo &38 -> tx_done_jsr (&8539)", inline=True)
comment(0x853F, "Y=&84: lo &41 -> tx_done_econet_event", inline=True)
comment(0x8540, "Y=&85: lo &4F -> tx_done_os_proc", inline=True)
comment(0x8541, "Y=&86: lo &5B -> tx_done_halt", inline=True)
comment(0x8542, "Y=&87: lo &72 -> tx_done_continue", inline=True)
...
comment(0x8681, "TX ctrl dispatch table (lo bytes)\n"
    ...
    "the table.")
comment(0x8681, "Ctrl &81 PEEK: tx_ctrl_peek", inline=True)
comment(0x8682, "Ctrl &82 POKE: tx_ctrl_poke", inline=True)
comment(0x8683, "Ctrl &83 JSR: proc_op_status2", inline=True)
comment(0x8684, "Ctrl &84 UserProc: proc_op_status2", inline=True)
comment(0x8685, "Ctrl &85 OSProc: proc_op_status2", inline=True)
comment(0x8686, "Ctrl &86 HALT: tx_ctrl_exit", inline=True)
comment(0x8687, "Ctrl &87 CONTINUE: tx_ctrl_exit", inline=True)
comment(0x8688, "Ctrl &88 MachType: tx_ctrl_machine_type", inline=True)
...
comment(0x89C9, "Dead data: &08", inline=True)
...
comment(0x8A6F, "Store service number as ROM counter", inline=True)
...
comment(0x8A8E, "Get ROM slot being checked", inline=True)
...
comment(0x8A98, "Decrement ROM counter", inline=True)
...
comment(0x8B6C, "Offset &0E in receive block", inline=True)
comment(0x8B6E, "Clear receive block flag", inline=True)
...
comment(0x8BBD, "Load first char of command name", inline=True)
...
comment(0x8CB6, "Print station number", inline=True)
...
comment(0x8E8A, "NETV handler: netv_handler (&A968)", inline=True)
...
comment(0x8F85, "Store &FF in workspace flag", inline=True)
...
comment(0x9003, "Offset 5: station ID", inline=True)
...
comment(0xA3F6, "Dispatch addr-1", inline=True)
comment(0xA3F8, "*Dump", inline=True)
comment(0xA3FC, "V no arg; syn 4: <filename> ...", inline=True)
comment(0xA3FD, "Dispatch addr-1", inline=True)
...
comment(0xA3DF, "Opt 0: &A3C6 (don't-care, unused)", inline=True)
comment(0xA3E0, "Opt 1: &A3B7 'L.!BOOT' (*LOAD)", inline=True)
comment(0xA3E1, "Opt 2: &A3B9 '!BOOT' (*RUN)", inline=True)
comment(0xA3E2, "Opt 3: &A3BF 'E.!BOOT' (*EXEC)", inline=True)
...
comment(0xB251, "Start of PS name in buffer", inline=True)
...
comment(0xB2D0, "Advance past station low", inline=True)
comment(0xB2D2, "Read client network number", inline=True)
...
comment(0xAF12, "No: continue copying", inline=True)
...
comment(0xB0B6, "Print FS info and newline", inline=True)
...
comment(0xB1BB, "Data buffer start lo (&14)", inline=True)
...
comment(0xB1BF, "Reply buffer start lo (&1C)", inline=True)
...
comment(0x952D, "Next channel", inline=True)
comment(0x952E, "Loop all 16 channels", inline=True)
...
comment(0x954A, "Check pending operation", inline=True)
...
comment(0xA299, "Copy argument to buffer (X=0)", inline=True)
...
comment(0xA50E, "Load from RX buffer", inline=True)
comment(0xA50F, "Store to osword_flag workspace", inline=True)
comment(0xA512, "Next byte down", inline=True)
comment(0xA513, "Loop for all 3 bytes", inline=True)
...
comment(0xA525, "Next byte down", inline=True)
comment(0xA526, "Loop for all 3 bytes", inline=True)
comment(0xA528, "Y=0 (INY from -1)", inline=True)
...
comment(0xA532, "Save A for later test", inline=True)
...
comment(0xA5CA, "Load PB byte 0 (OSWORD flag)", inline=True)
...
comment(0xA63C, "lo-sub 0: read FS station", inline=True)
comment(0xA63D, "lo-sub 1: set FS station", inline=True)
comment(0xA63E, "lo-sub 2: read workspace pair", inline=True)
comment(0xA63F, "lo-sub 3: write workspace pair", inline=True)
comment(0xA640, "lo-sub 4: read protection mask", inline=True)
comment(0xA641, "lo-sub 5: write protection mask", inline=True)
comment(0xA642, "lo-sub 6: read FCB handles", inline=True)
comment(0xA643, "lo-sub 7: set FCB handles", inline=True)
comment(0xA644, "lo-sub 8: read RX flag", inline=True)
comment(0xA645, "lo-sub 9: read RX port", inline=True)
comment(0xA646, "lo-sub 10: read error flag", inline=True)
comment(0xA647, "lo-sub 11: read context byte", inline=True)
comment(0xA648, "lo-sub 12: read CSD path", inline=True)
comment(0xA649, "lo-sub 13: write CSD path", inline=True)
comment(0xA64A, "lo-sub 14: read free buffers", inline=True)
comment(0xA64B, "lo-sub 15: read 3 context bytes", inline=True)
comment(0xA64C, "lo-sub 16: write 3 context bytes", inline=True)
comment(0xA64D, "lo-sub 17: query bridge status", inline=True)
...
comment(0xA7FE, "Store to PB[1] and return", inline=True)

# osword_13_read_context (&A804): sub 11 — read context byte
comment(0xA802, "Load context byte", inline=True)
comment(0xA805, "Store to PB[1] and return", inline=True)
...
comment(0xA80D, "Y=1", inline=True)
comment(0xA80E, "Store A to PB[1]", inline=True)
...
comment(0xA834, "Return", inline=True)
...
comment(0xA85D, "RX 4: buf start lo (&72)", inline=True)
...
comment(0xA861, "RX 8: buf end lo (&74)", inline=True)
...
comment(0xA8A1, "X = result status", inline=True)
...
comment(0xA8A6, "X = PB pointer low", inline=True)
...
comment(0xAACE, "Spool &02: skip (dest station)", inline=True)
comment(0xAACF, "Spool &03: skip (dest network)", inline=True)
comment(0xAAD0, "Spool &04: buf start lo=&25", inline=True)
...
comment(0xAC84, "buf start lo=&43", inline=True)
...
comment(0xAC88, "buf end lo=&4B", inline=True)
...
comment(0xAC8F, "skip: preserve dest network", inline=True)
comment(0xAC90, "buf start lo=&31", inline=True)
...
comment(0xAC94, "buf end lo=&34", inline=True)
...
comment(0xAD0D, "OSBYTE &85: read display start addr", inline=True)
...
comment(0xBA97, "Print space between hex bytes", inline=True)
...
comment(0xBAB1, "Inline string terminator (NOP)", inline=True)
comment(0xBAB2, "X += 16: restore byte count for ASCII", inline=True)
comment(0xBAB5, "Start from first data byte", inline=True)
...
comment(0xBAEF, "Inline string terminator (NOP)", inline=True)
comment(0xBAF0, "Restore starting column number", inline=True)
comment(0xBAF1, "16 column headers to print", inline=True)

# Column header print loop
comment(0xBAF3, "Save current column number", inline=True)
comment(0xBAF2, "Print as two hex digits", inline=True)
comment(0xBAF5, "Space separator", inline=True)
comment(0xBAF7, "Print space after column number", inline=True)
...
comment(0xBBFD, "More bytes to check", inline=True)
...
comment(0xB3EE, "Inline string terminator (NOP)", inline=True)
...
comment(0xB44D, "Decrement index", inline=True)
comment(0xB44E, "Clear workspace byte via l00cc", inline=True)
...
comment(0xB4EF, "Offset &0E in receive buffer", inline=True)
comment(0xB4F1, "Store attribute in receive buffer", inline=True)
...
comment(0xB55C, "C=1: close with write-flush", inline=True)
...
comment(0xB642, "Offset &0E in receive buffer", inline=True)
comment(0xB644, "Save current receive attribute", inline=True)
...
comment(0xB656, "Offset &0E", inline=True)
comment(0xB658, "Restore receive attribute", inline=True)
...
comment(0xB6C5, "Store in TX buffer", inline=True)
comment(0xB6C8, "X=1: flag byte", inline=True)
comment(0xB6C9, "Store in TX buffer", inline=True)
comment(0xB6CC, "Function code &0D", inline=True)
comment(0xB6CE, "X=5: copy 5 bytes to TX", inline=True)
...
comment(0xB6C9, "Offset &0E", inline=True)
comment(0xB6CB, "Save current receive attribute", inline=True)
...
comment(0xB6DA, "Offset &0E", inline=True)
comment(0xB6DC, "Restore receive attribute", inline=True)
...
comment(0xB79D, "Save fs_options", inline=True)
comment(0xB7A2, "Push fs_options", inline=True)
comment(0xB7A3, "Save fs_block_offset", inline=True)
comment(0xB7A5, "Push fs_block_offset", inline=True)
...
comment(0xB7C4, "Store fs_block_offset", inline=True)
comment(0xB7C6, "Restore fs_options", inline=True)
comment(0xB7C7, "Store fs_options", inline=True)
...
comment(0xB80B, "Offset &0E", inline=True)
comment(0xB80D, "Clear attribute in receive buffer", inline=True)
...
comment(0xB830, "Offset &0E", inline=True)
comment(0xB832, "Clear attribute in receive buffer", inline=True)
...
comment(0xB896, "Push X", inline=True)
comment(0xB897, "Save Y (FCB slot)", inline=True)
comment(0xB898, "Push Y", inline=True)
comment(0xB899, "Load reply port for FCB", inline=True)
...
comment(0xB8D0, "Offset &0E", inline=True)
comment(0xB8D2, "Clear attribute in receive buffer", inline=True)
...
comment(0x96F0, "Y=&0E: offset to error code in RX buffer", inline=True)
comment(0x96F2, "Load network error code from reply", inline=True)
...
comment(0x9703, "Y=&0E: error code offset", inline=True)
comment(0x9705, "Load error code from RX buffer", inline=True)
...
comment(0x9912, "Y=0: reset command line offset", inline=True)
...
comment(0x9C0C, "Y=&0E: error code offset", inline=True)
comment(0x9C0E, "Store channel char in RX buffer", inline=True)
...
comment(0x9CCC, "Y=&0E: error code offset", inline=True)
comment(0x9CCE, "Clear error code in RX buffer", inline=True)
...
comment(0x9D1C, "Y=&0E: error code offset", inline=True)
comment(0x9D1E, "Store &FF as error flag in RX buffer", inline=True)
