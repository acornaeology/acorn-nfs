...
; tx_poll_core (&85F1) is general-purpose.
;
; On Entry:
...
; Unreferenced data block (purpose unknown)
    equb &0e, &0e, &0a, &0a, &0a, &06, &06, &0a, &81, &00, &00, &00   ; 9eed: 0e 0e 0a... ......
    equb &00, &01, &01, &81                                           ; 9ef9: 00 01 01... ......   ; Unreferenced data block (purpose unknown)
; ***************************************************************************************
