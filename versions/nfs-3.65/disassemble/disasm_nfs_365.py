...
d.comment(
    0x800D,
    """The 'ROFF' suffix of "(C)ROFF" at [`cmd_roff_str`](label:cmd_roff_str) is reused by the `*ROFF` command matcher [`svc_4_star_command`](address:81A2?hex) — a space-saving trick that shares ROM bytes between the copyright string and the star-command-name table.
