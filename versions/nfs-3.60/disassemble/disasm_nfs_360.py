...
_rom_filepath = os.environ.get("FANTASM_ROM", str(_version_dirpath / "rom" / "nfs-3.60.rom"))
...
d.use_environment("acorn_sideways_rom", rom_title="NFS ROM 3.60 disassembly (Acorn Econet filing system)")
...
d.subroutine(
    ...
    description="""Copied from ROM at [`reloc_p5_src`](address:9462) during init.
...
d.comment(0x814B, "Set EVNTV high byte (EVNTV+1)", align=Align.INLINE)
...
d.comment(0x8155, "Set BRKV high byte (brkv+1)", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""The first 5 bytes (&81A9-&81AF) are the service handler epilogue:
...
d.subroutine(
    ...
    description="""Copies 14 bytes from l829a (&829A) into FILEV-FSCV (&0212),
...
d.comment(0x828B, "X = lo(run_fscv_cmd+5): auto-boot string", align=Align.INLINE)
...
d.index_base(0x829A, "fs_dispatch_addrs")
...
d.index_base(0x8580, "error_msg_table")
d.banner(
    0x8580,
...
d.index_base(0x8580, "msg_line_jammed")
d.label(0x858D, "msg_net_error")
d.label(0x8598, "msg_not_listening")
d.label(0x85A7, "msg_no_clock")
d.label(0x85B1, "msg_escape")
d.label(0x85B9, "msg_bad_option")
d.label(0x85C5, "msg_no_reply")
d.comment(0x8580, "Error &A0: Line Jammed", align=Align.INLINE)
d.comment(0x8581, '"Line Jammed" string', align=Align.INLINE)
d.comment(0x858D, "Error &A1: Net Error", align=Align.INLINE)
d.comment(0x858E, '"Net Error" string', align=Align.INLINE)
d.comment(0x8598, "Error &A2: Not listening", align=Align.INLINE)
d.comment(0x8599, '"Not listening" string', align=Align.INLINE)
d.comment(0x85A7, "Error &A3: No Clock", align=Align.INLINE)
d.comment(0x85A8, '"No Clock" string', align=Align.INLINE)
d.comment(0x85B1, "Error &11: Escape", align=Align.INLINE)
d.comment(0x85B2, '"Escape" string', align=Align.INLINE)
d.comment(0x85B9, "Error &CB: Bad Option", align=Align.INLINE)
d.comment(0x85BA, '"Bad Option" string', align=Align.INLINE)
d.comment(0x85C5, "Error &A5: No reply", align=Align.INLINE)
d.comment(0x85C6, '"No reply" string', align=Align.INLINE)
d.subroutine(
    0x85CF,
    "decode_attribs_6bit",
...
d.index_base(0x85EC, "access_bit_table")
...
d.subroutine(
    ...
    description="""Calls save_fscv_args (&864D) to preserve A/X/Y, then JSR &86DE
...
d.byte(0x8C57)
d.comment(0x8C57, "EX handler hi → &8C61 (ex_handler)", align=Align.INLINE)
d.byte(0x8C58)
...
d.index_base(0x8D54, "option_name_offsets")
...
d.index_base(0x8D68, "boot_string_offsets")
...
d.index_base(0x8EB8, "osword_handler_lo")
...
d.index_base(0x8EBD, "fs_osword_tbl_hi")
...
d.index_base(0x8EFF, "osword_12_offsets")
...
d.comment(0x8FB8, "Dest station = broadcast (accept reply from any station)", align=Align.INLINE)
...
d.comment(0x9029, "Set RX end address to max (accept any length)", align=Align.INLINE)
...
d.index_base(0x90A4, "osword_tbl_lo")
...
d.index_base(0x90AD, "osword_tbl_hi")
...
d.index_base(0x9145, "remote_osbyte_table")
...
d.comment(0x927C, "End address = max (unlimited data length)", align=Align.INLINE)
...
d.index_base(0x931E, "vdu_osbyte_table")
...
NMI shim from ROM (&9F7D) to RAM (nmi_code_base), patches the current
...
d.comment(0x9698, "Copy 32 bytes of NMI shim from ROM to nmi_code_base", align=Align.INLINE)
d.label(0x969A, "copy_nmi_shim")

d.comment(0x969A, "Read byte from NMI shim ROM source", align=Align.INLINE)
d.comment(0x969D, "Write to NMI shim RAM (nmi_code_base,Y)", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""Reached when the scout data loop sees no RDA (BPL at &9713) or
...
d.subroutine(
    ...
    description="""Installs nmi_rx_scout (&96BF) as the NMI handler via
...
d.comment(0x9A51, "CONTINUE(&87)/mc-type(&88) skip protection", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""Sets up a buffer at page &7F offset &25 (length 508 bytes) for
...
d.label(0x9BC5, "tx_dcd_clock_check")

d.comment(0x9BC5, "A=&20: mask for SR2 DCD (clock/carrier detect)", align=Align.INLINE)
d.comment(0x9BC7, "BIT SR2: test DCD -- is there a clock?", align=Align.INLINE)
d.comment(0x9BCA, "DCD set: no clock on the line, abandon TX", align=Align.INLINE)
...
d.comment(0x9BEC, "Read SR1 -- arms the CLR_RX_ST below", align=Align.INLINE)
...
d.comment(0x9FB5, "Padding", align=Align.INLINE)
...
# NFS's own usage (NFS's RAM layout differs from ANFS, so names are not
# borrowed across chains).
