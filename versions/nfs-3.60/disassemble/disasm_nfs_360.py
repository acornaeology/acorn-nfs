...
subroutine(0x9AAA, "rx_imm_machine_type", hook=None,
    ...
    description="""\
Sets up a buffer at page &7F offset &25 (length &01FC) for
...
header bytes as command strings:
  ...
  X=5: matches "NET" at title+4 — the ROM title suffix
...
comment(0x828B, "X = lo(run_fscv_cmd+5): auto-boot string", inline=True)
...
intoff_operand is referenced as a constant for self-modifying
