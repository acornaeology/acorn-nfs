...
.tube_osbyte_send_x
    ...
    bmi skip_param_read                                               ; 9596: 30 0f       0.  :0634[4]
...
.svc_11_nmi_claim
    ...
    bne handle_cb1_intr                                               ; 9641: d0 03       ..  :06df[4]
...
.print_inline_char
    ...
    bne print_next_char                                               ; 8666: d0 02       ..
...
.check_handshake_bit
    ...
    beq install_reply_scout                                           ; 9d26: f0 03       ..
...
.nmi_final_ack_validate
    ...
    bpl check_fv_final_ack                                            ; 9e9c: 10 03       ..
