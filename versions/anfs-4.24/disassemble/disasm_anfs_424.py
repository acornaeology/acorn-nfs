...
d.comment(0x8201, "A=&26: low byte of nmi_data_rx_bulk (&8226)", align=Align.INLINE)
...
d.comment(0x820D, "A=&A1: low byte of nmi_data_rx_tube (&82A1)", align=Align.INLINE)
...
d.comment(0x831F, "A=&26: low byte of nmi_ack_tx_src (&8326)", align=Align.INLINE)
...
d.comment(0x83FD, "A=&9D: low byte of nmi_rx_scout", align=Align.INLINE)
...
d.comment(0x871C, "X=&B6: low byte of nmi_tx_data (&87B6)", align=Align.INLINE)
...
d.comment(0x88A4, "A=&BA: low byte of nmi_data_tx alt-entry (&88BA)", align=Align.INLINE)
...
d.comment(0x8970, "A=&75: low byte of nmi_final_ack_net (&8975)", align=Align.INLINE)
...
d.comment(0x9C1B, "A=&C0: high byte of fs_filename_buf buffer", align=Align.INLINE)
