...
_svc_dispatch_entries = [
    ...
    (0x0010, 0x8F01, "svc_21_claim_abs_ws", "svc &21: claim absolute workspace (Hazel)"),
    (0x0011, 0x8F16, "svc_22_claim_private_ws", "svc &22: claim private workspace (Hazel)"),
    (0x0012, 0x8F08, "svc_23_record_abs_top", "svc &23: record top of absolute workspace"),
    (0x0013, 0x8E89, "svc_24_claim_private_page", "svc &24: reserve one private-workspace page"),
    (0x0014, 0x8E8B, "svc_25_return_fs_info", "svc &25: FS name + info reply"),
...
d.label(0x8F01, "svc_21_claim_abs_ws")
...
d.label(0x8F07, "rts_svc_21_claim_abs_ws")

d.comment(0x8F07, "Return", align=Align.INLINE)
d.label(0x8F08, "svc_23_record_abs_top")
...
d.comment(0x8F4D, "Yes: jump to svc_22_claim_private_ws (error path)", align=Align.INLINE)
