...
d.comment(0xA80E, "*HELP 'On' interactive-matcher entry: sub-table default word &8E44, keyword 'On', dispatch via &8E45", align=Align.INLINE)
...
d.comment(0xADE3, "Range 1+2: OSWORD &13 (net info)", align=Align.INLINE)
d.comment(0xB03B, "buf start lo", align=Align.INLINE)
d.comment(0x91FE, "Station-ID field pointer table (4 bytes)", align=Align.INLINE)
d.comment(0xABFB, "TX 11: &9C (data byte)", align=Align.INLINE)
...
d.comment(0x8815, "Y=&88: high byte of nmi_data_tx handler", align=Align.INLINE)
...
d.comment(0xA729, "X=&12: low byte of the -NET-FindLib command string (&A712)", align=Align.INLINE)
d.comment(0xA72B, "Y=&A7: high byte of the -NET-FindLib command string (&A712)", align=Align.INLINE)
