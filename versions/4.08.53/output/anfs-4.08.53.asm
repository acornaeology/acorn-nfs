...
tube_cmd_lo = tube_dispatch_cmd+1
    jmp (l0500)                                                       ; bef9: 6c 00 05    l.. :0050[1]   ; Dispatch to handler via indirect JMP
...
.c0400
    jmp tube_begin                                                    ; bf00: 4c 84 04    L.. :0400[2]   ; JMP to BEGIN startup entry
...
.tube_sendw_complete
    jsr tube_release_claim                                            ; bf71: 20 14 04     .. :0471[2]   ; SENDW complete: release, sync, restart
...
.claim_addr_ff
    ...
    jsr c0406                                                         ; bf9a: 20 06 04     .. :049a[2]   ; Request address claim from Tube system
    bcc claim_addr_ff                                                 ; bf9d: 90 f9       ..  :049d[2]   ; C=0: claim failed, retry
    jsr tube_init_reloc                                               ; bf9f: 20 d2 04     .. :049f[2]   ; Init reloc pointers from ROM header
; &bfa2 referenced 1 time by &04c4[2]
.next_rom_page
    lda #7                                                            ; bfa2: a9 07       ..  :04a2[2]   ; R4 cmd 7: SENDW to send ROM to parasite
    jsr tube_claim_default                                            ; bfa4: 20 cb 04     .. :04a4[2]   ; Set up Tube for SENDW transfer
...
.tube_claim_default
    ...
    jmp c0406                                                         ; bfcf: 4c 06 04    L.. :04cf[2]   ; Claim Tube address for transfer
...
.scan_copyright_end
    ...
    lda l8001,x                                                       ; bfeb: bd 01 80    ... :04eb[2]   ; Read 4-byte reloc address from ROM header
    sta tube_transfer_addr                                            ; bfee: 85 53       .S  :04ee[2]   ; Store reloc addr byte 1 as transfer addr
    lda l8002,x                                                       ; bff0: bd 02 80    ... :04f0[2]   ; Load reloc addr byte 2
...
.tube_osfind
    jsr tube_read_r2                                                  ; bcd2: 20 c5 06     .. :0542[3]   ; Read open mode from R2 for OSFIND
...
.tube_osfind_close
    jsr tube_read_r2                                                  ; bce2: 20 c5 06     .. :0552[3]   ; OSFIND close: read handle from R2
    tay                                                               ; bce5: a8          .   :0555[3]
...
.read_osargs_params
    jsr tube_read_r2                                                  ; bcf4: 20 c5 06     .. :0564[3]   ; Read next param byte from R2
    sta escape_flag,x                                                 ; bcf7: 95 ff       ..  :0567[3]
    dex                                                               ; bcf9: ca          .   :0569[3]
    bne read_osargs_params                                            ; bcfa: d0 f8       ..  :056a[3]
    jsr tube_read_r2                                                  ; bcfc: 20 c5 06     .. :056c[3]
...
.strnh
    jsr tube_read_r2                                                  ; bd16: 20 c5 06     .. :0586[3]   ; Read next string byte from R2
...
.argsw
    ...
    jsr tube_read_r2                                                  ; bd4c: 20 c5 06     .. :05bc[3]
...
.read_osgbpb_ctrl_blk
    jsr tube_read_r2                                                  ; bd63: 20 c5 06     .. :05d3[3]   ; Read next control block byte from R2
    sta escape_flag,x                                                 ; bd66: 95 ff       ..  :05d6[3]
    dex                                                               ; bd68: ca          .   :05d8[3]
    bne read_osgbpb_ctrl_blk                                          ; bd69: d0 f8       ..  :05d9[3]
    jsr tube_read_r2                                                  ; bd6b: 20 c5 06     .. :05db[3]
...
.tube_osbyte_long
    jsr tube_read_r2                                                  ; bd97: 20 c5 06     .. :0607[4]   ; Read X, Y, A from R2 for 3-param OSBYTE
    tax                                                               ; bd9a: aa          .   :060a[4]   ; Save in X
    jsr tube_read_r2                                                  ; bd9b: 20 c5 06     .. :060b[4]   ; Read Y parameter from co-processor
...
.tube_osword
    jsr tube_read_r2                                                  ; bdb7: 20 c5 06     .. :0627[4]   ; Overlapping entry: &20 = JSR c06c5 (OSWORD)
...
.read_rdln_ctrl_block
    jsr tube_read_r2                                                  ; bdfa: 20 c5 06     .. :066a[4]   ; Read control block byte from R2
...
; ***************************************************************************************
.nmi_handler
    lda #4                                                            ; 8023: a9 04       ..             ; Error &A5: No reply
    bit system_via_ifr                                                ; 8025: 2c 4d fe    ,M.
    bne c802d                                                         ; 8028: d0 03       ..
    lda #5                                                            ; 802a: a9 05       ..
    rts                                                               ; 802c: 60          `              ; RTS (end of save_vdu_state data)
...
.c802d
    ...
    tya                                                               ; 802f: 98          .
    pha                                                               ; 8030: 48          H
    lda system_via_acr                                                ; 8031: ad 4b fe    .K.
    and #&e3                                                          ; 8034: 29 e3       ).
    ora ws_0d64                                                       ; 8036: 0d 64 0d    .d.
    sta system_via_acr                                                ; 8039: 8d 4b fe    .K.
    lda system_via_sr                                                 ; 803c: ad 4a fe    .J.
    lda #4                                                            ; 803f: a9 04       ..
    sta system_via_ifr                                                ; 8041: 8d 4d fe    .M.
    sta system_via_ier                                                ; 8044: 8d 4e fe    .N.
    ldy ws_0d65                                                       ; 8047: ac 65 0d    .e.
    tya                                                               ; 804a: 98          .
    bmi c8052                                                         ; 804b: 30 05       0.
    ldy #&fe                                                          ; 804d: a0 fe       ..
    jmp c854a                                                         ; 804f: 4c 4a 85    LJ.
...
.dispatch_svc5
    lda #&85                                                          ; 8061: a9 85       ..             ; Push return addr high (&9B)
    pha                                                               ; 8063: 48          H              ; High byte on stack for RTS
    lda c84b1,y                                                       ; 8064: b9 b1 84    ...            ; Load dispatch target low byte
...
.adlc_init
    ...
    jsr adlc_full_reset                                               ; 806c: 20 5f 89     _.            ; Full ADLC hardware reset
...
.nmi_rx_scout
    ...
    beq scout_error                                                   ; 80b8: f0 38       .8             ; AP not set, no incoming data -- check for errors
...
.accept_frame
    lda #&d0                                                          ; 80cb: a9 d0       ..             ; Install next NMI handler at &9715 (RX scout second byte)
...
.nmi_rx_scout_net
    ...
    bpl scout_error                                                   ; 80d3: 10 1d       ..             ; No RDA -- check errors
...
.scout_reject
    ...
    jmp c83f1                                                         ; 80e3: 4c f1 83    L..            ; Return to idle scout listening
...
.accept_scout_net
    ...
    lda #2                                                            ; 80eb: a9 02       ..             ; Install scout data reading loop at &9747
...
.scout_error
    ...
    beq scout_discard                                                 ; 80f7: f0 06       ..             ; Neither set -- clean end, discard via &9A40
    jsr adlc_full_reset                                               ; 80f9: 20 5f 89     _.            ; Unexpected data/status: full ADLC reset
    jmp c83f1                                                         ; 80fc: 4c f1 83    L..            ; Discard and return to idle

; &80ff referenced 1 time by &80f7
.scout_discard
    jmp c83ee                                                         ; 80ff: 4c ee 83    L..            ; Gentle discard: RX_DISCONTINUE
...
.scout_loop_rda
    bpl scout_error                                                   ; 8107: 10 e9       ..             ; No RDA -- error handler &9737
    ...
    bne scout_complete                                                ; 8115: d0 15       ..             ; SR2 non-zero (FV or other) -- scout completion
...
.scout_loop_second
    ...
    beq scout_complete                                                ; 8120: f0 0a       ..             ; Buffer full (Y=12) -- force completion
...
.scout_complete
    ...
    beq scout_error                                                   ; 813b: f0 b5       ..             ; No FV -- not a valid frame end, error
    bpl scout_error                                                   ; 813d: 10 b3       ..             ; FV set but no RDA -- missing last byte, error
...
.scout_no_match
    jmp discard_after_reset                                           ; 8152: 4c 4b 84    LK.            ; Port = 0 -- immediate operation handler
...
.discard_no_match
    jmp nmi_error_dispatch                                            ; 81a1: 4c 2b 82    L+.            ; No match found -- discard frame
...
.port_match_found
    ...
    jsr tx_calc_transfer                                              ; 81b4: 20 e8 88     ..            ; Calculate transfer parameters
    bcc nmi_error_dispatch                                            ; 81b7: 90 72       .r             ; C=0: no Tube claimed -- discard
    ...
    jmp copy_scout_to_buffer                                          ; 81be: 4c 06 84    L..            ; Broadcast: different completion path
...
.send_data_rx_ack
    ...
    lda #&d2                                                          ; 81cb: a9 d2       ..             ; Install data_rx_setup at &97DC
...
.data_rx_setup
    ...
    lda #&dc                                                          ; 81d7: a9 dc       ..             ; Install nmi_data_rx at &97E6
...
.nmi_data_rx
    ...
    lda #&f0                                                          ; 81eb: a9 f0       ..             ; Install net check handler at &97FA
...
.nmi_data_rx_net
    ...
    bpl nmi_error_dispatch                                            ; 81f3: 10 36       .6             ; SR2 bit7 clear: no data ready -- error
    lda econet_data_continue_frame                                    ; 81f5: ad a2 fe    ...            ; Read dest network byte
    bne nmi_error_dispatch                                            ; 81f8: d0 31       .1             ; Network != 0: wrong network -- error
    lda #6                                                            ; 81fa: a9 06       ..             ; Install skip handler at &9810
    ldy #&82                                                          ; 81fc: a0 82       ..             ; High byte of &9810 handler
...
.nmi_data_rx_skip
    ...
    bpl nmi_error_dispatch                                            ; 8209: 10 20       .              ; SR2 bit7 clear: error
...
.install_data_rx_handler
    ...
    lda #&39 ; '9'                                                    ; 8218: a9 39       .9             ; Install bulk read at &9843
    ldy #&82                                                          ; 821a: a0 82       ..             ; High byte of &9843 handler
    bit econet_control1_or_status1                                    ; 821c: 2c a0 fe    ,..            ; SR1 bit7: more data already waiting?
    bmi nmi_data_rx_bulk                                              ; 821f: 30 18       0.             ; Yes: enter bulk read directly
    jmp set_nmi_vector                                                ; 8221: 4c 0e 0d    L..            ; No: install handler and RTI

; &8224 referenced 1 time by &8216
.install_tube_rx
    lda #&96                                                          ; 8224: a9 96       ..             ; Tube: install Tube RX at &98A0
    ldy #&82                                                          ; 8226: a0 82       ..             ; High byte of &98A0 handler
...
.nmi_error_dispatch
    ...
    jmp tx_result_fail                                                ; 8230: 4c ca 88    L..            ; Bit7 set: TX result = not listening

; &8233 referenced 1 time by &822e
.rx_error_reset
    jsr adlc_full_reset                                               ; 8233: 20 5f 89     _.            ; Full ADLC reset on RX error
    jmp c83eb                                                         ; 8236: 4c eb 83    L..            ; Discard and return to idle listen
...
.data_rx_loop
    bpl data_rx_complete                                              ; 823e: 10 2d       .-             ; SR2 bit7 clear: frame complete (FV)
    ...
    beq nmi_error_dispatch                                            ; 824c: f0 dd       ..             ; No pages left: handle as complete
...
.read_sr2_between_pairs
    ...
    bne data_rx_complete                                              ; 8253: d0 18       ..             ; SR2 non-zero, bit7 clear: frame done
...
.read_second_rx_byte
    ...
    beq data_rx_complete                                              ; 8263: f0 08       ..             ; No pages left: frame complete
...
.data_rx_complete
    ...
    beq nmi_error_dispatch                                            ; 827e: f0 ab       ..             ; No FV -- error
...
.read_last_rx_byte
    beq nmi_error_dispatch                                            ; 8284: f0 a5       ..             ; No buffer space: error/discard frame
...
.send_ack
    jmp ack_tx                                                        ; 8293: 4c e4 82    L..            ; Send ACK frame to complete handshake
...
.data_rx_tube_complete
    ...
    bpl ack_tx                                                        ; 82ca: 10 18       ..             ; FV set, no RDA: proceed to ACK
...
.ack_tx
    ...
    jsr advance_rx_buffer_ptr                                         ; 82e9: 20 44 83     D.            ; Final ACK: call completion handler
    jmp tx_result_ok                                                  ; 82ec: 4c c6 88    L..            ; Jump to TX success result
...
.ack_tx_configure
    ...
    lda #&8b                                                          ; 82f9: a9 8b       ..             ; Install saved next handler (&99BB for scout ACK)
...
.ack_tx_write_dest
    ...
    lda #&1b                                                          ; 8314: a9 1b       ..             ; Install handler at &9992 (write src addr)
...
.add_rxcb_ptr
    ...
    jsr c0406                                                         ; 8371: 20 06 04     ..            ; Claim Tube address for transfer
...
.return_rx_complete
    ...
    beq rx_complete_update_rxcb                                       ; 8395: f0 03       ..             ; Yes: POKE also needs data transfer
...
.skip_buf_ptr_update
    ...
    beq c83eb                                                         ; 83b4: f0 35       .5             ; Port=0: immediate op, discard+listen
...
.c83eb
    jsr discard_reset_listen                                          ; 83eb: 20 f8 83     ..
; &83ee referenced 3 times by &80ff, &8466, &8522
.c83ee
    jsr adlc_rx_listen                                                ; 83ee: 20 6e 89     n.
...
.c83fd
    ...
    jsr release_tube                                                  ; 8402: 20 3f 84     ?.            ; Release Tube claim before discarding
...
.scout_copy_done
    ...
    jmp rx_complete_update_rxcb                                       ; 842a: 4c 9a 83    L..            ; Jump to completion handler
...
.release_tube
    ...
    jsr c0406                                                         ; 8445: 20 06 04     ..            ; Release Tube address claim
...
.rotate_prot_mask
    ...
    bcs c83ee                                                         ; 8466: b0 86       ..             ; Bit set = operation disabled, discard
...
.dispatch_imm_op
    ...
    lda c83fd,y                                                       ; 846e: b9 fd 83    ...            ; Load handler low byte from jump table
...
.imm_op_out_of_range
    jmp nmi_error_dispatch                                            ; 847b: 4c 2b 82    L+.            ; Jump to discard handler
...
.rx_imm_peek
    ...
    jsr tx_calc_transfer                                              ; 84ce: 20 e8 88     ..            ; Calculate transfer size for response
...
.test_line_idle
    ...
    bne tx_prepare                                                    ; 860d: d0 34       .4             ; CTS set -- clock hardware detected, start TX
...
.inactive_retry
    ...
    bne c85f1                                                         ; 8617: d0 d8       ..             ; Not overflowed: retry INACTIVE test
    inc l0102,x                                                       ; 8619: fe 02 01    ...            ; Increment timeout counter byte 2
    bne c85f1                                                         ; 861c: d0 d3       ..             ; Not overflowed: retry INACTIVE test
    inc l0103,x                                                       ; 861e: fe 03 01    ...            ; Increment timeout counter byte 3
    bne c85f1                                                         ; 8621: d0 ce       ..             ; Not overflowed: retry INACTIVE test
...
.tx_prepare
    ...
    ldx #&e0                                                          ; 864b: a2 e0       ..             ; Install NMI handler at &9D4C (TX data handler)
    ...
    lda l85f6,y                                                       ; 8672: b9 f6 85    ...            ; Look up handler address low from table
...
.skip_buf_setup
    ...
    jsr tx_calc_transfer                                              ; 86d6: 20 e8 88     ..            ; Calculate transfer size from RXCB
...
.tx_fifo_write
    ...
    bcs tx_last_data                                                  ; 86fc: b0 1e       ..             ; Frame complete -- go to TX_LAST_DATA
...
.tx_last_data
    ...
    lda #&28 ; '('                                                    ; 8721: a9 28       .(             ; Install NMI handler at &9D94 (TX completion)
...
.nmi_tx_complete
    ...
    jmp tx_result_ok                                                  ; 8732: 4c c6 88    L..            ; bit6 set -- TX completion
...
.install_reply_scout
    lda #&44 ; 'D'                                                    ; 873f: a9 44       .D             ; Install RX reply handler at &9DB2
...
.nmi_reply_scout
    ...
    lda #&58 ; 'X'                                                    ; 8753: a9 58       .X             ; Install next handler at &9DC8 (reply continuation)
...
.nmi_reply_cont
    ...
    lda #&6f ; 'o'                                                    ; 8762: a9 6f       .o             ; Install next handler at &9DE3 (reply validation)
    bit econet_control1_or_status1                                    ; 8764: 2c a0 fe    ,..            ; BIT SR1: test IRQ (N=bit7) -- more data ready?
    bmi nmi_reply_validate                                            ; 8767: 30 06       0.             ; IRQ set -- fall through to &9DE3 without RTI
...
.nmi_reply_validate
    ...
    lda #&6e ; 'n'                                                    ; 8795: a9 6e       .n             ; Install next handler at &9EDD (four-way data phase) into &0D4B/&0D4C
    ldy #&88                                                          ; 8797: a0 88       ..             ; High byte &9E of next handler address
    ...
    bvc c87bd                                                         ; 87a5: 50 16       P.             ; TDRA not ready -- error
    ...
    lda #&b7                                                          ; 87b0: a9 b7       ..             ; Install handler at &9E2B (write src addr for scout ACK)
    ldy #&87                                                          ; 87b2: a0 87       ..             ; High byte &9D of handler address
...
.data_tx_begin
    ...
    lda #&e4                                                          ; 87ce: a9 e4       ..             ; Install nmi_data_tx at &9DC8
...
.install_imm_data_nmi
    lda #&2d ; '-'                                                    ; 87d5: a9 2d       .-             ; Install nmi_imm_data at &9E0F
...
.nmi_data_tx
    ...
    beq data_tx_last                                                  ; 87de: f0 33       .3
    ldy port_buf_len                                                  ; 87e0: a4 a2       ..
    beq c87e8                                                         ; 87e2: f0 04       ..
    ldy port_buf_len                                                  ; 87e4: a4 a2       ..
    beq nmi_data_tx                                                   ; 87e6: f0 f4       ..
...
.data_tx_last
    ...
    lda #&eb                                                          ; 881d: a9 eb       ..             ; Install discard_reset_listen at &99DB
    ldy #&83                                                          ; 881f: a0 83       ..             ; High byte of &99DB handler
...
.tx_tdra_error
    ...
    bpl tx_result_fail                                                ; 8869: 10 5f       ._             ; Bit7 clear: TX result = not listening
    jmp c83eb                                                         ; 886b: 4c eb 83    L..            ; Bit7 set: discard and return to listen
...
.handshake_await_ack
    ...
    lda #&7a ; 'z'                                                    ; 8873: a9 7a       .z             ; Install handler at &9EE9 (RX final ACK)
...
.nmi_final_ack
    ...
    beq tx_result_fail                                                ; 887f: f0 49       .I             ; No AP -- error
    ...
    lda #&8e                                                          ; 8889: a9 8e       ..             ; Install handler at &9EFF (final ACK continuation)
...
.nmi_final_ack_net
    ...
    bpl tx_result_fail                                                ; 8891: 10 37       .7             ; No RDA -- error
    lda econet_data_continue_frame                                    ; 8893: ad a2 fe    ...            ; Read dest network
    bne tx_result_fail                                                ; 8896: d0 32       .2             ; Non-zero -- network mismatch, error
    lda #&a2                                                          ; 8898: a9 a2       ..             ; Install handler at &9F15 (final ACK validation)
    bit econet_control1_or_status1                                    ; 889a: 2c a0 fe    ,..            ; BIT SR1: test IRQ -- more data ready?
    bmi nmi_final_ack_validate                                        ; 889d: 30 03       0.             ; IRQ set -- fall through to &9F15 without RTI
...
.nmi_final_ack_validate
    ...
    bpl tx_result_fail                                                ; 88a5: 10 23       .#             ; No RDA -- error
    ...
    bne tx_result_fail                                                ; 88ad: d0 1b       ..             ; Mismatch -- error
...
.tx_store_result
    ...
    jmp c83eb                                                         ; 88d5: 4c eb 83    L..            ; Full ADLC reset and return to idle listen
...
.calc_transfer_size
    ...
    jsr c0406                                                         ; 8929: 20 06 04     ..            ; Claim Tube transfer address
    bcc restore_x_and_return                                          ; 892c: 90 0a       ..             ; No Tube: skip reclaim
    lda rx_port                                                       ; 892e: ad 40 0d    .@.            ; Tube: reclaim with scout status
    jsr c0406                                                         ; 8931: 20 06 04     ..            ; Reclaim with scout status type
    jsr release_tube                                                  ; 8934: 20 3f 84     ?.            ; Release Tube claim after reclaim
...
.poll_nmi_idle
    ...
    cmp #&b3                                                          ; 8981: c9 b3       ..             ; Expected: &BF (nmi_rx_scout low)
...
listen_jmp_hi = reset_enter_listen+2
    jmp adlc_rx_listen                                                ; 899a: 4c 6e 89    Ln.            ; Set ADLC to RX listen mode
...
.service_handler
    pha                                                               ; 8a0b: 48          H
    cmp #&0f                                                          ; 8a0c: c9 0f       ..
    bne c8a32                                                         ; 8a0e: d0 22       ."
    tya                                                               ; 8a10: 98          .
    pha                                                               ; 8a11: 48          H
    lda #osbyte_read_os_version                                       ; 8a12: a9 00       ..
    ldx #1                                                            ; 8a14: a2 01       ..
    ...
    cpx #1                                                            ; 8a19: e0 01       ..
    beq c8a2e                                                         ; 8a1b: f0 11       ..
    cpx #2                                                            ; 8a1d: e0 02       ..
    beq c8a2e                                                         ; 8a1f: f0 0d       ..
    txa                                                               ; 8a21: 8a          .
    php                                                               ; 8a22: 08          .
    ldx romsel_copy                                                   ; 8a23: a6 f4       ..
    plp                                                               ; 8a25: 28          (
    beq c8a29                                                         ; 8a26: f0 01       ..
    inx                                                               ; 8a28: e8          .
; &8a29 referenced 1 time by &8a26
.c8a29
    lda #0                                                            ; 8a29: a9 00       ..
    sta l02a0,x                                                       ; 8a2b: 9d a0 02    ...
; &8a2e referenced 2 times by &8a1b, &8a1f
.c8a2e
    ldx romsel_copy                                                   ; 8a2e: a6 f4       ..
    pla                                                               ; 8a30: 68          h
    tay                                                               ; 8a31: a8          .
; &8a32 referenced 1 time by &8a0e
.c8a32
    pla                                                               ; 8a32: 68          h
    jsr sub_cbe5e                                                     ; 8a33: 20 5e be     ^.
    pha                                                               ; 8a36: 48          H
    cmp #1                                                            ; 8a37: c9 01       ..
    bne c8a50                                                         ; 8a39: d0 15       ..
    lda econet_control1_or_status1                                    ; 8a3b: ad a0 fe    ...
    and #&ed                                                          ; 8a3e: 29 ed       ).
    bne c8a49                                                         ; 8a40: d0 07       ..
    lda econet_control23_or_status2                                   ; 8a42: ad a1 fe    ...
    and #&db                                                          ; 8a45: 29 db       ).
    beq c8a50                                                         ; 8a47: f0 07       ..
; &8a49 referenced 1 time by &8a40
.c8a49
    rol l0df0,x                                                       ; 8a49: 3e f0 0d    >..
    sec                                                               ; 8a4c: 38          8
    ror l0df0,x                                                       ; 8a4d: 7e f0 0d    ~..
; &8a50 referenced 2 times by &8a39, &8a47
.c8a50
    lda l0df0,x                                                       ; 8a50: bd f0 0d    ...
    asl a                                                             ; 8a53: 0a          .
    pla                                                               ; 8a54: 68          h
    bcc c8a58                                                         ; 8a55: 90 01       ..
    rts                                                               ; 8a57: 60          `

; &8a58 referenced 1 time by &8a55
.c8a58
    cmp #&0f                                                          ; 8a58: c9 0f       ..
    bne c8a9f                                                         ; 8a5a: d0 43       .C
    ldx ws_0d6a                                                       ; 8a5c: ae 6a 0d    .j.
    bne c8a65                                                         ; 8a5f: d0 04       ..
    inx                                                               ; 8a61: e8          .
    stx l028d                                                         ; 8a62: 8e 8d 02    ...
; &8a65 referenced 1 time by &8a5f
.c8a65
    sta error_block                                                   ; 8a65: 8d 00 01    ...
; &8a68 referenced 1 time by &8a93
.c8a68
    lda #&80                                                          ; 8a68: a9 80       ..
    sta osrdsc_ptr_hi                                                 ; 8a6a: 85 f7       ..
    lda #&0c                                                          ; 8a6c: a9 0c       ..
    sta osrdsc_ptr                                                    ; 8a6e: 85 f6       ..
    jsr read_paged_rom                                                ; 8a70: 20 97 8a     ..            ; Read byte from paged ROM via OSRDSC.
; Increments osrdsc_ptr and reads from ROM Y.
    cmp #&4e ; 'N'                                                    ; 8a73: c9 4e       .N
    bne c8a90                                                         ; 8a75: d0 19       ..
    jsr read_paged_rom                                                ; 8a77: 20 97 8a     ..            ; Read byte from paged ROM via OSRDSC.
; Increments osrdsc_ptr and reads from ROM Y.
    cmp #&45 ; 'E'                                                    ; 8a7a: c9 45       .E
    bne c8a90                                                         ; 8a7c: d0 12       ..
    jsr read_paged_rom                                                ; 8a7e: 20 97 8a     ..            ; Read byte from paged ROM via OSRDSC.
; Increments osrdsc_ptr and reads from ROM Y.
    cmp #&54 ; 'T'                                                    ; 8a81: c9 54       .T
    bne c8a90                                                         ; 8a83: d0 0b       ..
    ldx error_block                                                   ; 8a85: ae 00 01    ...
    lda l0df0,x                                                       ; 8a88: bd f0 0d    ...
    ora #&80                                                          ; 8a8b: 09 80       ..
    sta l0df0,x                                                       ; 8a8d: 9d f0 0d    ...
; &8a90 referenced 3 times by &8a75, &8a7c, &8a83
.c8a90
    dec error_block                                                   ; 8a90: ce 00 01    ...
    bpl c8a68                                                         ; 8a93: 10 d3       ..
    bmi c8ac9                                                         ; 8a95: 30 32       02             ; ALWAYS branch
...
.c8a9f
    tax                                                               ; 8a9f: aa          .
    lda svc_state                                                     ; 8aa0: a5 a9       ..
    pha                                                               ; 8aa2: 48          H
    txa                                                               ; 8aa3: 8a          .
    sta svc_state                                                     ; 8aa4: 85 a9       ..
    cmp #&0d                                                          ; 8aa6: c9 0d       ..
    bcc c8ab2                                                         ; 8aa8: 90 08       ..
    sbc #5                                                            ; 8aaa: e9 05       ..
    cmp #&0d                                                          ; 8aac: c9 0d       ..
    beq c8ab2                                                         ; 8aae: f0 02       ..
    lda #0                                                            ; 8ab0: a9 00       ..
; &8ab2 referenced 2 times by &8aa8, &8aae
.c8ab2
    tax                                                               ; 8ab2: aa          .
    beq c8ac3                                                         ; 8ab3: f0 0e       ..
    lda ws_page                                                       ; 8ab5: a5 a8       ..
    pha                                                               ; 8ab7: 48          H
    sty ws_page                                                       ; 8ab8: 84 a8       ..
    tya                                                               ; 8aba: 98          .
    ldy #0                                                            ; 8abb: a0 00       ..
...
; Dispatches to svc_dispatch_lo/hi[X+Y+1].
    pla                                                               ; 8ac0: 68          h
    sta ws_page                                                       ; 8ac1: 85 a8       ..
; &8ac3 referenced 1 time by &8ab3
.c8ac3
    ldx svc_state                                                     ; 8ac3: a6 a9       ..
    pla                                                               ; 8ac5: 68          h
    sta svc_state                                                     ; 8ac6: 85 a9       ..
    txa                                                               ; 8ac8: 8a          .
; &8ac9 referenced 1 time by &8a95
.c8ac9
    ldx romsel_copy                                                   ; 8ac9: a6 f4       ..
    rts                                                               ; 8acb: 60          `

; ***************************************************************************************
.cmd_roff
    ldy #4                                                            ; 8acc: a0 04       ..
    lda (net_rx_ptr),y                                                ; 8ace: b1 9c       ..
    beq c8af3                                                         ; 8ad0: f0 21       .!
    lda #0                                                            ; 8ad2: a9 00       ..
    tax                                                               ; 8ad4: aa          .              ; X=&00
    sta (net_rx_ptr),y                                                ; 8ad5: 91 9c       ..
    tay                                                               ; 8ad7: a8          .              ; Y=&00
    lda #osbyte_read_write_econet_keyboard_disable                    ; 8ad8: a9 c9       ..
    jsr osbyte                                                        ; 8ada: 20 f4 ff     ..            ; Enable keyboard (for Econet)
    lda #&0a                                                          ; 8add: a9 0a       ..
    jsr sub_ca9ac                                                     ; 8adf: 20 ac a9     ..
; &8ae2 referenced 1 time by &9589
.sub_c8ae2
    stx nfs_workspace                                                 ; 8ae2: 86 9e       ..
    lda #&ce                                                          ; 8ae4: a9 ce       ..
; &8ae6 referenced 1 time by &8af1
.loop_c8ae6
    ldx nfs_workspace                                                 ; 8ae6: a6 9e       ..
    ldy #&7f                                                          ; 8ae8: a0 7f       ..
    jsr osbyte                                                        ; 8aea: 20 f4 ff     ..
    adc #1                                                            ; 8aed: 69 01       i.
    cmp #&d0                                                          ; 8aef: c9 d0       ..
    beq loop_c8ae6                                                    ; 8af1: f0 f3       ..
; &8af3 referenced 1 time by &8ad0
.c8af3
    lda #0                                                            ; 8af3: a9 00       ..
    sta svc_state                                                     ; 8af5: 85 a9       ..
    sta nfs_workspace                                                 ; 8af7: 85 9e       ..
    rts                                                               ; 8af9: 60          `

; &8afa referenced 3 times by &8c47, &8c72, &a2a7
.sub_c8afa
    pha                                                               ; 8afa: 48          H
    lda os_text_ptr                                                   ; 8afb: a5 f2       ..
    sta fs_crc_lo                                                     ; 8afd: 85 be       ..
    lda os_text_ptr_hi                                                ; 8aff: a5 f3       ..
    sta fs_crc_hi                                                     ; 8b01: 85 bf       ..
    pla                                                               ; 8b03: 68          h
...
.svc_18_fs_select
    cpy #5                                                            ; 8b05: c0 05       ..
    bne return_4                                                      ; 8b07: d0 fb       ..
    bit l0d6c                                                         ; 8b09: 2c 6c 0d    ,l.
    bmi return_4                                                      ; 8b0c: 30 f6       0.
; ***************************************************************************************
...
.cmd_net_fs
    jsr sub_c8cae                                                     ; 8b0e: 20 ae 8c     ..
    sta fs_load_addr_hi                                               ; 8b11: 85 b1       ..
    lda #0                                                            ; 8b13: a9 00       ..
    sta fs_load_addr                                                  ; 8b15: 85 b0       ..
    clc                                                               ; 8b17: 18          .
    ldy #&76 ; 'v'                                                    ; 8b18: a0 76       .v
; &8b1a referenced 1 time by &8b1d
.loop_c8b1a
    adc (fs_load_addr),y                                              ; 8b1a: 71 b0       q.
    dey                                                               ; 8b1c: 88          .
    bpl loop_c8b1a                                                    ; 8b1d: 10 fb       ..
    ldy #&77 ; 'w'                                                    ; 8b1f: a0 77       .w
    eor (fs_load_addr),y                                              ; 8b21: 51 b0       Q.
    beq c8b28                                                         ; 8b23: f0 03       ..
    jmp c8fcb                                                         ; 8b25: 4c cb 8f    L..

; &8b28 referenced 1 time by &8b23
.c8b28
    jsr sub_c8cf1                                                     ; 8b28: 20 f1 8c     ..
    ldy #&0d                                                          ; 8b2b: a0 0d       ..
; &8b2d referenced 1 time by &8b35
.loop_c8b2d
    lda (net_rx_ptr),y                                                ; 8b2d: b1 9c       ..
    sta l0dfa,y                                                       ; 8b2f: 99 fa 0d    ...
    dey                                                               ; 8b32: 88          .
    cpy #5                                                            ; 8b33: c0 05       ..
    bne loop_c8b2d                                                    ; 8b35: d0 f6       ..
    rol l0d6c                                                         ; 8b37: 2e 6c 0d    .l.
    clc                                                               ; 8b3a: 18          .
    ror l0d6c                                                         ; 8b3b: 6e 6c 0d    nl.
    ldy #&0d                                                          ; 8b3e: a0 0d       ..
; &8b40 referenced 1 time by &8b47
.loop_c8b40
    lda fs_vector_table,y                                             ; 8b40: b9 4b 8e    .K.
    sta filev,y                                                       ; 8b43: 99 12 02    ...
    dey                                                               ; 8b46: 88          .
    bpl loop_c8b40                                                    ; 8b47: 10 f7       ..
    jsr sub_c8f40                                                     ; 8b49: 20 40 8f     @.
    ldy #&1b                                                          ; 8b4c: a0 1b       ..
    ldx #7                                                            ; 8b4e: a2 07       ..
    jsr c8f53                                                         ; 8b50: 20 53 8f     S.
    lda #0                                                            ; 8b53: a9 00       ..
    sta l0e07                                                         ; 8b55: 8d 07 0e    ...
    sta l10c9                                                         ; 8b58: 8d c9 10    ...
    sta l1071                                                         ; 8b5b: 8d 71 10    .q.
    sta svc_state                                                     ; 8b5e: 85 a9       ..
    ldy #&0e                                                          ; 8b60: a0 0e       ..
    sta (net_rx_ptr),y                                                ; 8b62: 91 9c       ..
    sta l0d6d                                                         ; 8b64: 8d 6d 0d    .m.
    jsr sub_c8cb5                                                     ; 8b67: 20 b5 8c     ..
    jsr sub_cb439                                                     ; 8b6a: 20 39 b4     9.
    ldy #&77 ; 'w'                                                    ; 8b6d: a0 77       .w
; &8b6f referenced 1 time by &8b75
.loop_c8b6f
    lda (l00cc),y                                                     ; 8b6f: b1 cc       ..
    sta l1000,y                                                       ; 8b71: 99 00 10    ...
    dey                                                               ; 8b74: 88          .
    bpl loop_c8b6f                                                    ; 8b75: 10 f8       ..
    lda #&80                                                          ; 8b77: a9 80       ..
    ora l0d6c                                                         ; 8b79: 0d 6c 0d    .l.
    sta l0d6c                                                         ; 8b7c: 8d 6c 0d    .l.
    jmp c8cfd                                                         ; 8b7f: 4c fd 8c    L..

; &8b82 referenced 1 time by &8c6f
.c8b82
    ldx #&4a ; 'J'                                                    ; 8b82: a2 4a       .J
    jsr c8b8d                                                         ; 8b84: 20 8d 8b     ..
; ***************************************************************************************
.cmd_utils
    ldx #0                                                            ; 8b87: a2 00       ..
    beq c8b8d                                                         ; 8b89: f0 02       ..             ; ALWAYS branch
...
; ***************************************************************************************
.cmd_net_local
    ldx #&4a ; 'J'                                                    ; 8b8b: a2 4a       .J
; &8b8d referenced 2 times by &8b84, &8b89
.c8b8d
    bvc c8b9d                                                         ; 8b8d: 50 0e       P.
    txa                                                               ; 8b8f: 8a          .
    pha                                                               ; 8b90: 48          H
    tya                                                               ; 8b91: 98          .
    pha                                                               ; 8b92: 48          H
    jsr sub_c8c94                                                     ; 8b93: 20 94 8c     ..
    pla                                                               ; 8b96: 68          h
    tay                                                               ; 8b97: a8          .
    pla                                                               ; 8b98: 68          h
    tax                                                               ; 8b99: aa          .
    clv                                                               ; 8b9a: b8          .
    bvc c8ba0                                                         ; 8b9b: 50 03       P.             ; ALWAYS branch
...
.svc_4_star_command
    ldx #0                                                            ; 8c43: a2 00       ..
    ldy ws_page                                                       ; 8c45: a4 a8       ..
    jsr sub_c8afa                                                     ; 8c47: 20 fa 8a     ..
    jsr sub_ca128                                                     ; 8c4a: 20 28 a1     (.
    bcs c8c65                                                         ; 8c4d: b0 16       ..
    jmp ca10d                                                         ; 8c4f: 4c 0d a1    L..
...
; ***************************************************************************************
.svc_9_help
    jsr sub_c8d0c                                                     ; 8c52: 20 0c 8d     ..
    ldy ws_page                                                       ; 8c55: a4 a8       ..
    lda (os_text_ptr),y                                               ; 8c57: b1 f2       ..
    cmp #&0d                                                          ; 8c59: c9 0d       ..
    bne c8c68                                                         ; 8c5b: d0 0b       ..
    jsr sub_c8c94                                                     ; 8c5d: 20 94 8c     ..
    ldx #&c4                                                          ; 8c60: a2 c4       ..
    jsr c8ba0                                                         ; 8c62: 20 a0 8b     ..
; &8c65 referenced 3 times by &8c4d, &8c92, &8ccd
.c8c65
    ldy ws_page                                                       ; 8c65: a4 a8       ..
    rts                                                               ; 8c67: 60          `

; &8c68 referenced 1 time by &8c5b
.c8c68
    bit l947d                                                         ; 8c68: 2c 7d 94    ,}.
    cmp #&2e ; '.'                                                    ; 8c6b: c9 2e       ..
    bne c8c72                                                         ; 8c6d: d0 03       ..
    jmp c8b82                                                         ; 8c6f: 4c 82 8b    L..

; &8c72 referenced 1 time by &8c6d
.c8c72
    jsr sub_c8afa                                                     ; 8c72: 20 fa 8a     ..
; &8c75 referenced 1 time by &8c90
.loop_c8c75
    php                                                               ; 8c75: 08          .
    ldx #&c4                                                          ; 8c76: a2 c4       ..
    jsr sub_ca128                                                     ; 8c78: 20 28 a1     (.
    bcs c8c8d                                                         ; 8c7b: b0 10       ..
    plp                                                               ; 8c7d: 28          (
    lda #&8c                                                          ; 8c7e: a9 8c       ..
    pha                                                               ; 8c80: 48          H
    lda #&74 ; 't'                                                    ; 8c81: a9 74       .t
    pha                                                               ; 8c83: 48          H
    lda la3da,x                                                       ; 8c84: bd da a3    ...
    pha                                                               ; 8c87: 48          H
    lda la3d9,x                                                       ; 8c88: bd d9 a3    ...
    pha                                                               ; 8c8b: 48          H
    rts                                                               ; 8c8c: 60          `
...
.c8c8d
    plp                                                               ; 8c8d: 28          (
    cmp #&0d                                                          ; 8c8e: c9 0d       ..
    bne loop_c8c75                                                    ; 8c90: d0 e3       ..
    beq c8c65                                                         ; 8c92: f0 d1       ..             ; ALWAYS branch
...
.sub_c8cae
    ldy romsel_copy                                                   ; 8cae: a4 f4       ..
    lda l0df0,y                                                       ; 8cb0: b9 f0 0d    ...
    tay                                                               ; 8cb3: a8          .
    rts                                                               ; 8cb4: 60          `

; &8cb5 referenced 2 times by &8b67, &8ece
.sub_c8cb5
    jsr sub_c8cae                                                     ; 8cb5: 20 ae 8c     ..
    sty nfs_temp                                                      ; 8cb8: 84 cd       ..
    lda #0                                                            ; 8cba: a9 00       ..
    sta l00cc                                                         ; 8cbc: 85 cc       ..
...
; ***************************************************************************************
.svc_3_auto_boot
    lda #osbyte_scan_keyboard_from_16                                 ; 8cbf: a9 7a       .z
    jsr osbyte                                                        ; 8cc1: 20 f4 ff     ..            ; Keyboard scan starting from key 16
    txa                                                               ; 8cc4: 8a          .              ; X is key number if key is pressed, or &ff otherwise
    bmi c8cd5                                                         ; 8cc5: 30 0e       0.
    cmp #&19                                                          ; 8cc7: c9 19       ..
    beq c8ccf                                                         ; 8cc9: f0 04       ..
    eor #&55 ; 'U'                                                    ; 8ccb: 49 55       IU
    bne c8c65                                                         ; 8ccd: d0 96       ..
; &8ccf referenced 1 time by &8cc9
.c8ccf
    tay                                                               ; 8ccf: a8          .              ; Y=key
    lda #osbyte_write_keys_pressed                                    ; 8cd0: a9 78       .x
...
; Selects network filing system.
    ...
    lda l1071                                                         ; 8ce2: ad 71 10    .q.
    ora #4                                                            ; 8ce5: 09 04       ..
    sta l1071                                                         ; 8ce7: 8d 71 10    .q.
    ldx #4                                                            ; 8cea: a2 04       ..
    ldy #&8d                                                          ; 8cec: a0 8d       ..
    jmp ca0fc                                                         ; 8cee: 4c fc a0    L..

; &8cf1 referenced 1 time by &8b28
.sub_c8cf1
    lda #6                                                            ; 8cf1: a9 06       ..
    jsr sub_c8cfa                                                     ; 8cf3: 20 fa 8c     ..
    ldx #&0a                                                          ; 8cf6: a2 0a       ..
    bne c8cff                                                         ; 8cf8: d0 05       ..             ; ALWAYS branch

; &8cfa referenced 1 time by &8cf3
.sub_c8cfa
    jmp (fscv)                                                        ; 8cfa: 6c 1e 02    l..
...
.c8cff
    lda #osbyte_issue_service_request                                 ; 8cff: a9 8f       ..
...
.sub_c8d0c
    ldy ws_page                                                       ; 8d0c: a4 a8       ..
    ldx #5                                                            ; 8d0e: a2 05       ..
; &8d10 referenced 1 time by &8d19
.loop_c8d10
    lda (os_text_ptr),y                                               ; 8d10: b1 f2       ..
    cmp l8d2d,x                                                       ; 8d12: dd 2d 8d    .-.
    bne c8d1b                                                         ; 8d15: d0 04       ..
    iny                                                               ; 8d17: c8          .
    inx                                                               ; 8d18: e8          .
    bne loop_c8d10                                                    ; 8d19: d0 f5       ..
; &8d1b referenced 1 time by &8d15
.c8d1b
    cpx #&0d                                                          ; 8d1b: e0 0d       ..
    bne return_7                                                      ; 8d1d: d0 0d       ..
    ldx #0                                                            ; 8d1f: a2 00       ..
; &8d21 referenced 1 time by &8d2a
.loop_c8d21
    lda l8d2d,x                                                       ; 8d21: bd 2d 8d    .-.
    beq return_7                                                      ; 8d24: f0 06       ..
    jsr osasci                                                        ; 8d26: 20 e3 ff     ..            ; Write character
    inx                                                               ; 8d29: e8          .
    bne loop_c8d21                                                    ; 8d2a: d0 f5       ..
...
.cmd_iam
    tya                                                               ; 8d6e: 98          .
    pha                                                               ; 8d6f: 48          H
    lda #osbyte_close_spool_exec                                      ; 8d70: a9 77       .w
    sta l0e07                                                         ; 8d72: 8d 07 0e    ...
    jsr osbyte                                                        ; 8d75: 20 f4 ff     ..            ; Close any *SPOOL and *EXEC files
    ldy #0                                                            ; 8d78: a0 00       ..
    sty fs_work_4                                                     ; 8d7a: 84 b4       ..
    jsr sub_cb79f                                                     ; 8d7c: 20 9f b7     ..
    lda #0                                                            ; 8d7f: a9 00       ..
    sta l0e07                                                         ; 8d81: 8d 07 0e    ...
    pla                                                               ; 8d84: 68          h
    tay                                                               ; 8d85: a8          .
    lda (fs_options),y                                                ; 8d86: b1 bb       ..
    jsr sub_c9244                                                     ; 8d88: 20 44 92     D.
    bcc cmd_pass                                                      ; 8d8b: 90 24       .$             ; *Pass command.
; Changes file server password.
    jsr sub_c915a                                                     ; 8d8d: 20 5a 91     Z.
    bcs c8d9c                                                         ; 8d90: b0 0a       ..
    sta l0e01                                                         ; 8d92: 8d 01 0e    ...
    jsr sub_c8dfe                                                     ; 8d95: 20 fe 8d     ..
    iny                                                               ; 8d98: c8          .
    jsr sub_c915a                                                     ; 8d99: 20 5a 91     Z.
; &8d9c referenced 1 time by &8d90
.c8d9c
    beq cmd_pass                                                      ; 8d9c: f0 13       ..             ; *Pass command.
; Changes file server password.
    sta l0e00                                                         ; 8d9e: 8d 00 0e    ...
    ldx #&ff                                                          ; 8da1: a2 ff       ..
; &8da3 referenced 1 time by &8daa
.loop_c8da3
    inx                                                               ; 8da3: e8          .
    lda la45f,x                                                       ; 8da4: bd 5f a4    ._.
    sta l0f05,x                                                       ; 8da7: 9d 05 0f    ...
    bpl loop_c8da3                                                    ; 8daa: 10 f7       ..
    jsr sub_caef4                                                     ; 8dac: 20 f4 ae     ..
    beq c8db4                                                         ; 8daf: f0 03       ..
; ***************************************************************************************
; *Pass command.
; Changes file server password.
; ***************************************************************************************
...
.loop_c8db6
    iny                                                               ; 8db6: c8          .
    lda l0f05,y                                                       ; 8db7: b9 05 0f    ...
    cmp #&0d                                                          ; 8dba: c9 0d       ..
    beq c8def                                                         ; 8dbc: f0 31       .1
    cmp #&3a ; ':'                                                    ; 8dbe: c9 3a       .:
    bne loop_c8db6                                                    ; 8dc0: d0 f4       ..
    jsr oswrch                                                        ; 8dc2: 20 ee ff     ..            ; Write character
    sty fs_work_4                                                     ; 8dc5: 84 b4       ..
; &8dc7 referenced 4 times by &8dd7, &8ddb, &8dde, &8dea
.c8dc7
    lda #&ff                                                          ; 8dc7: a9 ff       ..
    sta escapable                                                     ; 8dc9: 85 97       ..
    jsr sub_c955a                                                     ; 8dcb: 20 5a 95     Z.
    jsr osrdch                                                        ; 8dce: 20 e0 ff     ..            ; Read a character from the current input stream
    cmp #&15                                                          ; 8dd1: c9 15       ..             ; A=character read
    bne c8de0                                                         ; 8dd3: d0 0b       ..
    ldy fs_work_4                                                     ; 8dd5: a4 b4       ..
    bne c8dc7                                                         ; 8dd7: d0 ee       ..
; &8dd9 referenced 1 time by &8de2
.loop_c8dd9
    cpy fs_work_4                                                     ; 8dd9: c4 b4       ..
    beq c8dc7                                                         ; 8ddb: f0 ea       ..
    dey                                                               ; 8ddd: 88          .
    bne c8dc7                                                         ; 8dde: d0 e7       ..
; &8de0 referenced 1 time by &8dd3
.c8de0
    cmp #&7f                                                          ; 8de0: c9 7f       ..
    beq loop_c8dd9                                                    ; 8de2: f0 f5       ..
    sta l0f05,y                                                       ; 8de4: 99 05 0f    ...
    iny                                                               ; 8de7: c8          .
    cmp #&0d                                                          ; 8de8: c9 0d       ..
    bne c8dc7                                                         ; 8dea: d0 db       ..
    jsr osnewl                                                        ; 8dec: 20 e7 ff     ..            ; Write newline (characters 10 and 13)
; &8def referenced 1 time by &8dbc
.c8def
    tya                                                               ; 8def: 98          .
    pha                                                               ; 8df0: 48          H
    jsr c945f                                                         ; 8df1: 20 5f 94     _.
    jsr sub_c987f                                                     ; 8df4: 20 7f 98     ..
    pla                                                               ; 8df7: 68          h
    tax                                                               ; 8df8: aa          .
    inx                                                               ; 8df9: e8          .
    ldy #0                                                            ; 8dfa: a0 00       ..
    beq c8e0e                                                         ; 8dfc: f0 10       ..             ; ALWAYS branch

; &8dfe referenced 1 time by &8d95
.sub_c8dfe
    jsr sub_ca868                                                     ; 8dfe: 20 68 a8     h.
    eor l0e01                                                         ; 8e01: 4d 01 0e    M..
    bne return_8                                                      ; 8e04: d0 03       ..
    sta l0e01                                                         ; 8e06: 8d 01 0e    ...
...
.c8e0a
    jsr sub_caef0                                                     ; 8e0a: 20 f0 ae     ..
    tay                                                               ; 8e0d: a8          .
; &8e0e referenced 2 times by &8dfc, &9310
.c8e0e
    jsr c9499                                                         ; 8e0e: 20 99 94     ..
    ldx l0f03                                                         ; 8e11: ae 03 0f    ...
    beq return_9                                                      ; 8e14: f0 2c       .,
    lda l0f05                                                         ; 8e16: ad 05 0f    ...
    ldy #&17                                                          ; 8e19: a0 17       ..
    bne svc_dispatch                                                  ; 8e1b: d0 16       ..             ; Service dispatch via PHA/PHA/RTS.
; On entry: X=base index, Y=additional offset.
; Dispatches to svc_dispatch_lo/hi[X+Y+1].; ALWAYS branch

    jsr sub_c9281                                                     ; 8e1d: 20 81 92     ..
    cmp #8                                                            ; 8e20: c9 08       ..
    bcs return_9                                                      ; 8e22: b0 1e       ..
    tax                                                               ; 8e24: aa          .
    jsr sub_caf12                                                     ; 8e25: 20 12 af     ..
    tya                                                               ; 8e28: 98          .
    ldy #&13                                                          ; 8e29: a0 13       ..
...
; Dispatches to svc_dispatch_lo/hi[X+Y+1].
    tay                                                               ; 8e37: a8          .
    lda svc_dispatch_hi,x                                             ; 8e38: bd e5 89    ...
    pha                                                               ; 8e3b: 48          H
.sub_c8e3c
l8e3e = sub_c8e3c+2
    lda svc_dispatch_lo,x                                             ; 8e3c: bd c0 89    ...
; &8e3e referenced 2 times by &8f53, &8f59
    pha                                                               ; 8e3f: 48          H
    ldx fs_options                                                    ; 8e40: a6 bb       ..
...
; ***************************************************************************************
.svc_7_osbyte
    lda osbyte_a_copy                                                 ; 8e7c: a5 ef       ..
    sbc #&31 ; '1'                                                    ; 8e7e: e9 31       .1
    cmp #4                                                            ; 8e80: c9 04       ..
    bcs return_10                                                     ; 8e82: b0 11       ..
    tax                                                               ; 8e84: aa          .
    lda #0                                                            ; 8e85: a9 00       ..
    sta svc_state                                                     ; 8e87: 85 a9       ..
    tya                                                               ; 8e89: 98          .
    ldy #&21 ; '!'                                                    ; 8e8a: a0 21       .!
...
.sub_c8e96
    tya                                                               ; 8e96: 98          .
    cmp #&21 ; '!'                                                    ; 8e97: c9 21       .!
    bcc c8e9d                                                         ; 8e99: 90 02       ..
    lda #&21 ; '!'                                                    ; 8e9b: a9 21       .!
; &8e9d referenced 1 time by &8e99
.c8e9d
    ldy #&0f                                                          ; 8e9d: a0 0f       ..
    sta (net_rx_ptr),y                                                ; 8e9f: 91 9c       ..
    rts                                                               ; 8ea1: 60          `
...
.svc_2_private_workspace
    sty net_rx_ptr_hi                                                 ; 8ea2: 84 9d       ..
    iny                                                               ; 8ea4: c8          .
    sty nfs_workspace_hi                                              ; 8ea5: 84 9f       ..
    iny                                                               ; 8ea7: c8          .
    tya                                                               ; 8ea8: 98          .
    ldy romsel_copy                                                   ; 8ea9: a4 f4       ..
    sta l0df0,y                                                       ; 8eab: 99 f0 0d    ...
    lda #0                                                            ; 8eae: a9 00       ..
    sta net_rx_ptr                                                    ; 8eb0: 85 9c       ..
    sta nfs_workspace                                                 ; 8eb2: 85 9e       ..
    sta ws_page                                                       ; 8eb4: 85 a8       ..
    sta ws_0d60                                                       ; 8eb6: 8d 60 0d    .`.
    ldy #4                                                            ; 8eb9: a0 04       ..
    sta (net_rx_ptr),y                                                ; 8ebb: 91 9c       ..
    lda #osbyte_issue_service_request                                 ; 8ebd: a9 8f       ..
    ldx #1                                                            ; 8ebf: a2 01       ..
    ldy #&0e                                                          ; 8ec1: a0 0e       ..
    jsr osbyte                                                        ; 8ec3: 20 f4 ff     ..            ; Issue paged ROM service call, Reason X=1 - Absolute public workspace claim
    jsr sub_c8e96                                                     ; 8ec6: 20 96 8e     ..
    lda l028d                                                         ; 8ec9: ad 8d 02    ...
    beq c8f23                                                         ; 8ecc: f0 55       .U
    jsr sub_c8cb5                                                     ; 8ece: 20 b5 8c     ..
    sta l0d6c                                                         ; 8ed1: 8d 6c 0d    .l.
    tay                                                               ; 8ed4: a8          .
; &8ed5 referenced 1 time by &8eda
.loop_c8ed5
    sta (l00cc),y                                                     ; 8ed5: 91 cc       ..
    sta (nfs_workspace),y                                             ; 8ed7: 91 9e       ..
    iny                                                               ; 8ed9: c8          .
    bne loop_c8ed5                                                    ; 8eda: d0 f9       ..
    ldy #&0c                                                          ; 8edc: a0 0c       ..
    sta (net_rx_ptr),y                                                ; 8ede: 91 9c       ..
    jsr sub_caff7                                                     ; 8ee0: 20 f7 af     ..
    ldy #6                                                            ; 8ee3: a0 06       ..
    lda #&fe                                                          ; 8ee5: a9 fe       ..
    sta l0e00                                                         ; 8ee7: 8d 00 0e    ...
    sta (net_rx_ptr),y                                                ; 8eea: 91 9c       ..
    lda #0                                                            ; 8eec: a9 00       ..
    sta l0e01                                                         ; 8eee: 8d 01 0e    ...
    iny                                                               ; 8ef1: c8          .              ; Y=&07
    sta (net_rx_ptr),y                                                ; 8ef2: 91 9c       ..
    ldy #3                                                            ; 8ef4: a0 03       ..
    sta (nfs_workspace),y                                             ; 8ef6: 91 9e       ..
    dey                                                               ; 8ef8: 88          .              ; Y=&02
    lda #&eb                                                          ; 8ef9: a9 eb       ..
    sta (nfs_workspace),y                                             ; 8efb: 91 9e       ..
    ldx #3                                                            ; 8efd: a2 03       ..
; &8eff referenced 1 time by &8f06
.loop_c8eff
    lda l8f2b,x                                                       ; 8eff: bd 2b 8f    .+.
    sta l0d6d,x                                                       ; 8f02: 9d 6d 0d    .m.
    dex                                                               ; 8f05: ca          .
    bne loop_c8eff                                                    ; 8f06: d0 f7       ..
    stx ws_0d68                                                       ; 8f08: 8e 68 0d    .h.
    stx l0e05                                                         ; 8f0b: 8e 05 0e    ...
    jsr caad0                                                         ; 8f0e: 20 d0 aa     ..
; &8f11 referenced 1 time by &8f1e
.loop_c8f11
    lda ws_page                                                       ; 8f11: a5 a8       ..
    jsr sub_ca0b6                                                     ; 8f13: 20 b6 a0     ..
    bcs c8f23                                                         ; 8f16: b0 0b       ..
    lda #&3f ; '?'                                                    ; 8f18: a9 3f       .?
    sta (nfs_workspace),y                                             ; 8f1a: 91 9e       ..
    inc ws_page                                                       ; 8f1c: e6 a8       ..
    bne loop_c8f11                                                    ; 8f1e: d0 f1       ..
    jsr c8f73                                                         ; 8f20: 20 73 8f     s.
; &8f23 referenced 2 times by &8ecc, &8f16
.c8f23
    ldy station_id_disable_net_nmis                                   ; 8f23: ac 18 fe    ...
    tya                                                               ; 8f26: 98          .
    bne c8f2f                                                         ; 8f27: d0 06       ..
; &8f29 referenced 1 time by &8f30
.loop_c8f29
l8f2b = loop_c8f29+2
    jmp c9201                                                         ; 8f29: 4c 01 92    L..
...
.c8f2f
    iny                                                               ; 8f2f: c8          .
    beq loop_c8f29                                                    ; 8f30: f0 f7       ..
    ldy #5                                                            ; 8f32: a0 05       ..
    sta (net_rx_ptr),y                                                ; 8f34: 91 9c       ..
    ldx #&40 ; '@'                                                    ; 8f36: a2 40       .@
    stx l0d61                                                         ; 8f38: 8e 61 0d    .a.
    lda #3                                                            ; 8f3b: a9 03       ..
    jsr cab09                                                         ; 8f3d: 20 09 ab     ..
; &8f40 referenced 1 time by &8b49
.sub_c8f40
    jsr adlc_init                                                     ; 8f40: 20 69 80     i.
    lda #&a8                                                          ; 8f43: a9 a8       ..
    jsr osbyte_x0                                                     ; 8f45: 20 6d 8e     m.            ; OSBYTE with X=0, Y=&FF.
; Called from dispatch table for specific OSBYTE calls.
    stx fs_error_ptr                                                  ; 8f48: 86 b8       ..
    sty fs_crflag                                                     ; 8f4a: 84 b9       ..
    ldy #&36 ; '6'                                                    ; 8f4c: a0 36       .6
    sty netv                                                          ; 8f4e: 8c 24 02    .$.
    ldx #1                                                            ; 8f51: a2 01       ..
; &8f53 referenced 2 times by &8b50, &8f65
.c8f53
    lda l8e3e,y                                                       ; 8f53: b9 3e 8e    .>.
    sta (fs_error_ptr),y                                              ; 8f56: 91 b8       ..
    iny                                                               ; 8f58: c8          .
    lda l8e3e,y                                                       ; 8f59: b9 3e 8e    .>.
    sta (fs_error_ptr),y                                              ; 8f5c: 91 b8       ..
    iny                                                               ; 8f5e: c8          .
    lda romsel_copy                                                   ; 8f5f: a5 f4       ..
    sta (fs_error_ptr),y                                              ; 8f61: 91 b8       ..
    iny                                                               ; 8f63: c8          .
    dex                                                               ; 8f64: ca          .
    bne c8f53                                                         ; 8f65: d0 ec       ..
    dex                                                               ; 8f67: ca          .
    stx l0d72                                                         ; 8f68: 8e 72 0d    .r.
    jsr sub_c8f80                                                     ; 8f6b: 20 80 8f     ..
    jsr sub_c8cae                                                     ; 8f6e: 20 ae 8c     ..
    iny                                                               ; 8f71: c8          .
    rts                                                               ; 8f72: 60          `
...
.loop_c8f75
    lda l0dfa,y                                                       ; 8f75: b9 fa 0d    ...
    sta (net_rx_ptr),y                                                ; 8f78: 91 9c       ..
    dey                                                               ; 8f7a: 88          .
    cpy #5                                                            ; 8f7b: c0 05       ..
    bne loop_c8f75                                                    ; 8f7d: d0 f6       ..
    rts                                                               ; 8f7f: 60          `

; &8f80 referenced 1 time by &8f6b
.sub_c8f80
    bit l0d6c                                                         ; 8f80: 2c 6c 0d    ,l.
    bpl return_11                                                     ; 8f83: 10 2c       .,
    ldy #0                                                            ; 8f85: a0 00       ..
    jsr sub_cb79f                                                     ; 8f87: 20 9f b7     ..
    lda #osbyte_close_spool_exec                                      ; 8f8a: a9 77       .w
    jsr osbyte                                                        ; 8f8c: 20 f4 ff     ..            ; Close any *SPOOL and *EXEC files
    jsr c8f73                                                         ; 8f8f: 20 73 8f     s.
    ldy #&76 ; 'v'                                                    ; 8f92: a0 76       .v
    lda #0                                                            ; 8f94: a9 00       ..
    clc                                                               ; 8f96: 18          .
; &8f97 referenced 1 time by &8f9b
.loop_c8f97
    adc l1000,y                                                       ; 8f97: 79 00 10    y..
    dey                                                               ; 8f9a: 88          .
    bpl loop_c8f97                                                    ; 8f9b: 10 fa       ..
    ldy #&77 ; 'w'                                                    ; 8f9d: a0 77       .w
    bpl c8fa4                                                         ; 8f9f: 10 03       ..             ; ALWAYS branch

; &8fa1 referenced 1 time by &8fa7
.loop_c8fa1
    lda l1000,y                                                       ; 8fa1: b9 00 10    ...
; &8fa4 referenced 1 time by &8f9f
.c8fa4
    sta (l00cc),y                                                     ; 8fa4: 91 cc       ..
    dey                                                               ; 8fa6: 88          .
    bpl loop_c8fa1                                                    ; 8fa7: 10 f8       ..
    lda l0d6c                                                         ; 8fa9: ad 6c 0d    .l.
    and #&7f                                                          ; 8fac: 29 7f       ).
    sta l0d6c                                                         ; 8fae: 8d 6c 0d    .l.
...
.sub_c8fb2
    ...
    tya                                                               ; 8fb4: 98          .
    pha                                                               ; 8fb5: 48          H
    ldy #&76 ; 'v'                                                    ; 8fb6: a0 76       .v
    lda #0                                                            ; 8fb8: a9 00       ..
    clc                                                               ; 8fba: 18          .
; &8fbb referenced 1 time by &8fbe
.loop_c8fbb
    adc (l00cc),y                                                     ; 8fbb: 71 cc       q.
    dey                                                               ; 8fbd: 88          .
    bpl loop_c8fbb                                                    ; 8fbe: 10 fb       ..
    ldy #&77 ; 'w'                                                    ; 8fc0: a0 77       .w
    cmp (l00cc),y                                                     ; 8fc2: d1 cc       ..
    bne c8fcb                                                         ; 8fc4: d0 05       ..
    pla                                                               ; 8fc6: 68          h
    tay                                                               ; 8fc7: a8          .
    pla                                                               ; 8fc8: 68          h
    plp                                                               ; 8fc9: 28          (
...
.sub_c911b
    ...
    lsr a                                                             ; 911e: 4a          J
    lsr a                                                             ; 911f: 4a          J
    jsr sub_c9124                                                     ; 9120: 20 24 91     $.
    pla                                                               ; 9123: 68          h
; &9124 referenced 1 time by &9120
.sub_c9124
    and #&0f                                                          ; 9124: 29 0f       ).
    cmp #&0a                                                          ; 9126: c9 0a       ..
    bcc c912c                                                         ; 9128: 90 02       ..
    adc #6                                                            ; 912a: 69 06       i.
...
.c9174
    ...
    adc #&b8                                                          ; 917e: 69 b8       i.
    bcs c91f4                                                         ; 9180: b0 72       .r
    cmp #&fa                                                          ; 9182: c9 fa       ..
; &9184 referenced 1 time by &9176
.c9184
    bcc c91f4                                                         ; 9184: 90 6e       .n
...
; ***************************************************************************************
.cmd_fs_operation
    jsr sub_c9313                                                     ; 92d2: 20 13 93     ..
    txa                                                               ; 92d5: 8a          .
    pha                                                               ; 92d6: 48          H
    jsr sub_c9335                                                     ; 92d7: 20 35 93     5.
    jsr sub_cae85                                                     ; 92da: 20 85 ae     ..
    pla                                                               ; 92dd: 68          h
    tax                                                               ; 92de: aa          .
    jsr sub_c92f5                                                     ; 92df: 20 f5 92     ..
    cmp #&0d                                                          ; 92e2: c9 0d       ..
    bne c92fd                                                         ; 92e4: d0 17       ..
...
.sub_c92f5
    lda l0e30                                                         ; 92f5: ad 30 0e    .0.
    cmp #&26 ; '&'                                                    ; 92f8: c9 26       .&
    beq c92e6                                                         ; 92fa: f0 ea       ..
    rts                                                               ; 92fc: 60          `

; &92fd referenced 3 times by &92e4, &930b, &93c6
.c92fd
    jsr sub_c92f5                                                     ; 92fd: 20 f5 92     ..
    sta l0f05,x                                                       ; 9300: 9d 05 0f    ...
    inx                                                               ; 9303: e8          .
    cmp #&0d                                                          ; 9304: c9 0d       ..
    beq c930e                                                         ; 9306: f0 06       ..
    jsr caea5                                                         ; 9308: 20 a5 ae     ..
    jmp c92fd                                                         ; 930b: 4c fd 92    L..

; &930e referenced 2 times by &9306, &93ee
.c930e
    ldy #0                                                            ; 930e: a0 00       ..
    jmp c8e0e                                                         ; 9310: 4c 0e 8e    L..
...
.loop_c9315
    dex                                                               ; 9315: ca          .
    lda cmd_table_fs,x                                                ; 9316: bd d8 a3    ...
    bpl loop_c9315                                                    ; 9319: 10 fa       ..
    inx                                                               ; 931b: e8          .
    ldy #0                                                            ; 931c: a0 00       ..
; &931e referenced 1 time by &9328
.loop_c931e
    lda cmd_table_fs,x                                                ; 931e: bd d8 a3    ...
    bmi c932a                                                         ; 9321: 30 07       0.
    sta l0f05,y                                                       ; 9323: 99 05 0f    ...
    inx                                                               ; 9326: e8          .
    iny                                                               ; 9327: c8          .
    bne loop_c931e                                                    ; 9328: d0 f4       ..
; &932a referenced 1 time by &9321
.c932a
    lda #&20 ; ' '                                                    ; 932a: a9 20       .
    sta l0f05,y                                                       ; 932c: 99 05 0f    ...
    iny                                                               ; 932f: c8          .
    tya                                                               ; 9330: 98          .
    tax                                                               ; 9331: aa          .
    pla                                                               ; 9332: 68          h
...
.sub_c9335
    lda #0                                                            ; 9335: a9 00       ..
    tax                                                               ; 9337: aa          .              ; X=&00
    sta l10d8                                                         ; 9338: 8d d8 10    ...
; &933b referenced 1 time by &9342
.loop_c933b
    lda (fs_crc_lo),y                                                 ; 933b: b1 be       ..
    cmp #&20 ; ' '                                                    ; 933d: c9 20       .
    bne c9344                                                         ; 933f: d0 03       ..
    iny                                                               ; 9341: c8          .
    bne loop_c933b                                                    ; 9342: d0 f7       ..
; &9344 referenced 1 time by &933f
.c9344
    cmp #&22 ; '"'                                                    ; 9344: c9 22       ."
    bne c934f                                                         ; 9346: d0 07       ..
    iny                                                               ; 9348: c8          .
    eor l10d8                                                         ; 9349: 4d d8 10    M..
    sta l10d8                                                         ; 934c: 8d d8 10    ...
; &934f referenced 2 times by &9346, &9364
.c934f
    lda (fs_crc_lo),y                                                 ; 934f: b1 be       ..
    cmp #&22 ; '"'                                                    ; 9351: c9 22       ."
    bne c935d                                                         ; 9353: d0 08       ..
    eor l10d8                                                         ; 9355: 4d d8 10    M..
    sta l10d8                                                         ; 9358: 8d d8 10    ...
    lda #&20 ; ' '                                                    ; 935b: a9 20       .
; &935d referenced 1 time by &9353
.c935d
    sta l0e30,x                                                       ; 935d: 9d 30 0e    .0.
    iny                                                               ; 9360: c8          .
    inx                                                               ; 9361: e8          .
    cmp #&0d                                                          ; 9362: c9 0d       ..
    bne c934f                                                         ; 9364: d0 e9       ..
...
; ***************************************************************************************
.cmd_rename
    jsr sub_c9313                                                     ; 9377: 20 13 93     ..
    txa                                                               ; 937a: 8a          .
    pha                                                               ; 937b: 48          H
    jsr sub_caf12                                                     ; 937c: 20 12 af     ..
    jsr sub_c9335                                                     ; 937f: 20 35 93     5.
    jsr sub_cae85                                                     ; 9382: 20 85 ae     ..
    pla                                                               ; 9385: 68          h
    tax                                                               ; 9386: aa          .
; &9387 referenced 1 time by &93a5
.loop_c9387
    lda l0e30                                                         ; 9387: ad 30 0e    .0.
    cmp #&0d                                                          ; 938a: c9 0d       ..
    bne c939a                                                         ; 938c: d0 0c       ..
...
.c939a
    sta l0f05,x                                                       ; 939a: 9d 05 0f    ...
    inx                                                               ; 939d: e8          .
    cmp #&20 ; ' '                                                    ; 939e: c9 20       .
    beq c93a8                                                         ; 93a0: f0 06       ..
    jsr caea5                                                         ; 93a2: 20 a5 ae     ..
    jmp loop_c9387                                                    ; 93a5: 4c 87 93    L..

; &93a8 referenced 2 times by &93a0, &93b0
.c93a8
    jsr caea5                                                         ; 93a8: 20 a5 ae     ..
    lda l0e30                                                         ; 93ab: ad 30 0e    .0.
    cmp #&20 ; ' '                                                    ; 93ae: c9 20       .
    beq c93a8                                                         ; 93b0: f0 f6       ..
    lda l1071                                                         ; 93b2: ad 71 10    .q.
    pha                                                               ; 93b5: 48          H
    jsr sub_caf12                                                     ; 93b6: 20 12 af     ..
    txa                                                               ; 93b9: 8a          .
    pha                                                               ; 93ba: 48          H
    jsr sub_cae85                                                     ; 93bb: 20 85 ae     ..
    pla                                                               ; 93be: 68          h
    tax                                                               ; 93bf: aa          .
    pla                                                               ; 93c0: 68          h
    cmp l1071                                                         ; 93c1: cd 71 10    .q.
    bne c938e                                                         ; 93c4: d0 c8       ..
    jmp c92fd                                                         ; 93c6: 4c fd 92    L..

; ***************************************************************************************
.cmd_dir
    lda (fs_crc_lo),y                                                 ; 93c9: b1 be       ..
    cmp #&26 ; '&'                                                    ; 93cb: c9 26       .&
    bne c944e                                                         ; 93cd: d0 7f       ..
    iny                                                               ; 93cf: c8          .
    lda (fs_crc_lo),y                                                 ; 93d0: b1 be       ..
    cmp #&0d                                                          ; 93d2: c9 0d       ..
    beq c93da                                                         ; 93d4: f0 04       ..
    cmp #&20 ; ' '                                                    ; 93d6: c9 20       .
    bne c93f1                                                         ; 93d8: d0 17       ..
...
.loop_c93dc
    iny                                                               ; 93dc: c8          .
    lda (fs_crc_lo),y                                                 ; 93dd: b1 be       ..
    sta l0f05,y                                                       ; 93df: 99 05 0f    ...
    cmp #&26 ; '&'                                                    ; 93e2: c9 26       .&
    bne loop_c93dc                                                    ; 93e4: d0 f6       ..
    lda #&0d                                                          ; 93e6: a9 0d       ..
    sta l0f05,y                                                       ; 93e8: 99 05 0f    ...
    iny                                                               ; 93eb: c8          .
    tya                                                               ; 93ec: 98          .
    tax                                                               ; 93ed: aa          .
    jmp c930e                                                         ; 93ee: 4c 0e 93    L..

; &93f1 referenced 1 time by &93d8
.c93f1
    cmp #&2e ; '.'                                                    ; 93f1: c9 2e       ..
    beq c93f8                                                         ; 93f3: f0 03       ..
    jmp c92e6                                                         ; 93f5: 4c e6 92    L..

; &93f8 referenced 1 time by &93f3
.c93f8
    iny                                                               ; 93f8: c8          .
    sty fs_load_addr                                                  ; 93f9: 84 b0       ..
    lda #4                                                            ; 93fb: a9 04       ..
    sta l0f05                                                         ; 93fd: 8d 05 0f    ...
    lda l1071                                                         ; 9400: ad 71 10    .q.
    ora #&40 ; '@'                                                    ; 9403: 09 40       .@
    sta l1071                                                         ; 9405: 8d 71 10    .q.
    ldx #1                                                            ; 9408: a2 01       ..
    jsr sub_caef4                                                     ; 940a: 20 f4 ae     ..
    ldy #&12                                                          ; 940d: a0 12       ..
    jsr c9499                                                         ; 940f: 20 99 94     ..
    lda l0f05                                                         ; 9412: ad 05 0f    ...
    cmp #2                                                            ; 9415: c9 02       ..
...
.c9428
    lda l0e03                                                         ; 9428: ad 03 0e    ...
    sta l0f05                                                         ; 942b: 8d 05 0f    ...
    ldx #1                                                            ; 942e: a2 01       ..
    ldy #7                                                            ; 9430: a0 07       ..
    jsr c9499                                                         ; 9432: 20 99 94     ..
    ldx #1                                                            ; 9435: a2 01       ..
    stx l0f05                                                         ; 9437: 8e 05 0f    ...
    stx l0f06                                                         ; 943a: 8e 06 0f    ...
    inx                                                               ; 943d: e8          .              ; X=&02
    ldy fs_load_addr                                                  ; 943e: a4 b0       ..
    jsr sub_caef4                                                     ; 9440: 20 f4 ae     ..
    ldy #6                                                            ; 9443: a0 06       ..
    jsr c9499                                                         ; 9445: 20 99 94     ..
    ldy l0f05                                                         ; 9448: ac 05 0f    ...
    jmp ca2dc                                                         ; 944b: 4c dc a2    L..

; &944e referenced 1 time by &93cd
.c944e
    jmp c8e0a                                                         ; 944e: 4c 0a 8e    L..
...
.sub_c9453
    jsr c945f                                                         ; 9453: 20 5f 94     _.
    sta txcb_port                                                     ; 9456: 85 c1       ..
    lda #3                                                            ; 9458: a9 03       ..
    sta txcb_start                                                    ; 945a: 85 c4       ..
    dec txcb_ctrl                                                     ; 945c: c6 c0       ..
    rts                                                               ; 945e: 60          `
...
.loop_c9462
    lda l9477,y                                                       ; 9462: b9 77 94    .w.
    sta txcb_ctrl,y                                                   ; 9465: 99 c0 00    ...
    cpy #2                                                            ; 9468: c0 02       ..
    bpl c9472                                                         ; 946a: 10 06       ..
    lda l0e00,y                                                       ; 946c: b9 00 0e    ...
    sta txcb_dest,y                                                   ; 946f: 99 c2 00    ...
; &9472 referenced 1 time by &946a
.c9472
    dey                                                               ; 9472: 88          .
    bpl loop_c9462                                                    ; 9473: 10 ed       ..
    pla                                                               ; 9475: 68          h
    rts                                                               ; 9476: 60          `
...
.sub_c9483
    pha                                                               ; 9483: 48          H
    sec                                                               ; 9484: 38          8
    bcs c94a1                                                         ; 9485: b0 1a       ..             ; ALWAYS branch

; &9487 referenced 2 times by &9944, &99f8
.sub_c9487
    clv                                                               ; 9487: b8          .
    bvc c94a0                                                         ; 9488: 50 16       P.             ; ALWAYS branch

; ***************************************************************************************
.cmd_bye
    ldy #0                                                            ; 948a: a0 00       ..
    jsr sub_cb79f                                                     ; 948c: 20 9f b7     ..
...
.sub_c94c6
    ...
    php                                                               ; 94d7: 08          .
    jsr sub_c9822                                                     ; 94d8: 20 22 98     ".
    plp                                                               ; 94db: 28          (
; &94dc referenced 2 times by &9a0b, &9f43
.sub_c94dc
    php                                                               ; 94dc: 08          .
    jsr sub_c9451                                                     ; 94dd: 20 51 94     Q.
    jsr c95c7                                                         ; 94e0: 20 c7 95     ..
    plp                                                               ; 94e3: 28          (
...
.c9573
    ...
    jsr sub_c8ae2                                                     ; 9589: 20 e2 8a     ..
    jsr sub_caa73                                                     ; 958c: 20 73 aa     s.
    ldx #1                                                            ; 958f: a2 01       ..
    ldy #0                                                            ; 9591: a0 00       ..
...
.c9620
    jsr sub_c9738                                                     ; 9620: 20 38 97     8.
    lda #0                                                            ; 9623: a9 00       ..
    sta error_text,x                                                  ; 9625: 9d 01 01    ...
    jmp c96da                                                         ; 9628: 4c da 96    L..
...
.c963b
    ...
    php                                                               ; 9642: 08          .
    tax                                                               ; 9643: aa          .
    ldy l9798,x                                                       ; 9644: bc 98 97    ...
    lda error_msg_table,y                                             ; 9647: b9 a4 97    ...
    jsr sub_c95fb                                                     ; 964a: 20 fb 95     ..
    ldx #0                                                            ; 964d: a2 00       ..
...
.c965e
    jsr sub_c9738                                                     ; 965e: 20 38 97     8.
    plp                                                               ; 9661: 28          (
    bvs c9670                                                         ; 9662: 70 0c       p.
    lda #&a4                                                          ; 9664: a9 a4       ..
    jsr sub_c95fb                                                     ; 9666: 20 fb 95     ..
...
.sub_c9767
    tay                                                               ; 9767: a8          .
    bit l947d                                                         ; 9768: 2c 7d 94    ,}.
    lda #&64 ; 'd'                                                    ; 976b: a9 64       .d
    jsr sub_c9778                                                     ; 976d: 20 78 97     x.
    lda #&0a                                                          ; 9770: a9 0a       ..
    jsr sub_c9778                                                     ; 9772: 20 78 97     x.
    lda #1                                                            ; 9775: a9 01       ..
    clv                                                               ; 9777: b8          .
...
.c9912
    ...
    jsr sub_c9281                                                     ; 9921: 20 81 92     ..
    jsr sub_c98f3                                                     ; 9924: 20 f3 98     ..
    jsr sub_caf12                                                     ; 9927: 20 12 af     ..
    jsr sub_cae85                                                     ; 992a: 20 85 ae     ..
    lda fs_last_byte_flag                                             ; 992d: a5 bd       ..
    bpl c99af                                                         ; 992f: 10 7e       .~
    cmp #&ff                                                          ; 9931: c9 ff       ..
    beq c9938                                                         ; 9933: f0 03       ..
    jmp c9cb9                                                         ; 9935: 4c b9 9c    L..

; &9938 referenced 1 time by &9933
.c9938
    jsr sub_caef0                                                     ; 9938: 20 f0 ae     ..
    ldy #2                                                            ; 993b: a0 02       ..
...
.sub_c993d
    ...
    jsr sub_c9487                                                     ; 9944: 20 87 94     ..
    ldy #6                                                            ; 9947: a0 06       ..
    lda (fs_options),y                                                ; 9949: b1 bb       ..
    bne c9955                                                         ; 994b: d0 08       ..
    jsr sub_c9a60                                                     ; 994d: 20 60 9a     `.
    jsr sub_c9a72                                                     ; 9950: 20 72 9a     r.
    bcc c995b                                                         ; 9953: 90 06       ..
; &9955 referenced 1 time by &994b
.c9955
    jsr sub_c9a72                                                     ; 9955: 20 72 9a     r.
    jsr sub_c9a60                                                     ; 9958: 20 60 9a     `.
...
.loop_c995d
    ...
    jsr sub_c9b86                                                     ; 9970: 20 86 9b     ..
    jsr sub_c9984                                                     ; 9973: 20 84 99     ..
    ldx #2                                                            ; 9976: a2 02       ..
...
.c99f8
    jsr sub_c9487                                                     ; 99f8: 20 87 94     ..
    jsr sub_c9b86                                                     ; 99fb: 20 86 9b     ..
    plp                                                               ; 99fe: 28          (
...
.loop_c9a2c
    ...
    ldy #5                                                            ; 9a37: a0 05       ..
    jsr sub_c9a50                                                     ; 9a39: 20 50 9a     P.
    jsr sub_c9a45                                                     ; 9a3c: 20 45 9a     E.
    jsr osnewl                                                        ; 9a3f: 20 e7 ff     ..            ; Write newline (characters 10 and 13)
    jmp c9cb9                                                         ; 9a42: 4c b9 9c    L..

; &9a45 referenced 1 time by &9a3c
.sub_c9a45
    ldy #9                                                            ; 9a45: a0 09       ..
    jsr sub_c9a50                                                     ; 9a47: 20 50 9a     P.
    ldy #&0c                                                          ; 9a4a: a0 0c       ..
    ldx #3                                                            ; 9a4c: a2 03       ..
...
.c9ac0
    ...
    jsr sub_c9822                                                     ; 9ac9: 20 22 98     ".
    lda fs_error_ptr                                                  ; 9acc: a5 b8       ..
    jsr sub_c9453                                                     ; 9ace: 20 53 94     S.
    plp                                                               ; 9ad1: 28          (
    bcs c9a84                                                         ; 9ad2: b0 b0       ..
    lda #&91                                                          ; 9ad4: a9 91       ..
    sta txcb_port                                                     ; 9ad6: 85 c1       ..
    jsr c95c7                                                         ; 9ad8: 20 c7 95     ..
...
.c9b44
    ldx #1                                                            ; 9b44: a2 01       ..
    jsr sub_caef2                                                     ; 9b46: 20 f2 ae     ..
    ldy #&12                                                          ; 9b49: a0 12       ..
    jsr c9499                                                         ; 9b4b: 20 99 94     ..
    lda l0f11                                                         ; 9b4e: ad 11 0f    ...
    stx l0f11                                                         ; 9b51: 8e 11 0f    ...
    stx l0f14                                                         ; 9b54: 8e 14 0f    ...
    jsr sub_c925f                                                     ; 9b57: 20 5f 92     _.
...
.c9ba6
    ...
    jsr sub_c8fb2                                                     ; 9baf: 20 b2 8f     ..
    sta fs_last_byte_flag                                             ; 9bb2: 85 bd       ..
    jsr sub_c9287                                                     ; 9bb4: 20 87 92     ..
    ora #0                                                            ; 9bb7: 09 00       ..
...
.loop_c9c27
    ...
    ldy #&0d                                                          ; 9c30: a0 0d       ..
    ldx #5                                                            ; 9c32: a2 05       ..
    jsr c9499                                                         ; 9c34: 20 99 94     ..
    stx fs_last_byte_flag                                             ; 9c37: 86 bd       ..
    pla                                                               ; 9c39: 68          h
    jsr sub_c92a1                                                     ; 9c3a: 20 a1 92     ..
; &9c3d referenced 1 time by &9beb
.c9c3d
    jmp c9cb9                                                         ; 9c3d: 4c b9 9c    L..

; &9c40 referenced 1 time by &9c23
.c9c40
    ldy #&0c                                                          ; 9c40: a0 0c       ..
    ldx #2                                                            ; 9c42: a2 02       ..
    jsr c9499                                                         ; 9c44: 20 99 94     ..
...
.c9c5c
    ...
    beq c9cb9                                                         ; 9c7c: f0 3b       .;             ; ALWAYS branch
...
.loop_c9c85
    ...
    ldy #&0d                                                          ; 9c8e: a0 0d       ..
    ldx #5                                                            ; 9c90: a2 05       ..
    jsr c9499                                                         ; 9c92: 20 99 94     ..
    stx fs_last_byte_flag                                             ; 9c95: 86 bd       ..
    pla                                                               ; 9c97: 68          h
    tay                                                               ; 9c98: a8          .
    lda fs_block_offset                                               ; 9c99: a5 bc       ..
    jsr sub_c92b8                                                     ; 9c9b: 20 b8 92     ..
    jsr sub_cb45b                                                     ; 9c9e: 20 5b b4     [.
    ...
    jmp c9cb9                                                         ; 9cb3: 4c b9 9c    L..

; &9cb6 referenced 1 time by &9bbe
.c9cb6
    jsr sub_cb79f                                                     ; 9cb6: 20 9f b7     ..
...
.c9cc8
    ...
    lda #5                                                            ; 9ccf: a9 05       ..
    bne c9cbb                                                         ; 9cd1: d0 e8       ..             ; ALWAYS branch
...
.c9ce3
    lsr a                                                             ; 9ce3: 4a          J
    bpl c9cbb                                                         ; 9ce4: 10 d5       ..
; &9ce6 referenced 1 time by &9d55
.c9ce6
    and #&3f ; '?'                                                    ; 9ce6: 29 3f       )?
    bne c9ce1                                                         ; 9ce8: d0 f7       ..
    txa                                                               ; 9cea: 8a          .
    jsr sub_cb52e                                                     ; 9ceb: 20 2e b5     ..
    eor #&80                                                          ; 9cee: 49 80       I.
    asl a                                                             ; 9cf0: 0a          .
    sta l0f05                                                         ; 9cf1: 8d 05 0f    ...
    rol a                                                             ; 9cf4: 2a          *
    sta l0f06                                                         ; 9cf5: 8d 06 0f    ...
    jsr sub_cae80                                                     ; 9cf8: 20 80 ae     ..
    ldx #2                                                            ; 9cfb: a2 02       ..
    jsr sub_caef2                                                     ; 9cfd: 20 f2 ae     ..
    ldy #6                                                            ; 9d00: a0 06       ..
    bit l947d                                                         ; 9d02: 2c 7d 94    ,}.
    sec                                                               ; 9d05: 38          8
    ror escapable                                                     ; 9d06: 66 97       f.
    jsr c949a                                                         ; 9d08: 20 9a 94     ..
...
.loop_c9d1e
    ...
    pla                                                               ; 9d3c: 68          h
    jsr sub_cb4fa                                                     ; 9d3d: 20 fa b4     ..
    bne c9d75                                                         ; 9d40: d0 33       .3
    jsr sub_c8fb2                                                     ; 9d42: 20 b2 8f     ..
    jsr sub_c9281                                                     ; 9d45: 20 81 92     ..
    tax                                                               ; 9d48: aa          .
    jsr sub_caf12                                                     ; 9d49: 20 12 af     ..
    txa                                                               ; 9d4c: 8a          .
    beq c9d7e                                                         ; 9d4d: f0 2f       ./
    jsr sub_caf95                                                     ; 9d4f: 20 95 af     ..
...
.c9d7b
    jmp c9cbb                                                         ; 9d7b: 4c bb 9c    L..

; &9d7e referenced 1 time by &9d4d
.c9d7e
    jsr sub_cb79f                                                     ; 9d7e: 20 9f b7     ..
    tya                                                               ; 9d81: 98          .
...
.c9e1c
    ...
    jsr sub_c8fb2                                                     ; 9e23: 20 b2 8f     ..
    jsr sub_c9281                                                     ; 9e26: 20 81 92     ..
    pha                                                               ; 9e29: 48          H
    jsr sub_caf12                                                     ; 9e2a: 20 12 af     ..
    pla                                                               ; 9e2d: 68          h
    tax                                                               ; 9e2e: aa          .
...
.c9e44
    ...
    pha                                                               ; 9e46: 48          H
    jsr sub_cb4e3                                                     ; 9e47: 20 e3 b4     ..
    pla                                                               ; 9e4a: 68          h
    tay                                                               ; 9e4b: a8          .
    jsr sub_cb79f                                                     ; 9e4c: 20 9f b7     ..
    ...
    ldy #&0d                                                          ; 9e6c: a0 0d       ..
    ldx #5                                                            ; 9e6e: a2 05       ..
    jsr c9499                                                         ; 9e70: 20 99 94     ..
    pla                                                               ; 9e73: 68          h
    jsr c9ecb                                                         ; 9e74: 20 cb 9e     ..
    php                                                               ; 9e77: 08          .
    ldy #0                                                            ; 9e78: a0 00       ..
    lda (fs_options),y                                                ; 9e7a: b1 bb       ..
    bcs c9e83                                                         ; 9e7c: b0 05       ..
    jsr sub_c92b8                                                     ; 9e7e: 20 b8 92     ..
    bpl c9e86                                                         ; 9e81: 10 03       ..
; &9e83 referenced 1 time by &9e7c
.c9e83
    jsr sub_c92a1                                                     ; 9e83: 20 a1 92     ..
; &9e86 referenced 1 time by &9e81
.c9e86
    sty l0f06                                                         ; 9e86: 8c 06 0f    ...
    jsr sub_c9ec4                                                     ; 9e89: 20 c4 9e     ..
    sta l0f05                                                         ; 9e8c: 8d 05 0f    ...
    ldy #&0c                                                          ; 9e8f: a0 0c       ..
    ldx #2                                                            ; 9e91: a2 02       ..
    jsr c9499                                                         ; 9e93: 20 99 94     ..
    jsr sub_c9ec0                                                     ; 9e96: 20 c0 9e     ..
    ldy #9                                                            ; 9e99: a0 09       ..
...
.loop_c9f15
    ...
    jsr sub_c9a6d                                                     ; 9f1d: 20 6d 9a     m.
    adc (fs_options),y                                                ; 9f20: 71 bb       q.
    sta l00af,y                                                       ; 9f22: 99 af 00    ...
    jsr sub_c9a80                                                     ; 9f25: 20 80 9a     ..
    dex                                                               ; 9f28: ca          .
...
.c9f55
    ...
    bne c9fb8                                                         ; 9f68: d0 4e       .N             ; ALWAYS branch
...
.loop_c9fc0
    ...
    beq c9ff4                                                         ; 9fcb: f0 27       .'             ; ALWAYS branch

; &9fcd referenced 1 time by &9fba
.c9fcd
    jsr ca05b                                                         ; 9fcd: 20 5b a0     [.
    lda #1                                                            ; 9fd0: a9 01       ..
...
.ca058
    jmp c9ff4                                                         ; a058: 4c f4 9f    L..

; &a05b referenced 3 times by &9fcd, &a060, &a2cb
.ca05b
    lda #&c3                                                          ; a05b: a9 c3       ..
    jsr c0406                                                         ; a05d: 20 06 04     ..
    bcc ca05b                                                         ; a060: 90 f9       ..
    rts                                                               ; a062: 60          `
...
.sub_ca08f
    ...
    jsr sub_c915a                                                     ; a095: 20 5a 91     Z.
    bcs ca0ad                                                         ; a098: b0 13       ..
    tya                                                               ; a09a: 98          .
    pha                                                               ; a09b: 48          H
    jsr sub_ca868                                                     ; a09c: 20 68 a8     h.
...
.ca11b
    ...
    lda la3da,x                                                       ; a11f: bd da a3    ...
    pha                                                               ; a122: 48          H
    lda la3d9,x                                                       ; a123: bd d9 a3    ...
    pha                                                               ; a126: 48          H
    rts                                                               ; a127: 60          `
...
.ca1a6
    ...
    jsr sub_caf95                                                     ; a1a9: 20 95 af     ..
    jsr sub_caf12                                                     ; a1ac: 20 12 af     ..
    jsr sub_cae80                                                     ; a1af: 20 80 ae     ..
; &a1b2 referenced 1 time by &a229
.ca1b2
    ldx #1                                                            ; a1b2: a2 01       ..
    jsr sub_caef2                                                     ; a1b4: 20 f2 ae     ..
    lda #2                                                            ; a1b7: a9 02       ..
    sta l0f05                                                         ; a1b9: 8d 05 0f    ...
    ldy #&12                                                          ; a1bc: a0 12       ..
    jsr c9499                                                         ; a1be: 20 99 94     ..
...
.ca265
    ...
    jsr sub_cb4fa                                                     ; a268: 20 fa b4     ..
    tay                                                               ; a26b: a8          .
    lda #0                                                            ; a26c: a9 00       ..
    sta l1060,x                                                       ; a26e: 9d 60 10    .`.
    sty l1070                                                         ; a271: 8c 70 10    .p.
    ldy #3                                                            ; a274: a0 03       ..
    jmp ca3d0                                                         ; a276: 4c d0 a3    L..
...
.loop_ca290
    ...
    jsr ca05b                                                         ; a2cb: 20 5b a0     [.
    ldx #9                                                            ; a2ce: a2 09       ..
    ldy #&0f                                                          ; a2d0: a0 0f       ..
    lda #4                                                            ; a2d2: a9 04       ..
    jmp c0406                                                         ; a2d4: 4c 06 04    L..
...
.ca2dc
    jsr sub_ca313                                                     ; a2dc: 20 13 a3     ..
    jmp c9cb9                                                         ; a2df: 4c b9 9c    L..

    jsr sub_ca34a                                                     ; a2e2: 20 4a a3     J.
    jmp c9cb9                                                         ; a2e5: 4c b9 9c    L..
...
.ca316
    ...
    bit l947d                                                         ; a329: 2c 7d 94    ,}.
; &a32c referenced 1 time by &a317
.ca32c
    sty l0e03                                                         ; a32c: 8c 03 0e    ...
    bvs ca33a                                                         ; a32f: 70 09       p.
    tya                                                               ; a331: 98          .
    jsr sub_cb4fa                                                     ; a332: 20 fa b4     ..
    sta l1073                                                         ; a335: 8d 73 10    .s.
    beq ca376                                                         ; a338: f0 3c       .<
; &a33a referenced 1 time by &a32f
.ca33a
    lda #&2a ; '*'                                                    ; a33a: a9 2a       .*
    bne ca373                                                         ; a33c: d0 35       .5             ; ALWAYS branch

; ***************************************************************************************
.cmd_flip
    lda l0e03                                                         ; a33e: ad 03 0e    ...
    pha                                                               ; a341: 48          H
    ldy l0e04                                                         ; a342: ac 04 0e    ...
    jsr sub_ca313                                                     ; a345: 20 13 a3     ..
    pla                                                               ; a348: 68          h
    tay                                                               ; a349: a8          .
...
.ca34d
    dex                                                               ; a34d: ca          .
    bmi ca363                                                         ; a34e: 30 13       0.
    jsr sub_cb57a                                                     ; a350: 20 7a b5     z.
    bne ca34d                                                         ; a353: d0 f8       ..
    lda l1060,x                                                       ; a355: bd 60 10    .`.
    and #&10                                                          ; a358: 29 10       ).
    beq ca34d                                                         ; a35a: f0 f1       ..
    tya                                                               ; a35c: 98          .
    sta l1030,x                                                       ; a35d: 9d 30 10    .0.
    bit l947d                                                         ; a360: 2c 7d 94    ,}.
; &a363 referenced 1 time by &a34e
.ca363
    sty l0e04                                                         ; a363: 8c 04 0e    ...
    bvs ca371                                                         ; a366: 70 09       p.
    tya                                                               ; a368: 98          .
    jsr sub_cb4fa                                                     ; a369: 20 fa b4     ..
    sta l1074                                                         ; a36c: 8d 74 10    .t.
    beq ca376                                                         ; a36f: f0 05       ..
; &a371 referenced 1 time by &a366
.ca371
    lda #&32 ; '2'                                                    ; a371: a9 32       .2
; &a373 referenced 2 times by &a311, &a33c
.ca373
    sta l1060,x                                                       ; a373: 9d 60 10    .`.
; &a376 referenced 3 times by &a30d, &a338, &a36f
.ca376
    jmp c8f73                                                         ; a376: 4c 73 8f    Ls.

    jsr sub_cb54a                                                     ; a379: 20 4a b5     J.
    sec                                                               ; a37c: 38          8
    lda l0f08                                                         ; a37d: ad 08 0f    ...
    sta l0e05                                                         ; a380: 8d 05 0e    ...
    php                                                               ; a383: 08          .
    ldy l0f05                                                         ; a384: ac 05 0f    ...
    jsr sub_ca2e8                                                     ; a387: 20 e8 a2     ..
    ldy l0f06                                                         ; a38a: ac 06 0f    ...
    jsr sub_ca313                                                     ; a38d: 20 13 a3     ..
    ldy l0f07                                                         ; a390: ac 07 0f    ...
    jsr sub_ca34a                                                     ; a393: 20 4a a3     J.
    plp                                                               ; a396: 28          (
    bcs ca39c                                                         ; a397: b0 03       ..
    jmp c9cb9                                                         ; a399: 4c b9 9c    L..

; &a39c referenced 1 time by &a397
.ca39c
    lda l1071                                                         ; a39c: ad 71 10    .q.
    tax                                                               ; a39f: aa          .
    and #4                                                            ; a3a0: 29 04       ).
    php                                                               ; a3a2: 08          .
    txa                                                               ; a3a3: 8a          .
    and #&fb                                                          ; a3a4: 29 fb       ).
    sta l1071                                                         ; a3a6: 8d 71 10    .q.
    plp                                                               ; a3a9: 28          (
    bne ca3cb                                                         ; a3aa: d0 1f       ..
    lda #osbyte_scan_keyboard                                         ; a3ac: a9 79       .y
...
.ca3cb
    ldy l0e05                                                         ; a3cb: ac 05 0e    ...
    beq boot_load_cmd                                                 ; a3ce: f0 e6       ..
; &a3d0 referenced 1 time by &a276
.ca3d0
    ldx la3c7,y                                                       ; a3d0: be c7 a3    ...
    ldy #&a3                                                          ; a3d3: a0 a3       ..
...
.ca526
    ...
    jsr sub_ca57c                                                     ; a554: 20 7c a5     |.
    sta l0f07                                                         ; a557: 8d 07 0f    ...
    pla                                                               ; a55a: 68          h
    pha                                                               ; a55b: 48          H
    and #&0f                                                          ; a55c: 29 0f       ).
    jsr sub_ca57c                                                     ; a55e: 20 7c a5     |.
...
.loop_ca878
    lda la844,y                                                       ; a878: b9 44 a8    .D.
    sta (nfs_workspace),y                                             ; a87b: 91 9e       ..
    lda la850,x                                                       ; a87d: bd 50 a8    .P.
...
.return_23
    ...
    ldy #&23 ; '#'                                                    ; a8d9: a0 23       .#
    jsr sub_caf12                                                     ; a8db: 20 12 af     ..
; &a8de referenced 1 time by &a8eb
.loop_ca8de
    lda c945f,y                                                       ; a8de: b9 5f 94    ._.
...
.loop_ca93d
    ...
    pha                                                               ; a949: 48          H
    jsr sub_caa6a                                                     ; a94a: 20 6a aa     j.
    jsr sub_ca964                                                     ; a94d: 20 64 a9     d.
...
.sub_ca981
    lda la995,x                                                       ; a981: bd 95 a9    ...
    pha                                                               ; a984: 48          H
    lda la98c,x                                                       ; a985: bd 8c a9    ...
    pha                                                               ; a988: 48          H
...
.cmd_cdir
    tya                                                               ; acfe: 98          .
    pha                                                               ; acff: 48          H
    jsr sub_caf12                                                     ; ad00: 20 12 af     ..
    jsr sub_cafa1                                                     ; ad03: 20 a1 af     ..
    cmp #&0d                                                          ; ad06: c9 0d       ..
    bne cad0e                                                         ; ad08: d0 04       ..
    ldx #2                                                            ; ad0a: a2 02       ..
...
.cad0e
    lda #&ff                                                          ; ad0e: a9 ff       ..
    sta fs_work_4                                                     ; ad10: 85 b4       ..
    jsr sub_c915a                                                     ; ad12: 20 5a 91     Z.
    ldx #&1b                                                          ; ad15: a2 1b       ..
; &ad17 referenced 1 time by &ad1b
.loop_cad17
    dex                                                               ; ad17: ca          .
    cmp lad31,x                                                       ; ad18: dd 31 ad    .1.
    bcc loop_cad17                                                    ; ad1b: 90 fa       ..
; &ad1d referenced 1 time by &ad0c
.cad1d
    stx l0f05                                                         ; ad1d: 8e 05 0f    ...
    pla                                                               ; ad20: 68          h
    tay                                                               ; ad21: a8          .
    jsr sub_caf95                                                     ; ad22: 20 95 af     ..
    jsr sub_cae82                                                     ; ad25: 20 82 ae     ..
    ldx #1                                                            ; ad28: a2 01       ..
    jsr sub_caef2                                                     ; ad2a: 20 f2 ae     ..
    ldy #&1b                                                          ; ad2d: a0 1b       ..
.sub_cad2f
lad31 = sub_cad2f+2
    jmp c9499                                                         ; ad2f: 4c 99 94    L..
...
; ***************************************************************************************
.cmd_lcat
    ror l1071                                                         ; ad4d: 6e 71 10    nq.
    sec                                                               ; ad50: 38          8
    bcs cad77                                                         ; ad51: b0 24       .$             ; ALWAYS branch

; ***************************************************************************************
.cmd_lex
    ror l1071                                                         ; ad53: 6e 71 10    nq.
    sec                                                               ; ad56: 38          8
    bcs cad5d                                                         ; ad57: b0 04       ..             ; ALWAYS branch

; ***************************************************************************************
.cmd_ex
    ror l1071                                                         ; ad59: 6e 71 10    nq.
    clc                                                               ; ad5c: 18          .
; &ad5d referenced 1 time by &ad57
.cad5d
    rol l1071                                                         ; ad5d: 2e 71 10    .q.
    lda #&ff                                                          ; ad60: a9 ff       ..
    sta fs_spool_handle                                               ; ad62: 85 ba       ..
    lda #1                                                            ; ad64: a9 01       ..
    sta fs_work_7                                                     ; ad66: 85 b7       ..
    lda #3                                                            ; ad68: a9 03       ..
    sta fs_work_5                                                     ; ad6a: 85 b5       ..
    bne cad84                                                         ; ad6c: d0 16       ..             ; ALWAYS branch

    jsr sub_c9281                                                     ; ad6e: 20 81 92     ..
    ldy #0                                                            ; ad71: a0 00       ..
    ror l1071                                                         ; ad73: 6e 71 10    nq.
    clc                                                               ; ad76: 18          .
; &ad77 referenced 1 time by &ad51
.cad77
    rol l1071                                                         ; ad77: 2e 71 10    .q.
    lda #3                                                            ; ad7a: a9 03       ..
    sta fs_spool_handle                                               ; ad7c: 85 ba       ..
    sta fs_work_7                                                     ; ad7e: 85 b7       ..
    lda #&0b                                                          ; ad80: a9 0b       ..
    sta fs_work_5                                                     ; ad82: 85 b5       ..
; &ad84 referenced 1 time by &ad6c
.cad84
    jsr sub_caf95                                                     ; ad84: 20 95 af     ..
    lda #&ff                                                          ; ad87: a9 ff       ..
    sta escapable                                                     ; ad89: 85 97       ..
    lda #6                                                            ; ad8b: a9 06       ..
    sta l0f05                                                         ; ad8d: 8d 05 0f    ...
    jsr sub_cae82                                                     ; ad90: 20 82 ae     ..
    ldx #1                                                            ; ad93: a2 01       ..
    jsr sub_caef2                                                     ; ad95: 20 f2 ae     ..
    lda l1071                                                         ; ad98: ad 71 10    .q.
    lsr a                                                             ; ad9b: 4a          J
...
.sub_cae82
    jsr sub_c98ff                                                     ; ae82: 20 ff 98     ..
; &ae85 referenced 4 times by &92da, &9382, &93bb, &992a
.sub_cae85
    lda l0e30                                                         ; ae85: ad 30 0e    .0.
    eor #&26 ; '&'                                                    ; ae88: 49 26       I&
    bne caed0                                                         ; ae8a: d0 44       .D
    lda l1071                                                         ; ae8c: ad 71 10    .q.
    ora #&40 ; '@'                                                    ; ae8f: 09 40       .@
    sta l1071                                                         ; ae91: 8d 71 10    .q.
    jsr caea5                                                         ; ae94: 20 a5 ae     ..
    lda l0e30                                                         ; ae97: ad 30 0e    .0.
    eor #&2e ; '.'                                                    ; ae9a: 49 2e       I.
    bne caec9                                                         ; ae9c: d0 2b       .+
    lda l0e31                                                         ; ae9e: ad 31 0e    .1.
    eor #&0d                                                          ; aea1: 49 0d       I.
    beq caecd                                                         ; aea3: f0 28       .(
...
.loop_caea9
    inx                                                               ; aea9: e8          .
    lda l0e31,x                                                       ; aeaa: bd 31 0e    .1.
    sta l0e30,x                                                       ; aead: 9d 30 0e    .0.
    eor #&0d                                                          ; aeb0: 49 0d       I.
    bne loop_caea9                                                    ; aeb2: d0 f5       ..
    txa                                                               ; aeb4: 8a          .
    beq caec6                                                         ; aeb5: f0 0f       ..
; &aeb7 referenced 1 time by &aec4
.loop_caeb7
    lda l0e2f,x                                                       ; aeb7: bd 2f 0e    ./.
    eor #&20 ; ' '                                                    ; aeba: 49 20       I
    bne caec6                                                         ; aebc: d0 08       ..
    lda #&0d                                                          ; aebe: a9 0d       ..
    sta l0e2f,x                                                       ; aec0: 9d 2f 0e    ./.
    dex                                                               ; aec3: ca          .
    bne loop_caeb7                                                    ; aec4: d0 f1       ..
...
.caec9
    eor #&23 ; '#'                                                    ; aec9: 49 23       I#
    beq return_27                                                     ; aecb: f0 fb       ..
; &aecd referenced 1 time by &aea3
.caecd
    jmp c92e6                                                         ; aecd: 4c e6 92    L..

; &aed0 referenced 1 time by &ae8a
.caed0
    eor #&1c                                                          ; aed0: 49 1c       I.
    bne return_27                                                     ; aed2: d0 f4       ..
    lda l0e32                                                         ; aed4: ad 32 0e    .2.
    eor #&2e ; '.'                                                    ; aed7: 49 2e       I.
    beq caedf                                                         ; aed9: f0 04       ..
    eor #&23 ; '#'                                                    ; aedb: 49 23       I#
    bne return_27                                                     ; aedd: d0 e9       ..
; &aedf referenced 1 time by &aed9
.caedf
    lda l1071                                                         ; aedf: ad 71 10    .q.
    ora #&40 ; '@'                                                    ; aee2: 09 40       .@
...
.loop_caef5
    lda (fs_crc_lo),y                                                 ; aef5: b1 be       ..
    sta l0f05,x                                                       ; aef7: 9d 05 0f    ...
    bcc caf07                                                         ; aefa: 90 0b       ..
    cmp #&21 ; '!'                                                    ; aefc: c9 21       .!
    eor #&26 ; '&'                                                    ; aefe: 49 26       I&
    bne caf05                                                         ; af00: d0 03       ..
    jmp c92e6                                                         ; af02: 4c e6 92    L..
...
.caf3f
    ...
    adc l0063                                                         ; af44: 65 63       ec
; ***************************************************************************************
.cmd_remove
    tya                                                               ; af46: 98          .
    pha                                                               ; af47: 48          H
    jsr sub_cafa1                                                     ; af48: 20 a1 af     ..
    cmp #&0d                                                          ; af4b: c9 0d       ..
    beq caf52                                                         ; af4d: f0 03       ..
    jmp ca10f                                                         ; af4f: 4c 0f a1    L..

; &af52 referenced 1 time by &af4d
.caf52
    pla                                                               ; af52: 68          h
    tay                                                               ; af53: a8          .
    jsr sub_caf95                                                     ; af54: 20 95 af     ..
    jsr sub_cae82                                                     ; af57: 20 82 ae     ..
    jsr sub_caef0                                                     ; af5a: 20 f0 ae     ..
    ldy #&14                                                          ; af5d: a0 14       ..
...
.caf68
    tay                                                               ; af68: a8          .
    lda #&64 ; 'd'                                                    ; af69: a9 64       .d
    jsr sub_caf76                                                     ; af6b: 20 76 af     v.
    lda #&0a                                                          ; af6e: a9 0a       ..
    jsr sub_caf76                                                     ; af70: 20 76 af     v.
    clv                                                               ; af73: b8          .
    lda #1                                                            ; af74: a9 01       ..
; &af76 referenced 2 times by &af6b, &af70
.sub_caf76
    sta fs_error_ptr                                                  ; af76: 85 b8       ..
    tya                                                               ; af78: 98          .
    ldx #&2f ; '/'                                                    ; af79: a2 2f       ./
    sec                                                               ; af7b: 38          8
    php                                                               ; af7c: 08          .
...
.loop_caf7d
    inx                                                               ; af7d: e8          .
    sbc fs_error_ptr                                                  ; af7e: e5 b8       ..
    bcs loop_caf7d                                                    ; af80: b0 fb       ..
    adc fs_error_ptr                                                  ; af82: 65 b8       e.
    tay                                                               ; af84: a8          .
    txa                                                               ; af85: 8a          .
    plp                                                               ; af86: 28          (
    bvc caf8d                                                         ; af87: 50 04       P.
    cmp #&30 ; '0'                                                    ; af89: c9 30       .0
    beq return_29                                                     ; af8b: f0 07       ..
; &af8d referenced 1 time by &af87
.caf8d
    ldx fs_error_ptr                                                  ; af8d: a6 b8       ..
    jsr osasci                                                        ; af8f: 20 e3 ff     ..            ; Write character
    stx fs_error_ptr                                                  ; af92: 86 b8       ..
...
.sub_caf95
    pha                                                               ; af95: 48          H
    lda fs_crc_lo                                                     ; af96: a5 be       ..
    sta os_text_ptr                                                   ; af98: 85 f2       ..
    lda fs_crc_hi                                                     ; af9a: a5 bf       ..
    sta os_text_ptr_hi                                                ; af9c: 85 f3       ..
    pla                                                               ; af9e: 68          h
    rts                                                               ; af9f: 60          `
...
.sub_cafa1
    lda (fs_crc_lo),y                                                 ; afa1: b1 be       ..
    cmp #&20 ; ' '                                                    ; afa3: c9 20       .
    beq cafad                                                         ; afa5: f0 06       ..
    cmp #&0d                                                          ; afa7: c9 0d       ..
    beq return_30                                                     ; afa9: f0 09       ..
    bne loop_cafa0                                                    ; afab: d0 f3       ..             ; ALWAYS branch

; &afad referenced 2 times by &afa5, &afb2
.cafad
    iny                                                               ; afad: c8          .
    lda (fs_crc_lo),y                                                 ; afae: b1 be       ..
    cmp #&20 ; ' '                                                    ; afb0: c9 20       .
    beq cafad                                                         ; afb2: f0 f9       ..
...
.sub_cafb5
    pha                                                               ; afb5: 48          H
    lda fs_crc_lo                                                     ; afb6: a5 be       ..
    sta fs_options                                                    ; afb8: 85 bb       ..
    lda fs_crc_hi                                                     ; afba: a5 bf       ..
    sta fs_block_offset                                               ; afbc: 85 bc       ..
    pla                                                               ; afbe: 68          h
    rts                                                               ; afbf: 60          `
...
.sub_cafc0
    tya                                                               ; afc0: 98          .
    pha                                                               ; afc1: 48          H
    jsr sub_c8cae                                                     ; afc2: 20 ae 8c     ..
    sta l00af                                                         ; afc5: 85 af       ..
    pla                                                               ; afc7: 68          h
    tay                                                               ; afc8: a8          .
    lda #0                                                            ; afc9: a9 00       ..
    sta l00ae                                                         ; afcb: 85 ae       ..
    rts                                                               ; afcd: 60          `

; ***************************************************************************************
.cmd_ps
    lda #1                                                            ; afce: a9 01       ..
    bit ws_0d6a                                                       ; afd0: 2c 6a 0d    ,j.
    bne cafd8                                                         ; afd3: d0 03       ..
    jmp cabec                                                         ; afd5: 4c ec ab    L..

; &afd8 referenced 1 time by &afd3
.cafd8
    jsr sub_cafc0                                                     ; afd8: 20 c0 af     ..
    jsr sub_cafb5                                                     ; afdb: 20 b5 af     ..
    lda (fs_options),y                                                ; afde: b1 bb       ..
    cmp #&0d                                                          ; afe0: c9 0d       ..
    beq cb005                                                         ; afe2: f0 21       .!
    clv                                                               ; afe4: b8          .
    jsr sub_c9244                                                     ; afe5: 20 44 92     D.
    bcc cb008                                                         ; afe8: 90 1e       ..
    tya                                                               ; afea: 98          .
    pha                                                               ; afeb: 48          H
    jsr sub_cb0c6                                                     ; afec: 20 c6 b0     ..
    pla                                                               ; afef: 68          h
    tay                                                               ; aff0: a8          .
    jsr sub_ca08f                                                     ; aff1: 20 8f a0     ..
    jmp cb095                                                         ; aff4: 4c 95 b0    L..
...
.loop_caffb
    lda l8d4b,x                                                       ; affb: bd 4b 8d    .K.
    sta (net_rx_ptr),y                                                ; affe: 91 9c       ..
    iny                                                               ; b000: c8          .
    inx                                                               ; b001: e8          .
    bne loop_caffb                                                    ; b002: d0 f7       ..
    rts                                                               ; b004: 60          `

; &b005 referenced 1 time by &afe2
.cb005
    bit l947d                                                         ; b005: 2c 7d 94    ,}.
; &b008 referenced 1 time by &afe8
.cb008
    sty ws_ptr_hi                                                     ; b008: 84 ac       ..
    bvs cb038                                                         ; b00a: 70 2c       p,
    ldx #6                                                            ; b00c: a2 06       ..
    ldy #&1c                                                          ; b00e: a0 1c       ..
    lda #&20 ; ' '                                                    ; b010: a9 20       .
; &b012 referenced 1 time by &b016
.loop_cb012
    sta (net_rx_ptr),y                                                ; b012: 91 9c       ..
    iny                                                               ; b014: c8          .
    dex                                                               ; b015: ca          .
    bne loop_cb012                                                    ; b016: d0 fa       ..
    jsr sub_caf95                                                     ; b018: 20 95 af     ..
    ldy ws_ptr_hi                                                     ; b01b: a4 ac       ..
    jsr gsinit                                                        ; b01d: 20 c2 ff     ..
    beq cb038                                                         ; b020: f0 16       ..
    ldx #6                                                            ; b022: a2 06       ..
    sty ws_ptr_hi                                                     ; b024: 84 ac       ..
    ldy #&1c                                                          ; b026: a0 1c       ..
    sty l00ad                                                         ; b028: 84 ad       ..
; &b02a referenced 1 time by &b036
.loop_cb02a
    ldy ws_ptr_hi                                                     ; b02a: a4 ac       ..
    jsr gsread                                                        ; b02c: 20 c5 ff     ..
    sty ws_ptr_hi                                                     ; b02f: 84 ac       ..
    bcs cb038                                                         ; b031: b0 05       ..
    jsr sub_cb2db                                                     ; b033: 20 db b2     ..
    bne loop_cb02a                                                    ; b036: d0 f2       ..
; &b038 referenced 3 times by &b00a, &b020, &b031
.cb038
    jsr sub_cb149                                                     ; b038: 20 49 b1     I.
    jsr c982a                                                         ; b03b: 20 2a 98     *.
    jsr sub_cb0d2                                                     ; b03e: 20 d2 b0     ..
    jsr sub_cb0c6                                                     ; b041: 20 c6 b0     ..
    lda #0                                                            ; b044: a9 00       ..
    tax                                                               ; b046: aa          .              ; X=&00
    ldy #&24 ; '$'                                                    ; b047: a0 24       .$
    sta (net_rx_ptr),y                                                ; b049: 91 9c       ..
; &b04b referenced 1 time by &b073
.cb04b
    pla                                                               ; b04b: 68          h
    beq cb075                                                         ; b04c: f0 27       .'
    pha                                                               ; b04e: 48          H
    tay                                                               ; b04f: a8          .
    lda (nfs_workspace),y                                             ; b050: b1 9e       ..
    bpl cb06d                                                         ; b052: 10 19       ..
    jsr sub_c9a6d                                                     ; b054: 20 6d 9a     m.
    lda (nfs_workspace),y                                             ; b057: b1 9e       ..
    sta l00ae                                                         ; b059: 85 ae       ..
    lda (l00ae,x)                                                     ; b05b: a1 ae       ..
    bne cb06d                                                         ; b05d: d0 0e       ..
    dey                                                               ; b05f: 88          .
    lda (nfs_workspace),y                                             ; b060: b1 9e       ..
    sta l00b6                                                         ; b062: 85 b6       ..
    dey                                                               ; b064: 88          .
    lda (nfs_workspace),y                                             ; b065: b1 9e       ..
    sta fs_work_5                                                     ; b067: 85 b5       ..
    ldy #&24 ; '$'                                                    ; b069: a0 24       .$
    sta (net_rx_ptr),y                                                ; b06b: 91 9c       ..
; &b06d referenced 2 times by &b052, &b05d
.cb06d
    pla                                                               ; b06d: 68          h
    tay                                                               ; b06e: a8          .
    lda #&3f ; '?'                                                    ; b06f: a9 3f       .?
    sta (nfs_workspace),y                                             ; b071: 91 9e       ..
    bne cb04b                                                         ; b073: d0 d6       ..             ; ALWAYS branch

; &b075 referenced 1 time by &b04c
.cb075
    jsr sub_cb0ab                                                     ; b075: 20 ab b0     ..
    ldy #&24 ; '$'                                                    ; b078: a0 24       .$
...
.cb095
    ldy #2                                                            ; b095: a0 02       ..
    lda fs_work_5                                                     ; b097: a5 b5       ..
    sta (nfs_workspace),y                                             ; b099: 91 9e       ..
    iny                                                               ; b09b: c8          .              ; Y=&03
    lda l00b6                                                         ; b09c: a5 b6       ..
    sta (nfs_workspace),y                                             ; b09e: 91 9e       ..
    rts                                                               ; b0a0: 60          `
...
.sub_cb0c6
    ldy #2                                                            ; b0c6: a0 02       ..
    lda (nfs_workspace),y                                             ; b0c8: b1 9e       ..
    sta fs_work_5                                                     ; b0ca: 85 b5       ..
    iny                                                               ; b0cc: c8          .              ; Y=&03
    lda (nfs_workspace),y                                             ; b0cd: b1 9e       ..
    sta l00b6                                                         ; b0cf: 85 b6       ..
    rts                                                               ; b0d1: 60          `

; &b0d2 referenced 2 times by &b03e, &b219
.sub_cb0d2
    pla                                                               ; b0d2: 68          h
    sta osword_flag                                                   ; b0d3: 85 aa       ..
    pla                                                               ; b0d5: 68          h
    sta ws_ptr_lo                                                     ; b0d6: 85 ab       ..
    lda #0                                                            ; b0d8: a9 00       ..
    pha                                                               ; b0da: 48          H
    lda #&84                                                          ; b0db: a9 84       ..
    sta ws_ptr_hi                                                     ; b0dd: 85 ac       ..
    lsr l0d61                                                         ; b0df: 4e 61 0d    Na.
    lda #3                                                            ; b0e2: a9 03       ..
...
.cb0f4
    inx                                                               ; b0f4: e8          .
    txa                                                               ; b0f5: 8a          .
    bne loop_cb0e4                                                    ; b0f6: d0 ec       ..
; &b0f8 referenced 1 time by &b0f2
.cb0f8
    tya                                                               ; b0f8: 98          .
    pha                                                               ; b0f9: 48          H
    lda #&7f                                                          ; b0fa: a9 7f       ..
    sta (nfs_workspace),y                                             ; b0fc: 91 9e       ..
    iny                                                               ; b0fe: c8          .
    lda #&9e                                                          ; b0ff: a9 9e       ..
    sta (nfs_workspace),y                                             ; b101: 91 9e       ..
    lda #0                                                            ; b103: a9 00       ..
    jsr sub_cb141                                                     ; b105: 20 41 b1     A.
    lda ws_ptr_hi                                                     ; b108: a5 ac       ..
    sta (nfs_workspace),y                                             ; b10a: 91 9e       ..
    clc                                                               ; b10c: 18          .
    php                                                               ; b10d: 08          .
    adc #3                                                            ; b10e: 69 03       i.
    plp                                                               ; b110: 28          (
    sta ws_ptr_hi                                                     ; b111: 85 ac       ..
    jsr sub_cb13a                                                     ; b113: 20 3a b1     :.
    lda ws_ptr_hi                                                     ; b116: a5 ac       ..
    sta (nfs_workspace),y                                             ; b118: 91 9e       ..
.sub_cb11a
lb11b = sub_cb11a+1
    jsr sub_cb13a                                                     ; b11a: 20 3a b1     :.
...
.cb120
    ...
    tay                                                               ; b12b: a8          .              ; Y=&0a
    tax                                                               ; b12c: aa          .              ; X=&0a
    sta fs_work_4                                                     ; b12d: 85 b4       ..
; &b12f referenced 3 times by &b130, &b133, &b137
.cb12f
    dey                                                               ; b12f: 88          .
    bne cb12f                                                         ; b130: d0 fd       ..
    dex                                                               ; b132: ca          .
    bne cb12f                                                         ; b133: d0 fa       ..
    dec fs_work_4                                                     ; b135: c6 b4       ..
    bne cb12f                                                         ; b137: d0 f6       ..
    rts                                                               ; b139: 60          `

; &b13a referenced 2 times by &b113, &b11a
.sub_cb13a
    iny                                                               ; b13a: c8          .
    lda l00af                                                         ; b13b: a5 af       ..
    sta (nfs_workspace),y                                             ; b13d: 91 9e       ..
    lda #&ff                                                          ; b13f: a9 ff       ..
; &b141 referenced 1 time by &b105
.sub_cb141
    iny                                                               ; b141: c8          .
    sta (nfs_workspace),y                                             ; b142: 91 9e       ..
    iny                                                               ; b144: c8          .
    sta (nfs_workspace),y                                             ; b145: 91 9e       ..
    iny                                                               ; b147: c8          .
    rts                                                               ; b148: 60          `
...
.loop_cb14b
    lda (net_rx_ptr),y                                                ; b14b: b1 9c       ..
    pha                                                               ; b14d: 48          H
    iny                                                               ; b14e: c8          .
    cpy #&24 ; '$'                                                    ; b14f: c0 24       .$
    bne loop_cb14b                                                    ; b151: d0 f8       ..
    ldy #&1b                                                          ; b153: a0 1b       ..
; &b155 referenced 1 time by &b15b
.loop_cb155
    pla                                                               ; b155: 68          h
    sta (net_rx_ptr),y                                                ; b156: 91 9c       ..
    dey                                                               ; b158: 88          .
    cpy #&13                                                          ; b159: c0 13       ..
    bne loop_cb155                                                    ; b15b: d0 f8       ..
    lda net_rx_ptr_hi                                                 ; b15d: a5 9d       ..
    sta net_tx_ptr_hi                                                 ; b15f: 85 9b       ..
    lda #&10                                                          ; b161: a9 10       ..
    sta net_tx_ptr                                                    ; b163: 85 9a       ..
    ldy #3                                                            ; b165: a0 03       ..
; &b167 referenced 1 time by &b16d
.loop_cb167
    lda lb170,y                                                       ; b167: b9 70 b1    .p.
    sta (net_tx_ptr),y                                                ; b16a: 91 9a       ..
    dey                                                               ; b16c: 88          .
    bpl loop_cb167                                                    ; b16d: 10 f8       ..
    rts                                                               ; b16f: 60          `
...
.sub_cb174
    ...
    beq cb184                                                         ; b177: f0 0b       ..
    jsr caf68                                                         ; b179: 20 68 af     h.
    lda #&2e ; '.'                                                    ; b17c: a9 2e       ..
    jsr osasci                                                        ; b17e: 20 e3 ff     ..            ; Write character 46
    bit l947d                                                         ; b181: 2c 7d 94    ,}.
...
.cb18d
    lda fs_work_5                                                     ; b18d: a5 b5       ..
    plp                                                               ; b18f: 28          (
    jmp caf68                                                         ; b190: 4c 68 af    Lh.

    equb &80, &9f, 0, 0, &14, 0, &ff, &ff, &1c, 0, &ff, &ff           ; b193: 80 9f 00... ...

; ***************************************************************************************
.cmd_pollps
    sty ws_ptr_hi                                                     ; b19f: 84 ac       ..
    jsr sub_cafc0                                                     ; b1a1: 20 c0 af     ..
    sta fs_work_4                                                     ; b1a4: 85 b4       ..
    jsr sub_cb149                                                     ; b1a6: 20 49 b1     I.
    jsr sub_cb2c4                                                     ; b1a9: 20 c4 b2     ..
    ldy ws_ptr_hi                                                     ; b1ac: a4 ac       ..
    jsr sub_cafb5                                                     ; b1ae: 20 b5 af     ..
    lda (fs_options),y                                                ; b1b1: b1 bb       ..
    cmp #&0d                                                          ; b1b3: c9 0d       ..
    beq cb1e1                                                         ; b1b5: f0 2a       .*
    clv                                                               ; b1b7: b8          .
    jsr sub_c9244                                                     ; b1b8: 20 44 92     D.
    bcc cb1e4                                                         ; b1bb: 90 27       .'
    tya                                                               ; b1bd: 98          .
    pha                                                               ; b1be: 48          H
    jsr sub_cb0c6                                                     ; b1bf: 20 c6 b0     ..
    pla                                                               ; b1c2: 68          h
    tay                                                               ; b1c3: a8          .
    jsr sub_ca08f                                                     ; b1c4: 20 8f a0     ..
    ldy #&7a ; 'z'                                                    ; b1c7: a0 7a       .z
    lda fs_work_5                                                     ; b1c9: a5 b5       ..
    sta (l00ae),y                                                     ; b1cb: 91 ae       ..
    iny                                                               ; b1cd: c8          .              ; Y=&7b
    lda l00b6                                                         ; b1ce: a5 b6       ..
    sta (l00ae),y                                                     ; b1d0: 91 ae       ..
    ldy #&14                                                          ; b1d2: a0 14       ..
    jsr sub_caff9                                                     ; b1d4: 20 f9 af     ..
    lda l00af                                                         ; b1d7: a5 af       ..
    sta net_tx_ptr_hi                                                 ; b1d9: 85 9b       ..
    lda #&78 ; 'x'                                                    ; b1db: a9 78       .x
    sta net_tx_ptr                                                    ; b1dd: 85 9a       ..
    bne cb212                                                         ; b1df: d0 31       .1             ; ALWAYS branch

; &b1e1 referenced 1 time by &b1b5
.cb1e1
    bit l947d                                                         ; b1e1: 2c 7d 94    ,}.
; &b1e4 referenced 1 time by &b1bb
.cb1e4
    bvs cb212                                                         ; b1e4: 70 2c       p,
    ldx #6                                                            ; b1e6: a2 06       ..
    ldy #&14                                                          ; b1e8: a0 14       ..
    lda #&20 ; ' '                                                    ; b1ea: a9 20       .
; &b1ec referenced 1 time by &b1f0
.loop_cb1ec
    sta (net_rx_ptr),y                                                ; b1ec: 91 9c       ..
    iny                                                               ; b1ee: c8          .
    dex                                                               ; b1ef: ca          .
    bne loop_cb1ec                                                    ; b1f0: d0 fa       ..
    jsr sub_caf95                                                     ; b1f2: 20 95 af     ..
    ldy ws_ptr_hi                                                     ; b1f5: a4 ac       ..
    jsr gsinit                                                        ; b1f7: 20 c2 ff     ..
    beq cb212                                                         ; b1fa: f0 16       ..
    ldx #6                                                            ; b1fc: a2 06       ..
    sty ws_ptr_hi                                                     ; b1fe: 84 ac       ..
    ldy #&14                                                          ; b200: a0 14       ..
    sty l00ad                                                         ; b202: 84 ad       ..
; &b204 referenced 1 time by &b210
.loop_cb204
    ldy ws_ptr_hi                                                     ; b204: a4 ac       ..
    jsr gsread                                                        ; b206: 20 c5 ff     ..
    sty ws_ptr_hi                                                     ; b209: 84 ac       ..
    bcs cb212                                                         ; b20b: b0 05       ..
    jsr sub_cb2db                                                     ; b20d: 20 db b2     ..
    bne loop_cb204                                                    ; b210: d0 f2       ..
; &b212 referenced 4 times by &b1df, &b1e4, &b1fa, &b20b
.cb212
    lda #&80                                                          ; b212: a9 80       ..
    sta escapable                                                     ; b214: 85 97       ..
    jsr c982a                                                         ; b216: 20 2a 98     *.
    jsr sub_cb0d2                                                     ; b219: 20 d2 b0     ..
    jsr sub_cb0ab                                                     ; b21c: 20 ab b0     ..
...
.sub_cb2c4
    ldy #&78 ; 'x'                                                    ; b2c4: a0 78       .x
; &b2c6 referenced 1 time by &b2d8
.loop_cb2c6
    lda lb11b,y                                                       ; b2c6: b9 1b b1    ...
    cpy #&7d ; '}'                                                    ; b2c9: c0 7d       .}
    beq cb2d1                                                         ; b2cb: f0 04       ..
    cpy #&81                                                          ; b2cd: c0 81       ..
    bne cb2d3                                                         ; b2cf: d0 02       ..
; &b2d1 referenced 1 time by &b2cb
.cb2d1
    lda net_rx_ptr_hi                                                 ; b2d1: a5 9d       ..
; &b2d3 referenced 1 time by &b2cf
.cb2d3
    sta (l00ae),y                                                     ; b2d3: 91 ae       ..
    iny                                                               ; b2d5: c8          .
    cpy #&84                                                          ; b2d6: c0 84       ..
    bne loop_cb2c6                                                    ; b2d8: d0 ec       ..
    rts                                                               ; b2da: 60          `

; &b2db referenced 2 times by &b033, &b20d
.sub_cb2db
    ldy l00ad                                                         ; b2db: a4 ad       ..
    and #&7f                                                          ; b2dd: 29 7f       ).
    cmp #&61 ; 'a'                                                    ; b2df: c9 61       .a
    bcc cb2e9                                                         ; b2e1: 90 06       ..
    cmp #&7b ; '{'                                                    ; b2e3: c9 7b       .{
    bcs cb2e9                                                         ; b2e5: b0 02       ..
    and #&5f ; '_'                                                    ; b2e7: 29 5f       )_
; &b2e9 referenced 2 times by &b2e1, &b2e5
.cb2e9
    sta (net_rx_ptr),y                                                ; b2e9: 91 9c       ..
    iny                                                               ; b2eb: c8          .
    sty l00ad                                                         ; b2ec: 84 ad       ..
    dex                                                               ; b2ee: ca          .
    rts                                                               ; b2ef: 60          `

; ***************************************************************************************
.cmd_prot
    lda (fs_crc_lo),y                                                 ; b2f0: b1 be       ..
    eor #&0d                                                          ; b2f2: 49 0d       I.
    bne cb2fa                                                         ; b2f4: d0 04       ..
    lda #&ff                                                          ; b2f6: a9 ff       ..
    bne cb31a                                                         ; b2f8: d0 20       .              ; ALWAYS branch

; &b2fa referenced 1 time by &b2f4
.cb2fa
    lda ws_0d68                                                       ; b2fa: ad 68 0d    .h.
    pha                                                               ; b2fd: 48          H
; &b2fe referenced 1 time by &b30e
.loop_cb2fe
    ldx #&d3                                                          ; b2fe: a2 d3       ..
    lda (fs_crc_lo),y                                                 ; b300: b1 be       ..
    sta ws_page                                                       ; b302: 85 a8       ..
    jsr sub_ca128                                                     ; b304: 20 28 a1     (.
    bcs cb310                                                         ; b307: b0 07       ..
    pla                                                               ; b309: 68          h
    ora la3d9,x                                                       ; b30a: 1d d9 a3    ...
    pha                                                               ; b30d: 48          H
    bne loop_cb2fe                                                    ; b30e: d0 ee       ..
; &b310 referenced 2 times by &b307, &b334
.cb310
    lda ws_page                                                       ; b310: a5 a8       ..
    eor #&0d                                                          ; b312: 49 0d       I.
    beq cb319                                                         ; b314: f0 03       ..
    jmp ca245                                                         ; b316: 4c 45 a2    LE.
...
.cb31a
    sta ws_0d68                                                       ; b31a: 8d 68 0d    .h.
    sta ws_0d69                                                       ; b31d: 8d 69 0d    .i.
    rts                                                               ; b320: 60          `

; ***************************************************************************************
.cmd_unprot
    lda (fs_crc_lo),y                                                 ; b321: b1 be       ..
    eor #&0d                                                          ; b323: 49 0d       I.
    beq cb31a                                                         ; b325: f0 f3       ..
    lda ws_0d68                                                       ; b327: ad 68 0d    .h.
    pha                                                               ; b32a: 48          H
; &b32b referenced 1 time by &b33b
.loop_cb32b
    ldx #&d3                                                          ; b32b: a2 d3       ..
    lda (fs_crc_lo),y                                                 ; b32d: b1 be       ..
    sta ws_page                                                       ; b32f: 85 a8       ..
    jsr sub_ca128                                                     ; b331: 20 28 a1     (.
    bcs cb310                                                         ; b334: b0 da       ..
    pla                                                               ; b336: 68          h
    and la3da,x                                                       ; b337: 3d da a3    =..
    pha                                                               ; b33a: 48          H
    bcc loop_cb32b                                                    ; b33b: 90 ee       ..             ; ALWAYS branch

; ***************************************************************************************
.cmd_wipe
    jsr sub_caf12                                                     ; b33d: 20 12 af     ..
    lda #0                                                            ; b340: a9 00       ..
    sta fs_work_5                                                     ; b342: 85 b5       ..
    jsr sub_caf95                                                     ; b344: 20 95 af     ..
    jsr sub_cae82                                                     ; b347: 20 82 ae     ..
    inx                                                               ; b34a: e8          .
...
.cb34d
    ...
    ldx #3                                                            ; b35a: a2 03       ..
    jsr sub_caef2                                                     ; b35c: 20 f2 ae     ..
    ldy #3                                                            ; b35f: a0 03       ..
    lda #&80                                                          ; b361: a9 80       ..
    sta escapable                                                     ; b363: 85 97       ..
    jsr c9499                                                         ; b365: 20 99 94     ..
...
.sub_cb46a
    cmp #&20 ; ' '                                                    ; b46a: c9 20       .
    bcc cb472                                                         ; b46c: 90 04       ..
    cmp #&30 ; '0'                                                    ; b46e: c9 30       .0
    bcc cb49d                                                         ; b470: 90 2b       .+
...
.cb678
    ...
    jsr sub_cb5ef                                                     ; b681: 20 ef b5     ..
    lda #&40 ; '@'                                                    ; b684: a9 40       .@
    sta l10b8,x                                                       ; b686: 9d b8 10    ...
    php                                                               ; b689: 08          .
    jsr sub_cb589                                                     ; b68a: 20 89 b5     ..
    plp                                                               ; b68d: 28          (
    ...
    ldy #&0d                                                          ; b6c5: a0 0d       ..
    ldx #5                                                            ; b6c7: a2 05       ..
    jsr c9499                                                         ; b6c9: 20 99 94     ..
; &b6cc referenced 1 time by &b6ba
.cb6cc
    jsr sub_cb5cc                                                     ; b6cc: 20 cc b5     ..
    ldy #&0e                                                          ; b6cf: a0 0e       ..
...
.cb87d
    ...
    pla                                                               ; b884: 68          h
    jsr sub_cb920                                                     ; b885: 20 20 b9      .
    jmp cb910                                                         ; b888: 4c 10 b9    L..

; &b88b referenced 1 time by &b87f
.cb88b
    bit l947d                                                         ; b88b: 2c 7d 94    ,}.
    jsr sub_cb738                                                     ; b88e: 20 38 b7     8.
    ...
    ldy #&0d                                                          ; b8c4: a0 0d       ..
    ldx #5                                                            ; b8c6: a2 05       ..
    jsr c9499                                                         ; b8c8: 20 99 94     ..
    pla                                                               ; b8cb: 68          h
    tay                                                               ; b8cc: a8          .
    lda l10d7                                                         ; b8cd: ad d7 10    ...
    jsr sub_cb920                                                     ; b8d0: 20 20 b9      .
    jsr sub_cb729                                                     ; b8d3: 20 29 b7     ).
    pla                                                               ; b8d6: 68          h
    tay                                                               ; b8d7: a8          .
    pla                                                               ; b8d8: 68          h
    tax                                                               ; b8d9: aa          .
...
.sub_cb979
    jsr sub_c9287                                                     ; b979: 20 87 92     ..
    jmp c9ecb                                                         ; b97c: 4c cb 9e    L..

; ***************************************************************************************
.cmd_close
    lda #osfind_close                                                 ; b97f: a9 00       ..
    tay                                                               ; b981: a8          .              ; Y=&00
...
.cbbaf
    jsr cbb0c                                                         ; bbaf: 20 0c bb     ..
    jmp c91f4                                                         ; bbb2: 4c f4 91    L..
...
.loop_cbe9a
    ...
    sta c0400,y                                                       ; be9d: 99 00 04    ...
    lda reloc_p5_src,y                                                ; bea0: b9 90 bc    ...
    sta l0500,y                                                       ; bea3: 99 00 05    ...
    lda reloc_p6_src,y                                                ; bea6: b9 90 bd    ...
    sta l0600,y                                                       ; bea9: 99 00 06    ...
    dey                                                               ; beac: 88          .
    bne loop_cbe9a                                                    ; bead: d0 eb       ..
    jsr sub_c0421                                                     ; beaf: 20 21 04     !.
