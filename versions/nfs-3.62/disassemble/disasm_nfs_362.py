...
comment(0x06DA, "A=4: CB1 interrupt bit mask", inline=True)
comment(0x06DC, "Test CB1 flag in VIA IFR", inline=True)
comment(0x06DF, "CB1 active: handle interrupt", inline=True)
