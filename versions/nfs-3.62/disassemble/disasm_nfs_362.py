...
label(0x8F3D, "read_local_station_id") # Read cached local station number from RX buffer offset &14
...
comment(0x86EA, "X=&FF: next INX wraps to first char index", inline=True)
...
comment(0x883B, "Y += 5", inline=True)
...
comment(0x884E, "Y -= 4", inline=True)
...
comment(0x8930, "X=1: filename only, no data extent", inline=True)
...
comment(0x8EA7, "Push low byte for RTS dispatch", inline=True)
...
comment(0x8EB8, "lo(osword_0f_handler-1): OSWORD &0F", inline=True)
comment(0x8EB9, "lo(osword_10_handler-1): OSWORD &10", inline=True)
comment(0x8EBA, "lo(osword_11_handler-1): OSWORD &11", inline=True)
comment(0x8EBB, "lo(osword_12_dispatch-1): OSWORD &12", inline=True)
comment(0x8EBC, "lo(econet_tx_rx-1): OSWORD &13", inline=True)
comment(0x8EBD, "hi(osword_0f_handler-1): OSWORD &0F", inline=True)
comment(0x8EBE, "hi(osword_10_handler-1): OSWORD &10", inline=True)
comment(0x8EBF, "hi(osword_11_handler-1): OSWORD &11", inline=True)
comment(0x8EC0, "hi(osword_12_dispatch-1): OSWORD &12", inline=True)
comment(0x8EC1, "hi(econet_tx_rx-1): OSWORD &13", inline=True)
...
comment(0x919E, "V=1: skip to net_rx_ptr page", inline=True)
comment(0x91A0, "V=0: use (nfs_workspace) page", inline=True)
...
comment(0x91AE, "Loop until all template bytes done", inline=True)
comment(0x91B0, "→ Y=&10 (main only)", inline=True)
comment(0x91B1, "Store final offset as net_tx_ptr", inline=True)
...
comment(0x8F3D, "Y=&14: RX buf offset of cached station ID", inline=True)
comment(0x8F3F, "Read cached local station number", inline=True)
...
comment(0x8F46, "Sub-function 8: read local station number", inline=True)
comment(0x8F48, "Match: read cached station ID from RX buffer", inline=True)
...
comment(0x8F07, "Sub-function 4 or 5: read/set protection", inline=True)
...
comment(0x9162, "Load param byte from OSWORD param block", inline=True)
...
comment(0x916C, "Load original OSWORD code", inline=True)
comment(0x916E, "Store OSWORD code at ws+0", inline=True)
...
comment(0x9879, "Write CR2", inline=True)
comment(0x987E, "Write CR1", inline=True)
...
comment(0x835D, "A=&77: OSBYTE close spool/exec", inline=True)
comment(0x8386, "Return with Z flag result", inline=True)
...
comment(0x85A7, "Error &A3: No Clock", inline=True)
...
comment(0x85C5, "Error &A5: No reply", inline=True)
...
comment(0x86B4, "Restore X from stack", inline=True)
comment(0x86B6, "Return with mask in X", inline=True)
comment(0x86BE, "Return with handle in A", inline=True)
...
comment(0x883D, "(continued)", inline=True)
...
comment(0x884F, "Y -= 3", inline=True)
comment(0x8850, "(continued)", inline=True)
comment(0x8851, "(continued)", inline=True)
...
comment(0x8D57, "Opt 3 (Exec) name offset: &18 -> &8D6C", inline=True)
comment(0x8D58, 'Opt 1 (Load): "L.!" command prefix', inline=True)
comment(0x8D5B, '"BOOT" string for boot option 2', inline=True)
comment(0x8D5F, "CR terminator for BOOT string", inline=True)
comment(0x8D60, 'Opt 3 (Exec): "E.!BOOT" command string', inline=True)
comment(0x8D67, "CR terminator / Opt 0 bare CR command", inline=True)
...
comment(0x9014, "Y=&04: advance to station address", inline=True)
...
comment(0x96D4, "Store broadcast flag in TX flags", inline=True)
...
comment(0x9703, "Neither set -- clean end, discard via &970B", inline=True)
...
comment(0x9877, "CR2=&84: disable PSE for bit testing", inline=True)
...
comment(0x9ADB, "CR2=&A7: RTS|CLR_RX_ST|FC_TDRA|PSE", inline=True)
...
comment(0x9B9D, "(continued)", inline=True)
...
comment(0x9C6B, "A=3: scout_status for PEEK", inline=True)
...
comment(0x9D53, "IRQ set: validate reply immediately", inline=True)
comment(0x9D58, "Store error and return to idle", inline=True)
comment(0x9D81, "Install next handler at &9E50 into &0D4B/&0D4C", inline=True)
...
comment(0x9E7F, "IRQ set: validate final ACK immediately", inline=True)
...
comment(0x9EE9, "(continued)", inline=True)
comment(0x9EEA, "(continued)", inline=True)
comment(0x9EEB, "(continued)", inline=True)
comment(0x9EF3, "(continued)", inline=True)
