...
d.use_environment("acorn_sideways_rom", rom_title="NFS ROM 3.62 disassembly (Acorn Econet filing system)")
...
d.subroutine(
    ...
    description="""Sets up a response buffer (start &25, page &7F, length
508 bytes) for the machine type query, then jumps to the
...
d.subroutine(
    ...
    description="""Added in 3.62 to fix *EX matching *EXEC. The "EX" command table
