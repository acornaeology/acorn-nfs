...
; and this page). Contains: &0400: JMP &0473 (BEGIN — CLI parser / startup entry) &0403:
; JMP &06E2 (tube_escape_check) &0406: tube_addr_claim — Tube address claim protocol
; (ADRR) &0414: tube_post_init — called after ROM→RAM copy &0473: BEGIN — startup/CLI
; entry, break type check &04E7: tube_rdch_handler — RDCHV target &04EF:
...
; read data byte to A
    ...
    jmp tube_escape_check                                             ; 934f: 4c e2 06    L.. :005e[1]        ; JMP to tube_escape_check (&06A7)
...
.error1
    ...
    jsr osbyte                                                        ; 83e9: 20 f4 ff     ..      ; osbyte: read write spool file handle
    txa                                                               ; 83ec: 8a          .     
...
.error_msg_table
    equb &a0                                                          ; 84af: a0          .     
    equs "Line Jammed", &00                                           ; 84b0: 4c 69 6e... Lin...
    equb &a1                                                          ; 84bc: a1          .     
    equs "Net Error", &00                                             ; 84bd: 4e 65 74... Net...
    equb &a2                                                          ; 84c7: a2          .     
    equs "Not listening", &00                                         ; 84c8: 4e 6f 74... Not...
    equb &a3                                                          ; 84d6: a3          .     
    equs "No Clock", &00                                              ; 84d7: 4e 6f 20... No ...
    equb &a4                                                          ; 84e0: a4          .     
    equs "Bad Txcb", &00                                              ; 84e1: 42 61 64... Bad...
    equb &11                                                          ; 84ea: 11          .     
    equs "Escape", &00                                                ; 84eb: 45 73 63... Esc...
    equb &cb                                                          ; 84f2: cb          .     
    equs "Bad Option", &00                                            ; 84f3: 42 61 64... Bad...
    equb &a5                                                          ; 84fe: a5          .     
    equs "No reply", &00                                              ; 84ff: 4e 6f 20... No ...
; ***************************************************************************************
...
.remot1
    ...
    jsr osbyte                                                        ; 9127: 20 f4 ff     ..      ; osbyte: read write econet keyboard disable
; ***************************************************************************************
