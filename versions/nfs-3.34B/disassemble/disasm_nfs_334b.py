...
comment(0x8EB8, "Sub-function 8: read local station number", inline=True)
comment(0x8EBA, "Match: read cached station ID from RX buffer", inline=True)
...
comment(0x84A5, "Y += 5", inline=True)
...
comment(0x84A6, "Y += 4", inline=True)
comment(0x84A7, "(continued)", inline=True)
comment(0x84A8, "(continued)", inline=True)
comment(0x84A9, "(continued)", inline=True)
comment(0x84AA, "Return with Y adjusted", inline=True)
comment(0x84AB, "Y -= 4", inline=True)
comment(0x84AC, "Y -= 3", inline=True)
comment(0x84AD, "(continued)", inline=True)
comment(0x84AE, "(continued)", inline=True)
