...
| `&0527`          | [`tube_poll_r4_wrch`](address:0527) — service R4 WRCH while waiting for R2 |
...
[`tube_osfile`](address:05D8) (`BEQ` to
...
d.comment(0x83F7, "Y=`&84`: high byte of [`sp_dot_string`](address:8445)", align=Align.INLINE)
