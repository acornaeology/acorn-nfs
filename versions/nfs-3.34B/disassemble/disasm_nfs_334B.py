...
d.use_environment("acorn_sideways_rom", rom_title="NFS ROM 3.34B disassembly (Acorn Econet filing system)")
...
d.comment(0x003D, "R4 not ready: check R2 instead", align=Align.INLINE)
...
d.comment(0x0048, "R2 not ready: loop back to R4 check", align=Align.INLINE)
d.comment(0x004A, "Re-check R4: WRCH has priority over R2", align=Align.INLINE)
d.comment(0x004D, "R4 ready: handle WRCH first", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""Copied from ROM at [`reloc_p4_src`](address:934D) during init. The first 28
...
d.subroutine(
    ...
    description="""Copied from ROM during init (the 256 bytes immediately following
the page-4 source).
...
| `&0527`          | [`tube_poll_r4_wrch`](label:tube_poll_r4_wrch) — service R4 WRCH while waiting for R2 |
...
d.subroutine(
    ...
    description="""Copied from ROM during init (the 256 bytes immediately following
the page-5 source). `&0600`–`&0601` is the tail of
[`tube_osfile`](label:tube_osfile) (`BEQ` to
...
d.index_base(0x824E, "fs_vector_addrs")
...
d.subroutine(
    ...
    description="""BPUTV enters at &83A3 (CLC; fall through) and BGETV enters
...
d.comment(0x83F7, "Y=`&84`: high byte of [`sp_dot_string`](label:sp_dot_string)", align=Align.INLINE)
d.comment(0x83F9, "Close SPOOL via `*SP.`", align=Align.INLINE)
...
d.index_base(0x84B0, "error_msg_table")
d.banner(
    0x84B0,
...
d.index_base(0x84B0, "msg_line_jammed")
...
d.index_base(0x8531, "access_bit_table")
...
d.subroutine(
    ...
    description="""  A=0: close file -- delegates to close_handle (&8986)
...
d.index_base(0x8E7A, "osword_12_ws_offsets")
...
d.subroutine(
    ...
    description="""A=0: Initialise TX control block from ROM template at &8311
...
d.index_base(0x902C, "osword_tbl_lo")

for i in range(9):
    d.rts_code_ptr(0x902C + i, 0x9035 + i)
d.index_base(0x9035, "osword_tbl_hi")
...
d.index_base(0x90BF, "remote_osbyte_table")
...
d.subroutine(
    ...
    description="""Sets X=&0D, Y=&7C. Tests bit 6 of &833B to choose target:
...
d.subroutine(
    ...
    description="""Read by the loop at &9168, indexed by X from a starting value
...
d.index_base(0x9305, "osbyte_vdu_table")
...
d.char_literal(0x82BD)
d.char_literal(0x855A)
d.char_literal(0x855F)
d.char_literal(0x8569)
d.char_literal(0x856D)
d.char_literal(0x85F8)
d.char_literal(0x85FA)
d.char_literal(0x860F)
d.char_literal(0x8642)
d.char_literal(0x8BB2)
d.char_literal(0x8BD8)
d.char_literal(0x8DD4)
d.char_literal(0x8DEB)
d.char_literal(0x8F0F)
d.char_literal(0x8F38)
d.char_literal(0x9060)
...
d.index_base(0x944D, "tube_dispatch_rom")
d.index_base(0x954D, "tube_code_page6_rom")
...
d.comment(0x964D, "Unreferenced data block; no reader located and absent from DNFS 3.60+. Purpose undetermined.")
d.label(0x964D, "unused_data_964d")
