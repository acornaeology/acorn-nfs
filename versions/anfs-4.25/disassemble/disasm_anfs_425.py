...
_rom_filepath = os.environ.get("FANTASM_ROM", str(_version_dirpath / "rom" / "anfs-4.25.rom"))
...
d.use_environment(
    "acorn_sideways_rom", rom_title="ANFS ROM 4.25 disassembly (Acorn Advanced Network Filing System)"
)
...
d.label(0x86A3, "tx_line_idle_check")

d.comment(0x86A3, "A=&20: mask for SR2 INACTIVE bit", align=Align.INLINE)
d.comment(0x86A5, "Test SR2 if line is idle", align=Align.INLINE)
d.comment(0x86A8, "Line not idle: handle as line jammed", align=Align.INLINE)
...
d.comment(0x86CC, "Read SR1 (acknowledge pending interrupt)", align=Align.INLINE)
...
d.label(0x8940, "tx_length_table")
...
[`print_inline`](label:print_inline): `CR + "Advanced NFS 4.25" +
...
d.comment(0x94C0, "Unbalanced: use BRK ptr for error", align=Align.INLINE)
...
In 4.25 the two entry points share one body: `print_fs_address` (`X=2`)
...
d.comment(0xA8A7, "Equal: take save_txcb_and_convert path", align=Align.INLINE)
d.comment(0xA8A9, "Restore A (OSWORD sub-code)", align=Align.INLINE)
d.comment(0xA8AB, "Equal: take save_txcb_done path", align=Align.INLINE)
d.comment(0xA8AD, "Other sub-codes: set state = 8", align=Align.INLINE)
d.comment(0xA8AF, "Store service state", align=Align.INLINE)
...
d.comment(0xA8B6, "Save current TX control block", align=Align.INLINE)
d.comment(0xA8B9, "Load seconds from clock workspace", align=Align.INLINE)
d.comment(0xA8BC, "Convert binary to BCD", align=Align.INLINE)
d.comment(0xA8BF, "Store BCD seconds", align=Align.INLINE)
d.comment(0xA8C2, "Load minutes from clock workspace", align=Align.INLINE)
d.comment(0xA8C5, "Convert binary to BCD", align=Align.INLINE)
d.comment(0xA8C8, "Store BCD minutes", align=Align.INLINE)
d.comment(0xA8CB, "Load hours from clock workspace", align=Align.INLINE)
d.comment(0xA8CE, "Convert binary to BCD", align=Align.INLINE)
d.comment(0xA8D1, "Store BCD hours", align=Align.INLINE)
d.comment(0xA8D4, "Clear hours high position", align=Align.INLINE)
d.comment(0xA8D6, "Store zero", align=Align.INLINE)
d.comment(0xA8D9, "Load day+month byte", align=Align.INLINE)
d.comment(0xA8DC, "Save for later high nibble extract", align=Align.INLINE)
d.comment(0xA8DD, "Load day value", align=Align.INLINE)
d.comment(0xA8E0, "Convert day to BCD", align=Align.INLINE)
d.comment(0xA8E3, "Store BCD day", align=Align.INLINE)
d.comment(0xA8E6, "Restore day+month byte", align=Align.INLINE)
d.comment(0xA8E7, "Push current A", align=Align.INLINE)
d.comment(0xA8E8, "Mask low nibble (month low bits)", align=Align.INLINE)
d.comment(0xA8EA, "Convert to BCD", align=Align.INLINE)
d.comment(0xA8ED, "Store BCD month", align=Align.INLINE)
d.comment(0xA8F0, "Pop saved value", align=Align.INLINE)
d.comment(0xA8F1, "Shift high nibble down", align=Align.INLINE)
d.comment(0xA8F2, "Divide by 4", align=Align.INLINE)
d.comment(0xA8F3, "(continued)", align=Align.INLINE)
d.comment(0xA8F4, "4th shift: isolate high nibble", align=Align.INLINE)
d.comment(0xA8F6, "Add &51 (offset base)", align=Align.INLINE)
d.comment(0xA8F8, "Convert year to BCD", align=Align.INLINE)
d.comment(0xA8FB, "Store BCD year", align=Align.INLINE)
d.comment(0xA8FE, "Copy 7 bytes (Y=6 down to 0)", align=Align.INLINE)
d.label(0xA900, "loop_copy_bcd_to_pb")

d.comment(0xA900, "Load BCD byte from workspace", align=Align.INLINE)
d.comment(0xA903, "Store to parameter block", align=Align.INLINE)
d.comment(0xA905, "Next byte down", align=Align.INLINE)
...
d.label(0xA90E, "loop_copy_pbytes_to_ws")

d.comment(0xA911, "Store to PB[Y]", align=Align.INLINE)
d.comment(0xA913, "Decrement Y (advance backwards)", align=Align.INLINE)
d.comment(0xA914, "Loop until Y wraps", align=Align.INLINE)
d.comment(0xA916, "A=2: PB[0] parameter for OSWORD &0E (seconds-since-midnight format)", align=Align.INLINE)
d.comment(0xA918, "Store parameter at PB[0]", align=Align.INLINE)
...
d.comment(0xA923, "Save caller flags (D may be in any state)", align=Align.INLINE)
d.comment(0xA924, "Save A across decimal-mode arithmetic", align=Align.INLINE)
d.comment(0xA925, "Zero: result is 0, skip loop", align=Align.INLINE)
d.comment(0xA927, "Enter decimal mode", align=Align.INLINE)
d.comment(0xA928, "Start BCD result at 0", align=Align.INLINE)
d.label(0xA92A, "loop_bcd_add")

d.comment(0xA92A, "Clear carry for BCD add", align=Align.INLINE)
d.comment(0xA92B, "Add 1 in decimal mode", align=Align.INLINE)
d.comment(0xA92D, "Count down binary value", align=Align.INLINE)
d.comment(0xA92E, "Loop until zero", align=Align.INLINE)
d.label(0xA930, "done_bcd_convert")

d.comment(0xA930, "Restore caller flags (incl. D)", align=Align.INLINE)
d.comment(0xA931, "Return with BCD result in A", align=Align.INLINE)
...
d.label(0xBFF7, "rom_tail_padding")
d.banner(
    0xBFF7,
...
d.comment(0xBFF7, "ROM-tail padding (2 bytes &FF)", align=Align.INLINE)
d.byte(0xBFF9)

d.comment(0xBFF9, "ROM-tail padding (1 byte &FF; on its own line for annotation)", align=Align.INLINE)
d.comment(0xBFFA, "ROM-tail padding (30 bytes &FF)", align=Align.INLINE)
...
d.index_base(0xA75D, "boot_cmd_lo_table")
d.index_base(0xBFE8, "hazel_minus_1a")
...
# UNMAPPED: d.expr(0x87F8, lo(sym("nmi_tx_switch_rx")))
# UNMAPPED: d.expr(0x882A, lo(sym("nmi_reply_cont")))
# UNMAPPED: d.expr(0x88A5, lo(sym("nmi_data_tx_alt")))
...
# UNMAPPED: d.expr(0x871D, lo(sym("nmi_tx_data")))
# UNMAPPED: d.expr(0x8839, lo(sym("nmi_reply_validate")))
# UNMAPPED: d.expr(0x8971, lo(sym("nmi_final_ack_net")))
d.expr(0x9C1A, lo(sym("hazel_parse_buf")))
d.expr(0x9C1E, hi(sym("hazel_parse_buf")))
# UNMAPPED: d.expr(0xA72A, lo(sym("findlib_oscli_cmd")))
d.expr(0xA72E, hi(sym("findlib_oscli_cmd")))
# UNMAPPED: d.expr(0x8814, lo(sym("nmi_reply_scout")))
