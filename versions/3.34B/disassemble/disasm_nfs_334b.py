...
entry(0x8486)
entry(0x83A3)
comment(0x83a3, "/ fall through...", inline=True)
...
comment(0x8369, "/ fall through...", inline=True)
...
comment(0x8449, "/ fall through...", inline=True)
...
label(0x8589, "handle_to_mask_a")       # TAY; CLC; fall into handle_to_mask
label(0x858A, "handle_to_mask_clc")     # CLC; fall into handle_to_mask (always convert)
comment(0x858a, "/ fall through...", inline=True)
...
comment(0x85ff, "/ fall through...", inline=True)
...
comment(0x864f, "/ fall through...", inline=True)
...
comment(0x89d2, "/ fall through...", inline=True)
...
comment(0x822d, "/ fall through...", inline=True)
...
comment(0x8400, "/ fall through...", inline=True)
...
comment(0x86cf, "/ fall through...", inline=True)
...
comment(0x881e, "/ fall through...", inline=True)
...
comment(0x88e0, "/ fall through...", inline=True)
...
comment(0x8d83, "/ fall through...", inline=True)
...
comment(0x8e7a, "/ fall through...", inline=True)
...
comment(0x9128, "/ fall through...", inline=True)
...
comment(0x91eb, "/ fall through...", inline=True)
...
entry(0x81FF)
entry(0x8201)
comment(0x8216, "/ fall through...", inline=True)
...
comment(0x9161, "/ fall through...", inline=True)
...
comment(0x85bb, "/ fall through...", inline=True)
...
comment(0x85e2, "/ fall through...", inline=True)
...
comment(0x864b, "/ fall through...", inline=True)
...
# ============================================================
# Set up filing system vectors (&8218)
# ============================================================
subroutine(0x8218, "setup_fs_vectors", hook=None,
...
comment(0x82cf, "/ fall through...", inline=True)
...
number tracking byte for the byte-stream protocol.""",
    ...
    on_exit={"a": "handle on open, 0 on close-all, restored on close-one",
             "x": "restored",
             "y": "restored"})
comment(0x8984, "/ fall through...", inline=True)
...
comment(0x834f, "/ fall through...", inline=True)
...
comment(0x8bee, "/ fall through...", inline=True)
...
comment(0x8cfb, "/ fall through...", inline=True)
...
comment(0x8d20, "/ fall through...", inline=True)
...
comment(0x8d64, "/ fall through...", inline=True)
...
comment(0x8db6, "/ fall through...", inline=True)
...
comment(0x8df1, "/ fall through...", inline=True)
...
comment(0x8df6, "/ fall through...", inline=True)
...
comment(0x8e00, "/ fall through...", inline=True)
...
comment(0x904a, "/ fall through...", inline=True)
...
comment(0x9149, "/ fall through...", inline=True)
...
comment(0x9248, "/ fall through...", inline=True)
