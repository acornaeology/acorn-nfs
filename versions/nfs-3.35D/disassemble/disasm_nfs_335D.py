...
d.use_environment("acorn_sideways_rom", rom_title="NFS ROM 3.35D disassembly (Acorn Econet filing system)")
...
d.subroutine(
    ...
    description="""Copied from ROM at [`reloc_p4_src`](address:935F) during init. The first 28
...
All other service calls `<&0D` dispatch via [`dispatch`](label:dispatch).""",
)
...
d.subroutine(
    0x80F4,
    "check_svc_high",
    title="Service handler: high service dispatch",
    description="""Handles service calls >= &80. Compares A against &FE:
...
d.subroutine(
    ...
    description="""New in 3.35D: table-driven vector initialisation replaces
...
d.comment(0x8118, "Store vector high byte (indexed by X)", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""Copies 14 bytes from fs_vector_addrs (&828A) into FILEV-FSCV (&0212),
...
d.index_base(0x828A, "fs_vector_addrs")
...
d.subroutine(
    ...
    description="""Wrapper for send_fs_reply_cmd that sets the timeout counter
...
d.index_base(0x8556, "error_msg_table")
d.banner(
    0x8556,
...
d.index_base(0x8556, "msg_line_jammed")
d.label(0x8563, "msg_net_error")
d.label(0x856E, "msg_not_listening")
d.label(0x857D, "msg_no_clock")
d.label(0x8587, "msg_escape")
d.label(0x858F, "msg_bad_option")
d.label(0x859B, "msg_no_reply")
d.comment(0x8556, "Error &A0: Line Jammed", align=Align.INLINE)
d.comment(0x8557, '"Line Jammed" string', align=Align.INLINE)
d.comment(0x8563, "Error &A1: Net Error", align=Align.INLINE)
d.comment(0x8564, '"Net Error" string', align=Align.INLINE)
d.comment(0x856E, "Error &A2: Not listening", align=Align.INLINE)
d.comment(0x856F, '"Not listening" string', align=Align.INLINE)
d.comment(0x857D, "Error &A3: No Clock", align=Align.INLINE)
d.comment(0x857E, '"No Clock" string', align=Align.INLINE)
d.comment(0x8587, "Error &11: Escape", align=Align.INLINE)
d.comment(0x8588, '"Escape" string', align=Align.INLINE)
d.comment(0x858F, "Error &CB: Bad Option", align=Align.INLINE)
d.comment(0x8590, '"Bad Option" string', align=Align.INLINE)
d.comment(0x859B, "Error &A5: No reply", align=Align.INLINE)
d.comment(0x859C, '"No reply" string', align=Align.INLINE)
...
d.index_base(0x85D7, "access_bit_table")
...
d.subroutine(
    ...
    description="""Calls save_fscv_args (&85AF) to preserve A/X/Y, then JSR &86B9
...
d.subroutine(
    ...
    description="""Sets &B7=&01 and &B5=&03, then branches into fscv_5_cat at
...
d.subroutine(
  ...
  Option 1 (Load): offset &E2 → &8CE2 = "L.!BOOT" (dual-purpose:
      the byte &4C='L' at &8CE2 is a JMP opcode and
...
d.subroutine(
    ...
    description="""Parses the filename via parse_filename_gs and copies it into
...
d.subroutine(
    ...
    description="""CLC entry (SDISC): copies handles only, then jumps to jmp_restore_args.
...
d.index_base(0x8EFD, "osword_12_offsets")
d.label(0x8EFF, "osword_12_dispatch")
d.subroutine(
    0x8EFF,
    "osword_12_dispatch",
    title="OSWORD &12 sub-function dispatcher",
    description="""Dispatches sub-functions 0-9 for OSWORD &12 (read/set FS
...
d.comment(0x9024, "Dest station = broadcast (accept reply from any station)", align=Align.INLINE)
...
d.index_base(0x90A0, "osword_tbl_lo")

for i in range(9):
    d.rts_code_ptr(0x90A0 + i, 0x90A9 + i)
d.index_base(0x90A9, "osword_tbl_hi")
...
d.subroutine(
    ...
    description="""Handles remote character output over the network. Clears
...
d.index_base(0x9133, "remote_osbyte_table")
...
d.subroutine(
    ...
    description="""Sets X=&0D, Y=&7C. Tests bit 6 of &837E to choose target:
...
d.comment(0x9271, "End address = max (unlimited data length)", align=Align.INLINE)
...
d.index_base(0x9317, "osbyte_vdu_table")
...
d.subroutine(
    ...
    description="""New in 3.35D: issues OSBYTE &8F with X=&0C (NMI claim service
request) before copying the NMI shim. Sub-entry at &968A skips
the service request for quick re-init. Then copies 32 bytes of
NMI shim from ROM (&9FD9) to RAM (nmi_code_base), patches the current
...
d.comment(0x968A, "Copy 32 bytes of NMI shim from ROM to nmi_code_base", align=Align.INLINE)
...
d.comment(0x968F, "Write to NMI shim RAM (nmi_code_base,Y)", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""Clears the TX complete flag, then polls econet_init_flag
...
d.subroutine(
    ...
    description="""Loads the saved tx_in_progress flag from RXCB offset 8
...
d.subroutine(
    ...
    description="""Reached when the scout data loop sees no RDA (BPL at &9756) or
...
d.subroutine(
    ...
    description="""Selects either the normal bulk RX handler (&98A4) or the Tube
...
d.subroutine(
    ...
    description="""Installs nmi_rx_scout (&9700) as the NMI handler via
...
d.subroutine(
    ...
    description="""Sets up a receive buffer (length 508 bytes) below the screen
...
d.char_literal(0x80A1)
d.char_literal(0x81F1)
d.char_literal(0x82FF)
d.char_literal(0x8605)
d.char_literal(0x8609)
d.char_literal(0x8BD5)
d.char_literal(0x8BE3)
d.char_literal(0x8D12)
d.char_literal(0x8D45)
d.char_literal(0x8DB1)
d.char_literal(0x8DB3)
d.char_literal(0x8DEF)
d.char_literal(0x8E66)
d.char_literal(0x8E77)
d.char_literal(0x8F8C)
d.char_literal(0x8FB5)
...
d.label(0x9AA5, "imm_op_dispatch_lo")
d.comment(0x9AA5, "Ctrl &81: PEEK", align=Align.INLINE)
d.comment(0x9AA6, "Ctrl &82: POKE", align=Align.INLINE)
d.comment(0x9AA7, "Ctrl &83: JSR", align=Align.INLINE)
d.comment(0x9AA8, "Ctrl &84: UserProc", align=Align.INLINE)
d.comment(0x9AA9, "Ctrl &85: OSProc", align=Align.INLINE)
d.comment(0x9AAA, "Ctrl &86: HALT", align=Align.INLINE)
d.comment(0x9AAB, "Ctrl &87: CONTINUE", align=Align.INLINE)
d.comment(0x9AAC, "Ctrl &88: machine-type", align=Align.INLINE)
d.label(0x9AAD, "imm_op_dispatch_hi")
d.comment(0x9AAD, "Ctrl &81: PEEK", align=Align.INLINE)
d.comment(0x9AAE, "Ctrl &82: POKE", align=Align.INLINE)
d.comment(0x9AAF, "Ctrl &83: JSR", align=Align.INLINE)
d.comment(0x9AB0, "Ctrl &84: UserProc", align=Align.INLINE)
d.comment(0x9AB1, "Ctrl &85: OSProc", align=Align.INLINE)
d.comment(0x9AB2, "Ctrl &86: HALT", align=Align.INLINE)
d.comment(0x9AB3, "Ctrl &87: CONTINUE", align=Align.INLINE)
d.comment(0x9AB4, "Ctrl &88: machine-type", align=Align.INLINE)

d.label(0x9BA0, "tx_done_dispatch_lo")
d.comment(0x9BA0, "Ctrl &83: JSR", align=Align.INLINE)
d.comment(0x9BA1, "Ctrl &84: UserProc", align=Align.INLINE)
d.comment(0x9BA2, "Ctrl &85: OSProc", align=Align.INLINE)
d.comment(0x9BA3, "Ctrl &86: HALT", align=Align.INLINE)
d.comment(0x9BA4, "Ctrl &87: CONTINUE", align=Align.INLINE)
d.label(0x9BA5, "tx_done_dispatch_hi")
d.comment(0x9BA5, "Ctrl &83: JSR", align=Align.INLINE)
d.comment(0x9BA6, "Ctrl &84: UserProc", align=Align.INLINE)
d.comment(0x9BA7, "Ctrl &85: OSProc", align=Align.INLINE)
d.comment(0x9BA8, "Ctrl &86: HALT", align=Align.INLINE)
d.comment(0x9BA9, "Ctrl &87: CONTINUE", align=Align.INLINE)

d.label(0x9CE3, "tx_ctrl_dispatch_lo")
d.comment(0x9CE3, "Ctrl &81: PEEK", align=Align.INLINE)
d.comment(0x9CE4, "Ctrl &82: POKE", align=Align.INLINE)
d.comment(0x9CE5, "Ctrl &83: JSR", align=Align.INLINE)
d.comment(0x9CE6, "Ctrl &84: UserProc", align=Align.INLINE)
d.comment(0x9CE7, "Ctrl &85: OSProc", align=Align.INLINE)
d.comment(0x9CE8, "Ctrl &86: HALT", align=Align.INLINE)
d.comment(0x9CE9, "Ctrl &87: CONTINUE", align=Align.INLINE)
d.comment(0x9CEA, "Ctrl &88: machine-type", align=Align.INLINE)
d.label(0x9CEB, "tx_ctrl_dispatch_hi")
d.comment(0x9CEB, "Ctrl &81: PEEK", align=Align.INLINE)
d.comment(0x9CEC, "Ctrl &82: POKE", align=Align.INLINE)
d.comment(0x9CED, "Ctrl &83: JSR", align=Align.INLINE)
d.comment(0x9CEE, "Ctrl &84: UserProc", align=Align.INLINE)
d.comment(0x9CEF, "Ctrl &85: OSProc", align=Align.INLINE)
d.comment(0x9CF0, "Ctrl &86: HALT", align=Align.INLINE)
d.comment(0x9CF1, "Ctrl &87: CONTINUE", align=Align.INLINE)
d.comment(0x9CF2, "Ctrl &88: machine-type", align=Align.INLINE)
