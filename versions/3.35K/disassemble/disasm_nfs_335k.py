...
label(0x8280, "fs_vector_addrs")        # 14-byte table: FILEV-FSCV extended vector addresses
...
label(0x91D3, "return_display_setup") # NFS09: return from remote_display_setup
...
subroutine(0x91C4, "remote_display_setup", hook=None,
