...
.l8024
    equb 3                                                            ; 8024: 03          .
    equb <(return_1-1)                                                ; 8025: f5          .
    equb <(svc_abs_workspace-1)                                       ; 8026: b7          .
    equb <(svc_private_workspace-1)                                   ; 8027: c0          .
    equb <(svc_autoboot-1)                                            ; 8028: 18          .
    equb <(sub_c81b1-1)                                               ; 8029: b0          .
    equb <(svc_unknown_irq-1)                                         ; 802a: 6b          k
    equb <(return_1-1)                                                ; 802b: f5          .
    equb <(sub_c806f-1)                                               ; 802c: 6e          n
    equb <(osword_fs_entry-1)                                         ; 802d: 7e          ~
    equb <(svc_help-1)                                                ; 802e: 03          .
    equb <(return_1-1)                                                ; 802f: f5          .
    equb <(svc_nmi_claim-1)                                           ; 8030: 68          h
    equb <(svc_nmi_release-1)                                         ; 8031: 65          e
    equb <(select_nfs-1)                                              ; 8032: ec          .
    equb <(insert_remote_key-1)                                       ; 8033: e7          .
    equb <(remote_boot_handler-1)                                     ; 8034: 99          .
    equb <(save_palette_vdu-1)                                        ; 8035: a5          .
    equb <(execute_at_0100-1)                                         ; 8036: c7          .
    equb <(remote_validated-1)                                        ; 8037: d7          .
    equb <(sub_c89e8-1)                                               ; 8038: e7          .
    equb <(eof_handler-1)                                             ; 8039: 68          h
    equb <(sub_c8dcf-1)                                               ; 803a: ce          .
    equb <(fscv_star_handler-1)                                       ; 803b: d6          .
    equb <(sub_c8dcf-1)                                               ; 803c: ce          .
    equb <(cat_handler-1)                                             ; 803d: 20
    equb <(fscv_shutdown-1)                                           ; 803e: 4c          L
    equb <(fscv_read_handles-1)                                       ; 803f: 73          s
    equb <(print_dir_name-1)                                          ; 8040: 88          .
    equb <(copy_handles_and_boot-1)                                   ; 8041: 29          )
...
.c811f
    ...
    bne init_vectors_and_copy                                         ; 8123: d0 1b       ..
    cpy #0                                                            ; 8125: c0 00       ..
...
.c81e6
    ldx #5                                                            ; 81e6: a2 05       ..
    jsr match_rom_string                                              ; 81e8: 20 5e 83     ^.
...
.svc_private_workspace
    ...
    sta fs_boot_option                                                ; 82f4: 8d 05 0e    ...
    iny                                                               ; 82f7: c8          .              ; Y=&16
    sta (net_rx_ptr),y                                                ; 82f8: 91 9c       ..
    ldy #3                                                            ; 82fa: a0 03       ..
...
.send_fs_reply_cmd
    ...
    jsr send_to_fs_star                                               ; 83f3: 20 1b 85     ..
    plp                                                               ; 83f6: 28          (
...
.loop_c8508
    lda error_msg_table,y                                             ; 8508: b9 79 85    .y.
...
.bgetv_handler
    sec                                                               ; 855c: 38          8
    jsr handle_bput_bget                                              ; 855d: 20 10 84     ..            ; Handle BPUT/BGET file byte I/O
    sec                                                               ; 8560: 38          8
    lda #&fe                                                          ; 8561: a9 fe       ..
    bit l0fdf                                                         ; 8563: 2c df 0f    ,..
    bvs return_4                                                      ; 8566: 70 10       p.
    clc                                                               ; 8568: 18          .
    php                                                               ; 8569: 08          .
    lda l00cf                                                         ; 856a: a5 cf       ..
    plp                                                               ; 856c: 28          (
    bmi c8572                                                         ; 856d: 30 03       0.
...
.loop_c876a
    ...
    jsr send_to_fs_star                                               ; 8779: 20 1b 85     ..
    ldy #3                                                            ; 877c: a0 03       ..
...
.c884c
    ...
    jsr send_to_fs_star                                               ; 8864: 20 1b 85     ..
...
.ex_handler
    ldx #1                                                            ; 8c1b: a2 01       ..
    lda #3                                                            ; 8c1d: a9 03       ..
    bne c8c29                                                         ; 8c1f: d0 08       ..             ; ALWAYS branch
...
.c8c29
    ...
    ldx #3                                                            ; 8c3f: a2 03       ..
    jsr print_reply_bytes                                             ; 8c41: 20 fb 8c     ..
...
.c8ca4
    ...
    ldx #&1b                                                          ; 8cc0: a2 1b       ..
    jsr print_reply_bytes                                             ; 8cc2: 20 fb 8c     ..
...
.loop_c8ce8
    ...
    pla                                                               ; 8cf4: 68          h
    clc                                                               ; 8cf5: 18          .
    adc l00b4                                                         ; 8cf6: 65 b4       e.
    tay                                                               ; 8cf8: a8          .
    bne c8cc8                                                         ; 8cf9: d0 cd       ..
...
; ***************************************************************************************
.osword_11_handler
    lda net_rx_ptr_hi                                                 ; 8ed4: a5 9d       ..
    sta l00ac                                                         ; 8ed6: 85 ac       ..
    ldy #&7f                                                          ; 8ed8: a0 7f       ..
...
.loop_c900b
    ...
    jmp send_to_fs_star                                               ; 9031: 4c 1b 85    L..
...
.osword_trampoline
    ...
    pha                                                               ; 9092: 48          H
    lda osword_tbl_lo,x                                               ; 9093: bd 9a 90    ...
    pha                                                               ; 9096: 48          H
...
.bsxl0
    ...
    jsr send_to_fs_star                                               ; 9296: 20 1b 85     ..
    pla                                                               ; 9299: 68          h
    pha                                                               ; 929a: 48          H
...
.print_hex
    ...
    lsr a                                                             ; 9fe3: 4a          J
    lsr a                                                             ; 9fe4: 4a          J
    jsr print_hex_nibble                                              ; 9fe5: 20 e9 9f     ..
    pla                                                               ; 9fe8: 68          h
; ***************************************************************************************
