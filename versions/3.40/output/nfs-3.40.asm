...
.initl
    ...
    beq init_fs_vectors                                               ; 8202: f0 5c       .\             ; ALWAYS branch
...
.svc_3_autoboot
    ...
    bmi print_station_info                                            ; 8222: 30 0a       0.
; ***************************************************************************************
; Check boot key
; 
...
.store_rom_ptr_pair
    lda run_fscv_cmd,y                                                ; 8335: b9 89 82    ...
    sta (osrdsc_ptr),y                                                ; 8338: 91 f6       ..
    iny                                                               ; 833a: c8          .
    lda run_fscv_cmd,y                                                ; 833b: b9 89 82    ...
...
.quote1
    ...
    bcc quote1                                                        ; 86f4: 90 f5       ..             ; ALWAYS branch
