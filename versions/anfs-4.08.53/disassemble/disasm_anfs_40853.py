...
d.comment(0x8089, "Copy 32 bytes of NMI shim from ROM to nmi_code_base", align=Align.INLINE)
d.label(0x808B, "copy_nmi_shim")

d.comment(0x808B, "Read byte from NMI shim ROM source", align=Align.INLINE)
d.comment(0x808E, "Write to NMI shim RAM (nmi_code_base,Y)", align=Align.INLINE)
...
d.comment(0x82D9, "Save extra byte to rx_extra_byte for later use", align=Align.INLINE)
