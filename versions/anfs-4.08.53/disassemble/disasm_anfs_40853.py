...
d.expr(0x83F2, "<(nmi_rx_scout)")
d.expr(0x83F4, ">(nmi_rx_scout)")

d.expr(0x80CC, "<(nmi_rx_scout_net)")
d.expr(0x81D8, "<(nmi_data_rx)")
d.expr(0x81EC, "<(nmi_data_rx_net)")
d.expr(0x8225, "<(nmi_data_rx_tube)")
d.expr(0x8227, ">(nmi_data_rx_tube)")
d.expr(0x8315, "<(nmi_ack_tx_src)")
d.expr(0x8317, ">(nmi_ack_tx_src)")
d.expr(0x8722, "<(nmi_tx_complete)")
d.expr(0x8724, ">(nmi_tx_complete)")
d.expr(0x8740, "<(nmi_reply_scout)")
d.expr(0x8754, "<(nmi_reply_cont)")
d.expr(0x87B1, "<(nmi_scout_ack_src)")
d.expr(0x87B3, ">(nmi_scout_ack_src)")
d.expr(0x87D6, "<(nmi_data_tx_tube)")
d.expr(0x87D8, ">(nmi_data_tx_tube)")
d.expr(0x881E, "<(discard_reset_rx)")
d.expr(0x8820, ">(discard_reset_rx)")
d.expr(0x8874, "<(nmi_final_ack)")
d.expr(0x8876, ">(nmi_final_ack)")
d.expr(0x888A, "<(nmi_final_ack_net)")

d.label(0x8102, "nmi_scout_data")
d.label(0x87E4, "nmi_data_tx_alt")
d.expr(0x80EC, "<(nmi_scout_data)")
d.expr(0x80EE, ">(nmi_scout_data)")
d.expr(0x87CF, "<(nmi_data_tx_alt)")
d.expr(0x87D1, ">(nmi_data_tx_alt)")
