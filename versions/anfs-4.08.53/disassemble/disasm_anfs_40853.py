...
label(0x8625, "tx_bad_ctrl_error")
...
subroutine(0x8052, "set_jsr_protection",
...
subroutine(0x8344, "advance_rx_buffer_ptr",
    ...
    "Tube pointer by 1.")
subroutine(0x838B, "nmi_post_ack_dispatch",
...
comment(0x8076, "Check Tube presence via OSBYTE &EA", inline=True)
comment(0x8079, "Store Tube presence flag from OSBYTE &EA", inline=True)
comment(0x8080, "Issue NMI claim service request", inline=True)
...
comment(0x80C8, "Store broadcast flag in rx_src_net", inline=True)
...
comment(0x80E6, "Network = 0 (local): clear tx_flags", inline=True)
...
comment(0x81DC, "A=1: AP mask for SR2 bit test", inline=True)
...
comment(0x83CD, "Set bit7: signals wait_net_tx_ack that reply arrived", inline=True)
comment(0x83CF, "Store to RXCB byte 0 (bit 7 set = complete)", inline=True)
...
comment(0x83E4, "Discard scout and reset listen state", inline=True)
...
comment(0x83EB, "Discard scout and reset RX listen", inline=True)
comment(0x83EE, "Reset ADLC and return to RX listen", inline=True)
...
comment(0x8486, "A=0: port buffer lo at page boundary", inline=True)
...
comment(0x8496, "Y=1: copy 2 bytes (1 down to 0)", inline=True)
...
comment(0x84E0, "CR2=&A7: RTS|CLR_RX_ST|FC_TDRA|PSE", inline=True)
comment(0x84E2, "Write CR2 for TX setup", inline=True)
comment(0x84E5, "NMI handler lo byte (self-modifying)", inline=True)
comment(0x84E7, "Y=&85: NMI handler high byte", inline=True)
...
comment(0x8539, "Hi byte of tx_done_exit-1", inline=True)
...
comment(0x85B1, "(continued)", inline=True)
...
comment(0x8625, "Error &44: control byte out of valid range", inline=True)
...
comment(0x86A0, "Skip buffer setup if transfer size is zero", inline=True)
...
comment(0x890B, "(continued)", inline=True)
...
comment(0x899D, "INTOFF: force /NMI high (IC97 flip-flop clear)", inline=True)
...
comment(0x89B9, "INTON: guaranteed /NMI edge if ADLC IRQ asserted", inline=True)
...
comment(0x8A40, "Non-zero: ADLC absent, set flag", inline=True)
comment(0x8A42, "Read ADLC status register 2", inline=True)
comment(0x8A45, "Mask relevant status bits", inline=True)
comment(0x8A47, "Zero: ADLC present, skip", inline=True)
comment(0x8A49, "Shift bit 7 into carry", inline=True)
comment(0x8A4C, "Set carry to mark ADLC absent", inline=True)
comment(0x8A4D, "Rotate carry into bit 7 of slot flag", inline=True)
comment(0x8A50, "Load ROM slot flag byte", inline=True)
comment(0x8A53, "Shift bit 7 (ADLC absent) into carry", inline=True)
comment(0x8A54, "Restore service call number", inline=True)
comment(0x8A55, "ADLC present: continue dispatch", inline=True)
comment(0x8A57, "ADLC absent: decline service, return", inline=True)
...
comment(0x8ABD, "Dispatch to service handler via table", inline=True)
...
comment(0x8C14, "X += 3: skip syntax descriptor and address", inline=True)
comment(0x8C15, "(continued)", inline=True)
comment(0x8C16, "(continued)", inline=True)
...
comment(0x8C1E, "X += 3: skip syntax descriptor and address", inline=True)
comment(0x8C1F, "(continued)", inline=True)
...
comment(0x8CD5, "Select NFS as current filing system", inline=True)
...
comment(0x8D8B, "Not a digit: skip to password entry", inline=True)
comment(0x8D8D, "Parse user ID string", inline=True)
comment(0x8D90, "No user ID: go to password", inline=True)
comment(0x8D9C, "No FS address: skip to password", inline=True)
...
comment(0x8E35, "Y still positive: continue counting", inline=True)
...
comment(0x8E8C, "Dispatch to OSBYTE handler via table", inline=True)
...
comment(0x8F40, "Initialise ADLC hardware", inline=True)
comment(0x8F43, "OSBYTE &A8: read ROM pointer table", inline=True)
comment(0x8F45, "Read ROM pointer table address", inline=True)
...
comment(0xA14D, "X += 3: skip flags and address bytes", inline=True)
comment(0xA14E, "(continued)", inline=True)
comment(0xA14F, "(continued)", inline=True)
...
comment(0xA5A8, "Load NFS workspace page high byte", inline=True)
comment(0xA5AA, "Set workspace pointer high", inline=True)
comment(0xA5AC, "Set workspace pointer low from Y", inline=True)
comment(0xA5AE, "Rotate Econet flags (save interrupt state)", inline=True)
comment(0xA5B1, "Load PB byte 0 (OSWORD flag)", inline=True)
comment(0xA5B3, "Store OSWORD flag", inline=True)
comment(0xA5B5, "Non-zero: use specified slot", inline=True)
comment(0xA5B7, "A=3: start searching from slot 3", inline=True)
comment(0xA5B9, "Convert slot to 2-bit workspace index", inline=True)
comment(0xA5BC, "C set: slot invalid, store result", inline=True)
comment(0xA5BE, "Shift index right (divide by 4)", inline=True)
comment(0xA5BF, "Continue shift", inline=True)
comment(0xA5C0, "Transfer to X as workspace offset", inline=True)
comment(0xA5C1, "Load workspace byte at offset", inline=True)
comment(0xA5C3, "Zero: slot empty, store result", inline=True)
comment(0xA5C5, "Compare with &3F ('?' marker)", inline=True)
comment(0xA5C7, "Match: slot found for receive", inline=True)
comment(0xA5C9, "Try next slot index", inline=True)
comment(0xA5CA, "Transfer back to A", inline=True)
comment(0xA5CB, "Loop back (A != 0)", inline=True)
comment(0xA5CD, "Transfer found slot to A", inline=True)
comment(0xA5CE, "X=0: index for indirect store", inline=True)
comment(0xA5D0, "Store slot number to PB byte 0", inline=True)
comment(0xA5D2, "Convert specified slot to workspace index", inline=True)
comment(0xA5D5, "C set: slot invalid, store result", inline=True)
comment(0xA5D7, "Y=Y-1: adjust workspace offset", inline=True)
comment(0xA5D8, "Update workspace pointer low", inline=True)
comment(0xA5DA, "A=&C0: slot active marker", inline=True)
comment(0xA5DC, "Y=1: workspace byte offset", inline=True)
comment(0xA5DE, "X=&0B: byte count for PB copy", inline=True)
comment(0xA5E0, "Compare Y with OSWORD flag", inline=True)
comment(0xA5E2, "Add workspace byte (check slot state)", inline=True)
comment(0xA5E4, "Zero: slot ready, copy PB and mark", inline=True)
comment(0xA5E6, "Negative: slot busy, increment and retry", inline=True)
comment(0xA5E8, "Clear carry for PB copy", inline=True)
comment(0xA5E9, "Copy PB byte to workspace slot", inline=True)
comment(0xA5EC, "C set: copy done, finish", inline=True)
comment(0xA5EE, "A=&3F: mark slot as pending ('?')", inline=True)
comment(0xA5F0, "Y=1: workspace flag offset", inline=True)
comment(0xA5F2, "Store pending marker to workspace", inline=True)
comment(0xA5F6, "Increment retry counter", inline=True)
comment(0xA5F8, "Non-zero: retry copy loop", inline=True)
comment(0xA5FA, "Decrement Y (adjust offset)", inline=True)
comment(0xA5FB, "Store result A to PB via Y", inline=True)
comment(0xA5FD, "Rotate Econet flags back (restore state)", inline=True)
comment(0xA600, "Return from OSWORD 11 handler", inline=True)
...
comment(0xBC34, "Y += 3: advance source index", inline=True)
comment(0xBC35, "(continued)", inline=True)
comment(0xBC36, "(continued)", inline=True)
...
comment(0xBC8A, "X += 4", inline=True)
comment(0xBC8B, "(continued)", inline=True)
comment(0xBC8C, "(continued)", inline=True)
...
comment(0x983A, "Restore control byte (overwritten by result code on retry)", inline=True)
...
comment(0x9840, "ASL: bit 6 (error flag) into N", inline=True)
comment(0x9841, "N=0 (bit 6 clear): success", inline=True)
comment(0x9843, "ASL: shift away error flag, keep error type", inline=True)
comment(0x9844, "Z=1 (no type bits): fatal; Z=0: retryable", inline=True)
...
comment(0x9A6C, "Y += 5", inline=True)
comment(0x9A6D, "Y += 4", inline=True)
comment(0x9A6E, "(continued)", inline=True)
comment(0x9A6F, "(continued)", inline=True)
comment(0x9A70, "(continued)", inline=True)
...
comment(0x9A80, "Y -= 3", inline=True)
