...
.svc_9_help
    ...
    equs &0d, "NFS 3.62", &0d                                         ; 820b: 0d 4e 46... .NF
...
; &8c4c referenced 1 time by &8c46
    ...
    equb &80, &81, &45, &58, &9f, &b4                                 ; 8c53: 80 81 45... ..E
    equs "BYE"                                                        ; 8c59: 42 59 45    BYE
...
.tx_prepare
    ...
    equb &6e, &72, &b4, &b4, &b4, &c4, &c4, &6a                       ; 9c63: 6e 72 b4... nr.
.imm_op_status3
...
;     Number of data bytes     = 641 bytes
