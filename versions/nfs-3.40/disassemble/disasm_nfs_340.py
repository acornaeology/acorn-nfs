...
# visible at &9DC2 even if FV has been latched.
#
...
#   Read byte 0 at &9D9A -> refills byte 1 (RDA visible at &9DA9)
#   Read byte 1 at &9DAE -> refills byte 2 (RDA visible at &9DC2)
#   Read byte 2 at &9DC7 -> refills byte 3/LAST (FV set)
#   Read byte 3 at &9DCF -> FIFO empty
#   Check FV at &9DD9 -> FV is set
...
comment(0x0626, "Send X result via R2 (data overlap with &70=BVS)", inline=True)
comment(0x0628, "Read OSWORD number from R2", inline=True)
...
comment(0x86E3, "X=&FF: next INX wraps to first char index", inline=True)
...
comment(0x87FC, "Y += 5", inline=True)
comment(0x87FD, "Y += 4", inline=True)
...
comment(0x880F, "Y -= 4", inline=True)
...
comment(0x88EC, "X=1: filename only, no data extent", inline=True)
...
label(0x8F35, "read_local_station_id") # Read cached local station number from RX buffer offset &14
comment(0x8F35, "Y=&14: RX buf offset of cached station ID", inline=True)
comment(0x8F37, "Read cached local station number", inline=True)
comment(0x8F39, "Y=1: param block byte 1", inline=True)
comment(0x8F3B, "Return station number to caller's param block", inline=True)
comment(0x8F3D, "Return", inline=True)
comment(0x8F3E, "Sub-function 8: read local station number", inline=True)
comment(0x8F40, "Match: read cached station ID from RX buffer", inline=True)
...
comment(0x0607, "Read X parameter from co-processor", inline=True)
...
comment(0x0668, "X=4: read 5 control block bytes", inline=True)
...
comment(0x06C5, "Poll R2 status (bit 7 = data ready)", inline=True)
comment(0x06C8, "Not ready: keep polling", inline=True)
comment(0x06CA, "Read byte from Tube R2 data register", inline=True)
...
comment(0x87FE, "(continued)", inline=True)
comment(0x87FF, "(continued)", inline=True)
comment(0x8800, "(continued)", inline=True)
comment(0x880A, "Next byte (descending)", inline=True)
comment(0x880D, "Loop until offset 2 reached", inline=True)
comment(0x8810, "Y -= 3", inline=True)
comment(0x8811, "(continued)", inline=True)
comment(0x8812, "(continued)", inline=True)
...
comment(0x9BF6, "(continued)", inline=True)
...
comment(0x9F57, "(continued)", inline=True)
comment(0x9F58, "(continued)", inline=True)
comment(0x9F59, "(continued)", inline=True)
comment(0x9F61, "(continued)", inline=True)
