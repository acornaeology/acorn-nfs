...
.accept_scout_net
    ...
    lda #&43 ; 'C'                                                    ; 972c: a9 43       .C       ; Install scout data reading loop at &970E
...
.nmi_data_rx
    ...
    lda #&37 ; '7'                                                    ; 9830: a9 37       .7       ; Install net check handler at &9837
...
.tx_last_data
    ...
    lda #&75 ; 'u'                                                    ; 9d6e: a9 75       .u       ; Install NMI handler at &9D75 (nmi_tx_complete)
