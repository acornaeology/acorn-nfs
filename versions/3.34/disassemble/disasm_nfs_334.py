...
label(0x8697, "copy_filename_ptr")       # Copy filename pointer to os_text_ptr and parse
...
label(0x8945, "return_a_zero")          # Return with A=0 via register restore
...
label(0x9000, "enable_irq_and_tx")     # CLI then JMP tx_poll_ff
