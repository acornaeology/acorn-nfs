...
; read data byte to A
    ...
    jmp tube_escape_check                                             ; 935d: 4c e2 06    L.. :005e[1]        ; JMP to tube_escape_check (&06A7)
...
svc_entry_lo = service_entry+1
    jmp check_svc_high                                                ; 8003: 4c ea 80    L..      ; JMP service_handler
...
; command match table at &8BE4, and from FSCV 2/3/4 indirectly. If CSD handle is zero
...
.net_4_resume_remote
    ...
    jsr osbyte                                                        ; 818e: 20 f4 ff     ..      ; Re-enable keyboard (X=0, Y=0)  osbyte: read write econet keyboard disable
...
.clear_osbyte_ce_cf
    ...
    lda #osbyte_read_write_econet_os_call_interception                ; 8198: a9 ce       ..       ; OSBYTE &CE: first system mask to reset
...
.clear_osbyte_masks
    ...
    jsr osbyte                                                        ; 819e: 20 f4 ff     ..      ; Reset system mask byte  osbyte: read write econet os call interception
...
.error1
    ...
    jsr osbyte                                                        ; 8425: 20 f4 ff     ..      ; osbyte: read write exec file handle
...
.remot1
    ...
    jsr osbyte                                                        ; 8495: 20 f4 ff     ..      ; osbyte: read write econet keyboard disable
; ***************************************************************************************
...
.error_msg_table
    equb &a0                                                          ; 854d: a0          .     
    equs "Line Jammed", &00                                           ; 854e: 4c 69 6e... Lin...
    equb &a1                                                          ; 855a: a1          .     
    equs "Net Error", &00                                             ; 855b: 4e 65 74... Net...
    equb &a2                                                          ; 8565: a2          .     
    equs "Not listening", &00                                         ; 8566: 4e 6f 74... Not...
    equb &a3                                                          ; 8574: a3          .     
    equs "No Clock", &00                                              ; 8575: 4e 6f 20... No ...
    equb &11                                                          ; 857e: 11          .     
    equs "Escape", &00                                                ; 857f: 45 73 63... Esc...
    equb &cb                                                          ; 8586: cb          .     
    equs "Bad Option", &00                                            ; 8587: 42 61 64... Bad...
    equb &a5                                                          ; 8592: a5          .     
    equs "No reply", &00                                              ; 8593: 4e 6f 20... No ...
; ***************************************************************************************
...
.gbpbf1
    ...
    bne gbpbf2                                                        ; 8a3b: d0 01       ..       ; Not at handle offset: continue
...
.svc_8_osword
    ...
    bmi logon3                                                        ; 8e7a: 30 3b       0;       ; Outside our OSWORD range, exit
; ***************************************************************************************
...
.osword_12_handler
    ...
    bcs logon3                                                        ; 8e7e: b0 37       .7       ; Index >= 5: not ours, return
; ***************************************************************************************
...
;
; Pushes address tx_done_exit-1 on the stack (so RTS returns to tx_done_exit), then does
; JMP (l0d58) to call the remote JSR target routine. When that routine returns via RTS,
