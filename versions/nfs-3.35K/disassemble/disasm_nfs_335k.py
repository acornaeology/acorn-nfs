...
# ============================================================
subroutine(0x8D9D, "print_hex", hook=None,
...
subroutine(0x85D9, "print_inline", hook=None,
...
# ============================================================
subroutine(0x8168, "svc_dispatch_epilogue", hook=None,
...
comment(0x81AE, "X=1: ROM offset for \"NET\" match", inline=True)
...
comment(0x8437, "Y=&84: high byte of OSCLI string in ROM", inline=True)
...
comment(0x86BC, "X=&FF: next INX wraps to first char index", inline=True)
...
comment(0x87DD, "Y += 5", inline=True)
comment(0x87DE, "Y += 4", inline=True)
...
comment(0x87F0, "Y -= 4", inline=True)
...
comment(0x88CF, "X=1: filename only, no data extent", inline=True)
...
comment(0x8ED4, "Store as copy source high byte in &BF", inline=True)
...
comment(0x8EFD, "Sub-function 4 or 5: read/set protection", inline=True)
...
comment(0x8F07, "Store workspace page in &BF (hi byte)", inline=True)
comment(0x8F09, "Load offset: &FF (sub 0-1) or &01 (sub 2-3)", inline=True)
comment(0x8F0C, "Store offset in &BE (lo byte)", inline=True)
...
comment(0x8FBF, "Y=2: copy 3 bytes (indices 2,1,0)", inline=True)
...
comment(0x90D8, "X=7: 8-entry NCTBPL table size", inline=True)
...
comment(0x9148, "Load param byte from OSWORD param block", inline=True)
...
comment(0x9152, "Load original OSWORD code", inline=True)
comment(0x9154, "Store OSWORD code at ws+0", inline=True)
...
comment(0x916C, "BIT test: V flag = bit 6 of &8374", inline=True)
...
comment(0x9176, "Set up TX and send RWORD packet", inline=True)
...
subroutine(0x8EA9, "copy_param_byte", hook=None,
...
subroutine(0x913A, "remote_osword_handler", hook=None,
...
comment(0x842E, "A=&E4: OSCLI \"SP.\" string at &84E4", inline=True)
...
comment(0x87F1, "Y -= 3", inline=True)
comment(0x87F2, "(continued)", inline=True)
comment(0x87F3, "(continued)", inline=True)
...
comment(0x87DF, "(continued)", inline=True)
comment(0x87E0, "(continued)", inline=True)
comment(0x87E1, "(continued)", inline=True)
