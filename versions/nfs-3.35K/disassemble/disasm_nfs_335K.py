...
d.banner(
    ...
    description="""Each byte is a Y offset into [`error_msg_table`](address:854D).
...
|---------|---------|------|
| `*NET1` | [`net_1_read_handle`](address:8E3B) | read file handle from received packet |
| `*NET2` | [`net_2_read_handle_entry`](address:8E56) | read handle entry from workspace |
| `*NET3` | [`net_3_close_handle`](address:8E66) | close handle / mark as unused |
| `*NET4` | [`net_4_resume_remote`](address:8180) | resume after remote operation |""",
)
...
in the [`fs_cmd_match_table`](address:8BE4), and from FSCV 2 / 3 / 4
...
[`nlistn`](address:84CB) / [`nlisne`](address:84CD): the TXCB
...
by [`copy_error_message`](address:84D8) until the trailing NUL
