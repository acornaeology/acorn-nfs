...
d.use_environment("acorn_sideways_rom", rom_title="NFS ROM 3.35K disassembly (Acorn Econet filing system)")
...
d.subroutine(
    ...
    description="""Copied from ROM at [`reloc_p4_src`](address:935A) during init. The first 28
...
d.subroutine(
    ...
    description="""Copied from ROM at [`reloc_p4_src`](address:935A)+`&100` during init.
...
d.subroutine(
    ...
    description="""Copied from ROM at [`reloc_p4_src`](address:935A)+`&200` during init.
...
d.comment(0x810E, "Store vector high byte (indexed by X)", align=Align.INLINE)
...
d.expr(0x817A, sym("cmd_roff_str") - sym("binary_version"))
...
d.expr(0x81AF, sym("cmd_net_str") - sym("binary_version"))
...
d.subroutine(
    ...
    description="""Copies 14 bytes from fs_vector_addrs (&8280) into FILEV-FSCV (&0212),
...
d.subroutine(
    ...
    description="""Copies 12 bytes from tx_ctrl_template (&836E) to &00C0.
...
d.subroutine(
    ...
    description="""BPUTV enters at &83DC (CLC; fall through) and BGETV enters
...
d.label(0x857E, "msg_escape")
d.label(0x8586, "msg_bad_option")
d.label(0x8592, "msg_no_reply")
d.comment(0x854D, "Error &A0: Line Jammed", align=Align.INLINE)
d.comment(0x854E, '"Line Jammed" string', align=Align.INLINE)
d.comment(0x855A, "Error &A1: Net Error", align=Align.INLINE)
d.comment(0x855B, '"Net Error" string', align=Align.INLINE)
d.comment(0x8565, "Error &A2: Not listening", align=Align.INLINE)
d.comment(0x8566, '"Not listening" string', align=Align.INLINE)
d.comment(0x8574, "Error &A3: No Clock", align=Align.INLINE)
d.comment(0x8575, '"No Clock" string', align=Align.INLINE)
d.comment(0x857E, "Error &11: Escape", align=Align.INLINE)
d.comment(0x857F, '"Escape" string', align=Align.INLINE)
d.comment(0x8586, "Error &CB: Bad Option", align=Align.INLINE)
d.comment(0x8587, '"Bad Option" string', align=Align.INLINE)
d.comment(0x8592, "Error &A5: No reply", align=Align.INLINE)
d.comment(0x8593, '"No reply" string', align=Align.INLINE)
...
d.subroutine(
    ...
    description="""ORs A into fs_work_0e07 (EOF hint byte), then falls through
...
a non-zero starting Y offset.""",
    on_entry={"y": "offset into (os_text_ptr) buffer (0 at &86BA)"},
...
d.subroutine(
    ...
    description="""Calls save_fscv_args (&85A6) to preserve A/X/Y, then JSR &86B0
...
d.subroutine(
    ...
    description="""  A=0: close file -- delegates to close_handle (&89AE)
...
d.subroutine(
    ...
    description="""If C=1, copies one byte from (osword_pb_ptr),Y to
...
d.subroutine(
    ...
    description="""Dispatches OSWORD &12 sub-functions 0-9:
...
d.comment(0x8FA2, "Dest station = broadcast (accept reply from any station)", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""A=0: Initialise TX control block from ROM template at &834A
...
d.comment(0x901C, "Set RX end address to max (accept any length)", align=Align.INLINE)
...
d.subroutine(
    ...
    description="""Handles OSWORD 7 (sound) and OSWORD 8 (define envelope)
...
d.subroutine(
    ...
    description="""Sets X=&0D, Y=&7C. Tests bit 6 of &8374 to choose target:
...
d.subroutine(
    ...
    description="""Read by the loop at &9176, indexed by X from a starting value
...
d.comment(0x926C, "End address = max (unlimited data length)", align=Align.INLINE)
...
NMI shim from ROM (&9FE8) to RAM (nmi_code_base), patches the current
...
d.subroutine(
    ...
    description="""Sets up a buffer just below screen memory (length 508 bytes)
...
JSR happens safely outside the NMI handler. Pushes address
...
d.char_literal(0x81E7)
d.char_literal(0x82F5)
d.char_literal(0x85FB)
d.char_literal(0x85FF)
d.char_literal(0x8BD7)
d.char_literal(0x8BE5)
d.char_literal(0x8D0A)
d.char_literal(0x8D3D)
d.char_literal(0x8DA9)
d.char_literal(0x8DAB)
d.char_literal(0x8DE7)
d.char_literal(0x8E5E)
d.char_literal(0x8E6F)
d.char_literal(0x8F84)
d.char_literal(0x8FAD)
d.char_literal(0x90CC)
...
d.index_base(0x945A, "tube_dispatch_rom")
d.index_base(0x955A, "tube_code_page6_rom")
...
d.comment(0x816D, "Unreferenced data block; no reader located and absent from DNFS 3.60+. Purpose undetermined.")
d.label(0x816D, "unused_data_816d")
