...
- Disassembler is [dasmos](https://acornaeology.github.io/dasmos/) (PyPI `dasmos>=2.0.1`; needs `fantasm>=0.17.1` to parse its schema-versioned JSON); local source-of-truth checkout at `/Users/rjs/Code/acornaeology/dasmos/`
